...
namespace Server
{
	...
	public class Skill : IComparable<Skill>
	{
        ...
        #region mod by Dies Irae
        public delegate double RacialBonusHandler( Race race, SkillName skill, double nonRacialValue );

	    public static RacialBonusHandler RacialHandler { get; set; }

	    public delegate double ClassBonusHandler( Mobile m, SkillName skill, double nonClassValue );

	    public static ClassBonusHandler ClassHandler { get; set; }
	    #endregion
		...
		public double Value
		{
			get
			{
                ...
                value = ( RacialHandler == null ) ? value : RacialHandler( m_Owner.Owner.Race, SkillName, value ); // mod by Dies Irae
                value = ( ClassHandler == null ) ? value : ClassHandler( m_Owner.Owner, SkillName, value ); // mod by Dies Irae
