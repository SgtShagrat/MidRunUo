...
namespace Server
{
    ...
    {
        void DisplayItemInfo( Mobile from );
        bool IsIdentifiedFor( Mobile from );
        void AddIdentifier( Mobile from );
        void InvalidateSecondAgeNames();
        void ClearIdentifiers();
        void CopyIdentifiersTo( IIdentificable tasteIdentificable );
    }

    public interface ITasteIdentificable
    {
        void DisplayItemInfo( Mobile from );
        bool IsIdentifiedFor( Mobile from );
        void AddIdentifier( Mobile from );
        string AlreadyIdentifiedMessage { get; }
        void ClearIdentifiers();
        void CopyIdentifiersTo( ITasteIdentificable tasteIdentificable );
    }

    public interface IUncookedEatable
    {
    }
    #endregion
	...
	{
		bool IsCasting{ get; }
        void OnCasterDamaged( Mobile from, int damage ); // mod by Dies Irae
		void OnCasterHurt();
		void OnCasterKilled();
