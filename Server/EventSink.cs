...
namespace Server
{
    ...
    public delegate void ClientPacketInterceptedEventHandler(ClientPacketInterceptedEventArgs e);
    #endregion
	...
	public delegate void MobileDeathEventHandler( MobileDeathEventArgs e ); //mod by Magius(CHE)
	...
	public class MobileDeathEventArgs : EventArgs
	{
		public Mobile Mobile{get;private set; }
		public Container Corpse {get;private set;}

		public MobileDeathEventArgs( Mobile mobile, Container corpse )
		{
			Mobile = mobile;
			Corpse = corpse;
		}
    ...
    #region SocketPatcketInterceptor System - Magius(CHE)
    public class CPI_Socket : IDisposable
    {
        public Socket InternalSocket { get; internal set; }
        ...
        public void Dispose()
        {
            ...
            try
            {
                InternalSocket.Close(1);
                // SocketPool.ReleaseSocket( InternalSocket );
            }
    ...
    public class ClientPacketInterceptedEventArgs : EventArgs
    {
        public CPI_Socket Socket { get; private set; }
        /// <summary>
        /// If a socket will be intercepted control will be passed to custom script and will be removed from 
        /// core list.
        /// Custom script must dispose socket when finisch by calling.
        /// </summary>
        public bool Intercepted { get; set; }
        public byte PacketId { get; private set; }
        public byte[] BufferedDatas { get; private set; }

        public ClientPacketInterceptedEventArgs( Socket s, byte packetId, byte[] remainbuff )
        {
            Socket = new CPI_Socket { InternalSocket = s };
            PacketId = packetId;
            BufferedDatas = remainbuff;
        }
    }
    #endregion
	...
	public class EventSink
	{
        ...
        #region SocketPatcketInterceptor System - Magius(CHE)
        public static event ClientPacketInterceptedEventHandler ClientPacketIntercepted;
        #endregion
		...
		public static event MobileDeathEventHandler PlayerDeath;
		#region Mod by Magius(CHE)		
		public static event MobileDeathEventHandler NonPlayerDeath;
		#endregion		
		...
		#region Mod by Magius(CHE)		
		public static void InvokeNonPlayerDeath( MobileDeathEventArgs e )
		{
		...
		public static void InvokePlayerDeath( MobileDeathEventArgs e )
		{
			if ( PlayerDeath != null )
				PlayerDeath( e );
		}
        ...
        #region SocketPatcketInterceptor System - Magius(CHE)
        public static void InvokeClientPacketIntercepted(ClientPacketInterceptedEventArgs e)
        {
            if (ClientPacketIntercepted != null)
                ClientPacketIntercepted(e);
        }
        #endregion
		...
		public static void InvokeWorldSave( WorldSaveEventArgs e )
		{
			if ( WorldSave != null )
		    {
                Midgard.WorldSaveProfiler.Instance.StartMainProfile();
				WorldSave( e );
                Midgard.WorldSaveProfiler.Instance.EndMainProfile();
		    }
		}
