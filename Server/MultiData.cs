...
namespace Server
{
	public class MultiData
	{
		...
		static MultiData()
		{
			...
			string idxPath = Core.FindDataFile( Path.Combine( MuleditorPath, "multi.idx" ) );
			string mulPath = Core.FindDataFile( Path.Combine( MuleditorPath, "multi.mul" ) );
        ...
        private static readonly string MuleditorPath = Path.Combine( Core.BaseDirectory, "MulEditor" );
	...
	public sealed class MultiComponentList
	{
        ...
        public MultiComponentList( Point2D min, Point2D max, Point2D center, int width, int height, MultiTileEntry[] mte )
        {
            m_Min = min;
            m_Max = max;
            m_Center = center;
            ...
            MultiTileEntry[] allTiles = m_List = mte;
