...
using Midgard.Engines.SecondAgeLoot;
using Midgard.Items;
using SecondAgeLoot = Midgard.Engines.SecondAgeLoot;
...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_WeaponTypes = new Type[]
			{
                ...
                typeof( MageStaff ) // mod by Dies Irae
			};
		...
		private static Type[] m_JewelryTypes = new Type[]
			{
				typeof( GoldRing ),				typeof( GoldBracelet ), typeof( GoldBeadNecklace ),  typeof( GoldEarrings ), typeof( GoldNecklace ),
				typeof( SilverRing ),			typeof( SilverBracelet ), typeof( SilverBeadNecklace ),  typeof( SilverEarrings ), typeof( SilverNecklace )
			};

        public static Type[] JewelryTypes { get { return m_JewelryTypes; } }

        public static Type[] AosJewelryTypes { get { return m_AosJewelryTypes; } }

        private static Type[] m_AosJewelryTypes = new Type[]
			{
		...
		#region MajorArtifacts MajorArtifactsNoSteal MajorArtifactsRar11 MajorArtifactsRar10 MajorStealableArtifacts
		public static Type[] MajorArtifacts{ get{ return m_MajorArtifacts; } }
		
		private static Type[] m_MajorArtifacts = new Type[]
		{
			typeof( LegacyOfTheDreadLord ), 	typeof( TheDragonSlayer ),				typeof( ArmorOfFortune ),			
			typeof( GauntletsOfNobility ),		typeof( HelmOfInsight ),				typeof( HolyKnightsBreastplate ),	
			typeof( JackalsCollar ),			typeof( LeggingsOfBane ),				typeof( MidnightBracers ),			
			typeof( OrnateCrownOfTheHarrower ),	typeof( ShadowDancerLeggings ),			typeof( TunicOfFire ),				
			typeof( VoiceOfTheFallenKing ),		typeof( BraceletOfHealth ),				typeof( OrnamentOfTheMagician ),	
			typeof( RingOfTheElements ),		typeof( RingOfTheVile ),				typeof( Aegis ),					
			typeof( ArcaneShield ),				typeof( AxeOfTheHeavens ),				typeof( BladeOfInsanity ),			
			typeof( BoneCrusher ),				typeof( BreathOfTheDead ),				typeof( Frostbringer ),				
			typeof( SerpentsFang ),				typeof( StaffOfTheMagi ),				typeof( TheBeserkersMaul ),
			typeof( TheDryadBow ),				typeof( DivineCountenance ),			typeof( HatOfTheMagi ),				
			typeof( HuntersHeaddress ),			typeof( SpiritOfTheTotem ), 			typeof( BladeOfTheRighteous ), 		
			typeof( InquisitorsResolution ),	typeof( TitansHammer ),					typeof( ZyronicClaw ),
			typeof( TheTaskmaster )
		};
		
		public static Type[] MajorArtifactsNoSteal{ get{ return m_MajorArtifactsNoSteal; } }
		
		private static Type[] m_MajorArtifactsNoSteal = new Type[]
		{
			typeof( LegacyOfTheDreadLord ), 	typeof( TheDragonSlayer ),				typeof( ArmorOfFortune ),			
			typeof( GauntletsOfNobility ),		typeof( HelmOfInsight ),				typeof( HolyKnightsBreastplate ),	
			typeof( JackalsCollar ),			typeof( LeggingsOfBane ),				typeof( MidnightBracers ),			
			...
			typeof( SerpentsFang ),				typeof( StaffOfTheMagi ),				typeof( TheBeserkersMaul ),
			typeof( TheDryadBow ),				typeof( DivineCountenance ),			typeof( HatOfTheMagi ),				
			typeof( HuntersHeaddress ),			typeof( SpiritOfTheTotem ), 			typeof( TheTaskmaster )
		};
		
		public static Type[] MajorArtifactsRar11{ get{ return m_MajorArtifactsRar11; } }
		
		private static Type[] m_MajorArtifactsRar11 = new Type[]
		{
			typeof( LegacyOfTheDreadLord ), 	typeof( TheDragonSlayer ),				typeof( ArmorOfFortune ),			
			typeof( GauntletsOfNobility ),		typeof( HelmOfInsight ),				typeof( HolyKnightsBreastplate ),	
			typeof( JackalsCollar ),			typeof( LeggingsOfBane ),				typeof( MidnightBracers ),			
		...
		public static Type[] MajorArtifactsRar10{ get{ return m_MajorArtifactsRar10; } }
		
		private static Type[] m_MajorArtifactsRar10 = new Type[]
		{
			typeof( TheTaskmaster )
		};
		
		public static Type[] MajorStealableArtifacts{ get{ return m_MajorStealableArtifacts; } }
		
		private static Type[] m_MajorStealableArtifacts = new Type[]
		{
			typeof( BladeOfTheRighteous ), 		typeof( InquisitorsResolution ),		typeof( TitansHammer ),	
			typeof( ZyronicClaw )
		};
		#endregion
		
		#region MinorArtifacts MinorArtifactsParagon MinorArtifactsLeviathan MinorArtifactsTreasureMapChest
		public static Type[] MinorArtifacts{ get{ return m_MinorArtifacts; } }
		
		private static Type[] m_MinorArtifacts = new Type[]
		{
			typeof( BurglarsBandana),			typeof( DreadPirateHat ),				typeof( GlovesOfThePugilist ),
			typeof( HeartOfTheLion ), 			typeof( OrcishVisage ),					typeof( PolarBearMask ),
			typeof( VioletCourage ),			typeof( ShieldOfInvulnerability ),		typeof( ArcticDeathDealer ), 
			typeof( BlazeOfDeath ),				typeof( BowOfTheJukaKing ),				typeof( CaptainQuacklebushsCutlass ),
			typeof( CavortingClub ),			typeof( ColdBlood ),					typeof( EnchantedTitanLegBone ),
			typeof( LunaLance ),				typeof( NightsKiss ),					typeof( NoxRangersHeavyCrossbow ),
			typeof( PixieSwatter ),				typeof( StaffOfPower ),					typeof( WrathOfTheDryad ),
			typeof( AlchemistsBauble ),			typeof( CandelabraOfSouls ),			typeof( GhostShipAnchor ),
			typeof( GoldBricks ),				typeof( PhillipsWoodenSteed ),			typeof( SeahorseStatuette ),
			typeof( ShipModelOfTheHMSCape ),	typeof( AdmiralsHeartyRum ),			typeof( GwennosHarp ),
			typeof( IolosLute )
		};
		
		public static Type[] MinorArtifactsParagon{ get{ return m_MinorArtifactsParagon; } }
		
		private static Type[] m_MinorArtifactsParagon = new Type[]
		{
			...
			typeof( BurglarsBandana ), 			typeof( CavortingClub ),				typeof( EnchantedTitanLegBone ), 
			typeof( GwennosHarp ),				typeof( IolosLute ), 					typeof( LunaLance ),
			typeof( NightsKiss ), 				typeof( NoxRangersHeavyCrossbow ),		typeof( OrcishVisage ),
			typeof( PolarBearMask ),			typeof( ShieldOfInvulnerability ), 		typeof( StaffOfPower ),
			typeof( VioletCourage ), 			typeof( HeartOfTheLion ), 				typeof( WrathOfTheDryad ), 
			typeof( PixieSwatter ),				typeof( GlovesOfThePugilist )			
		};

		public static Type[] MinorArtifactsLeviathan{ get{ return m_MinorArtifactsLeviathan; } }
		
		private static Type[] m_MinorArtifactsLeviathan = new Type[]
		{
			typeof( CandelabraOfSouls ),		typeof( GhostShipAnchor ),				typeof( GoldBricks ),
			typeof( PhillipsWoodenSteed ),		typeof( SeahorseStatuette ),			typeof( ShipModelOfTheHMSCape ),
			typeof( AdmiralsHeartyRum ),		typeof( AlchemistsBauble ),				typeof( ArcticDeathDealer ),
			typeof( BlazeOfDeath ),				typeof( BurglarsBandana ),				typeof( CaptainQuacklebushsCutlass ),
			typeof( CavortingClub ),			typeof( DreadPirateHat ),				typeof( EnchantedTitanLegBone ),
			typeof( GwennosHarp ),				typeof( IolosLute ),					typeof( LunaLance ),
			typeof( NightsKiss ),				typeof( NoxRangersHeavyCrossbow ),		typeof( PolarBearMask ),
			typeof( VioletCourage )
		};
		
		public static Type[] MinorArtifactsTreasureMapChest{ get{ return m_MinorArtifactsTreasureMapChest; } }
		
		private static Type[] m_MinorArtifactsTreasureMapChest = new Type[]
		{
			...
			typeof( GwennosHarp ), 				typeof( IolosLute ),					typeof( LunaLance ), 				
			typeof( NightsKiss ), 				typeof( NoxRangersHeavyCrossbow ),		typeof( PolarBearMask ), 			
			typeof( VioletCourage ), 			typeof( HeartOfTheLion ),				typeof( ColdBlood ), 				
		...
		public static Item RandomMajorArtifact()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MajorArtifacts );
			StringToLog( string.Format( "Artefatto maggiore {0} creato in data {1} tramite Loot.RandomMajorArtifact().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}
		
		public static Item RandomMajorArtifactNoSteal()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MajorArtifactsNoSteal );
			StringToLog( string.Format( "Artefatto maggiore {0} creato in data {1} tramite Loot.RandomMajorArtifactNoSteal().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}

		public static Item RandomMajorArtifactRar11()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MajorArtifactsRar11 );
			StringToLog( string.Format( "Artefatto maggiore di rarità 11 {0} creato in data {1} tramite Loot.RandomMajorArtifactRar11().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}
		
		public static Item RandomMajorArtifactRar10()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MajorArtifactsRar10 );
			StringToLog( string.Format( "Artefatto maggiore di rarità 10 {0} creato in data {1} tramite Loot.RandomMajorArtifactRar10().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}		
		
		public static Item RandomMajorStealableArtifact()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MajorStealableArtifacts );
			StringToLog( string.Format( "Artefatto maggiore stealable{0} creato in data {1} tramite Loot.RandomMajorStealableArtifact().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}	
		
		public static Item RandomMinorArtifact()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MinorArtifacts );
			StringToLog( string.Format( "Artefatto minore {0} creato in data {1} tramite Loot.RandomMinorArtifact().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}
		
		public static Item RandomMinorArtifactParagon()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MinorArtifactsParagon );
			StringToLog( string.Format( "Artefatto minore da paragon {0} creato in data {1} tramite Loot.RandomMinorArtifactParagon().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}
		
		public static Item RandomMinorArtifactLeviathan()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MinorArtifactsLeviathan );
			StringToLog( string.Format( "Artefatto minore da leviatano {0} creato in data {1} tramite Loot.RandomMinorArtifactLeviathan().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}
		
		public static Item RandomMinorArtifactTreasureMapChest()
		{
            if( !Core.AOS )
                return null;

			Item i = Construct( MinorArtifactsTreasureMapChest );
			StringToLog( string.Format( "Artefatto minore {0} creato in data {1} tramite Loot.MinorArtifactsTreasureMapChest().",
			                            i.GetType().Name, DateTime.Now.ToString() ), "Logs/Midgard2ArtifactsLog.txt" );
			return i;
		}
		#endregion
		...
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldWearableLoot.GetClothing.Construct() as BaseClothing;
            #endregion
		...
		public static BaseWeapon RandomRangedWeapon( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldWeaponsLoot.RangedWeapon.Construct() as BaseWeapon;
            #endregion
		...
		public static BaseWeapon RandomWeapon( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldWeaponsLoot.Weapons.Construct() as BaseWeapon;
            #endregion
		...
		public static Item RandomWeaponOrJewelry( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return Utility.RandomBool() ? (Item)RandomWeapon() : RandomJewelry();
            #endregion
		...
		public static BaseJewel RandomJewelry()
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldWearableLoot.GetJewelry.Construct() as BaseJewel;
            #endregion
		...
		public static BaseArmor RandomArmor( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldArmorsLoot.Armors.Construct() as BaseArmor;
            #endregion
		...
		public static BaseHat RandomHat( bool inTokuno )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldWearableLoot.RandomHat.Construct() as BaseHat;
            #endregion
		...
		public static Item RandomArmorOrHat( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return Utility.RandomBool() ? (Item)RandomArmor() : RandomHat();
            #endregion
		...
		public static BaseShield RandomShield()
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return OldArmorsLoot.GetExtraArmor.Construct() as BaseShield;
            #endregion
		...
		public static Item RandomArmorOrShieldOrJewelry( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return Utility.RandomBool() ? (Item)RandomArmor() : RandomJewelry();
            #endregion
		...
		public static Item RandomArmorOrShieldOrWeapon( bool inTokuno, bool isMondain )
		{
            #region mod by Dies Irae [third crown loot system]
            if( Core.T2A )
                return Utility.RandomBool() ? (Item)RandomShield() : RandomWeapon();
            #endregion
		...
		public static Item RandomArmorOrShieldOrWeaponOrJewelry( bool inTokuno, bool isMondain )
		{
            ...
            if( Core.T2A )
            {
                ...
                {
                    case 0: return RandomArmor();
                    case 1: return RandomWeapon();
                    case 2: return RandomJewelry();
                    default: return null;
                }
            }
            #endregion
