...
namespace Server.Misc
{
	public class Email
	{
        ...
        private const string User = "staff@midgardshard.it";

        private const string Password = "midgard";

		public static readonly string EmailServer = "smtp.midgardshard.it";

		public static readonly string CrashAddresses = "m.visintin@fvgs.it";
		...
		{
			if ( EmailServer != null )
				_Client = new SmtpClient( EmailServer, 25 );
