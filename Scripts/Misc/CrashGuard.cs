	...
	public class CrashGuard
	{
		...
		private static void Backup()
		{
			...
			try
			{
                ...
                CreateDirectory( rootBackup, "Attachments/" );
                CopyFile( rootOrigin, rootBackup, "Attachments/Attachments.bin" );
                CopyFile( rootOrigin, rootBackup, "Attachments/Attachments.fpi" );
                CopyFile( rootOrigin, rootBackup, "Attachments/Attachments.ima" );

                CreateDirectory( rootBackup, "ClassSystem/" );
                CopyFile( rootOrigin, rootBackup, "ClassSystem/ClassSystemSave.bin" );

                CreateDirectory( rootBackup, "CommercialSystem/" );
                CopyFile( rootOrigin, rootBackup, "CommercialSystem/CommercialStatus.bin" );

                CreateDirectory( rootBackup, "Jailings/" );
                CopyFile( rootOrigin, rootBackup, "Jailings/Jailings.bin" );
                CopyFile( rootOrigin, rootBackup, "Jailings/Jailings.idx" );

                CreateDirectory( rootBackup, "MailSystem/" );
                CopyFile( rootOrigin, rootBackup, "MailSystem/Mails.bin" );

                CreateDirectory( rootBackup, "OrderChaosWars/" );
                CopyFile( rootOrigin, rootBackup, "OrderChaosWars/Wars.bin" );

                CreateDirectory( rootBackup, "RaceSystem/" );
                CopyFile( rootOrigin, rootBackup, "RaceSystem/RaceSystemSave.bin" );

                CreateDirectory( rootBackup, "SkillSystem/" );
                CopyFile( rootOrigin, rootBackup, "SkillSystem/SkillSave.bin" );

                CreateDirectory( rootBackup, "TownSystem/" );
                CopyFile( rootOrigin, rootBackup, "TownSystem/TownJailSystemSave.bin" );
                CopyFile( rootOrigin, rootBackup, "TownSystem/TownSystemSave.bin" );

                CreateDirectory( rootBackup, "World/" );
                CopyFile( rootOrigin, rootBackup, "World/GroupsList.bin" );
                #endregion
		...
		private static void GenerateCrashReport( CrashedEventArgs e )
		{
			...
			{
				string timeStamp = GetTimeStamp();
				string fileName = String.Format( "Logs/Crash {0}.log", timeStamp );
