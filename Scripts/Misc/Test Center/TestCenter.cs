...
namespace Server.Misc
{
	...
	{
		private static bool m_Enabled = Midgard.Misc.Midgard2Persistance.TestCenterEnabled; // Mod by Dies Irae
		...
		{
			if ( value < 10 || value > 100 ) // mod by Dies Irae
			{
		...
		public class TCHelpGump : Gump
		{
			public TCHelpGump() : base( 40, 40 )
			{
				...
				AddLabel( 45, 10, 0x34, "http://www.midgardshard.it" ); // mod by Dies Irae
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				switch ( info.ButtonID )
				{
					case 1: // RunUO.com
					{
						sender.LaunchBrowser( "http://www.midgardshard.it" ); // mod by Dies Irae
						break;
					}
