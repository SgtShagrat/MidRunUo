...
namespace Server.Misc
{
	public class ServerList
	{
		...
		*/
		...
		public static readonly string Address = Midgard.Misc.Midgard2Persistance.Address;
		public static readonly string ServerName = Midgard.Misc.Midgard2Persistance.ServerName;
		#endregion
		...
		private static bool IsPrivateNetwork( IPAddress ip )
		{
			...
			if ( IPAddress.IsLoopback ( ip ) ) //loopback is private network too :-)
				return true;
			...
			if ( Utility.IPMatch( "192.168.*", ip ) )
				...
				return true;
			else if ( Utility.IPMatch( "5.*", ip ) ) // Hamachi
				return true;
			else
				return false;
		}
