...
namespace Midgard.Commands
{
    ...
    public class FireFeet
    {
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register( "FireFeet", AccessLevel.Administrator, new CommandEventHandler( FireFeet_OnCommand ) );
            CommandSystem.Register( "FireFeetSettings", AccessLevel.Administrator, new CommandEventHandler( FireFeetSettings_OnCommand ) );
