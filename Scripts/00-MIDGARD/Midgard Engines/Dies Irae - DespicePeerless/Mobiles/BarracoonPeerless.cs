/***************************************************************************
 *                               Dies Irae - BarracoonPeerless.cs
 *                            -------------------
...
{
    public class BarracoonPeerless : BasePeerless
    {
        [Constructable]
        public BarracoonPeerless()
            : base( AIType.AI_BossMelee, FightMode.Closest, 10, 1, 0.2, 0.4 )
        {
            ...
            {
                XmlChampionBoss a = new XmlChampionBoss( true, true, true, ChampionSkullType.Greed, 6, 12 );
                a.Name = "ChampionBoss";
        ...
        public BarracoonPeerless( Serial serial )
            : base( serial )
        {
        }
