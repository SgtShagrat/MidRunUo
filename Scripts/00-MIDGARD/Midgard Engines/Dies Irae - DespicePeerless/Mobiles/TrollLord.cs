...
{
    [CorpseName( "a troll lord corpse" )]
    public class TrollLord : Troll
    {
        [Constructable]
        public TrollLord()
        {
        ...
        public TrollLord( Serial serial )
            : base( serial )
        {
        }
        ...
        public override int AreaPoisonDamage
        {
            get { return 50; }
        }
        ...
        public override string ApplyNameSuffix( string suffix )
        {
            ...
            {
                if( suffix.Length == 0 )
                    suffix = "[lord of trolls]";
                else
                    suffix = String.Concat( suffix, " [lord of trolls]" );
            }
