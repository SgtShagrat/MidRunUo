...
namespace Midgard.Mobiles
{
    ...
    public class LizardmenLord : Lizardman
    {
        [Constructable]
        public LizardmenLord()
        {
            Name = "Issthissh Dragonborn";
        ...
        public LizardmenLord(Serial serial)
            : base(serial)
        {
        }
        ...
        public override string ApplyNameSuffix(string suffix)
        {
            ...
            {
                if (suffix.Length == 0)
                    suffix = "[lord of lizardmen]";
                else
                    suffix = String.Concat(suffix, " [lord of lizardmen]");
            }
