...
{
    [CorpseName( "a titan lord corpse" )]
    public class TitanLord : Titan
    {
        [Constructable]
        public TitanLord()
        {
            Name = Utility.RandomStringList( "Cronus", "Iapetus", "Oceanus", "Hyperion", "Crius", "Coeus", "Cronus" );
        ...
        public TitanLord( Serial serial )
            : base( serial )
        {
        }
        ...
        public override int AreaEnergyDamage
        {
            get { return 50; }
        }
        ...
        public override string ApplyNameSuffix( string suffix )
        {
            ...
            {
                if( suffix.Length == 0 )
                    suffix = "[lord of titans]";
                else
                    suffix = String.Concat( suffix, " [lord of titans]" );
            }
