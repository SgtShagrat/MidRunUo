...
{
    public class HonestyQuestOne : BaseQuest
    {
        public override QuestChain ChainID { get { return QuestChain.VirtueChampionHonesty; } }

        public override Type NextQuest { get { return typeof( HonestyQuestTwo ); } }
        ...
        public override object Title { get { return "Honesty (the unholy gem)"; } }

        public override object Description
        {
            get
            {
                return "<em>Honesty is nonjudgmental empathy for one's fellow creatures.</em><br>" +
                       "Give me a pure stone of Honesty to complete the overall mission.<br>" +
        ...
        public override object Uncomplete { get { return "Return once ye have purified a gem of Honesty."; } }

        public override object Complete { get { return "Well donw. Now you are ready for the main mission I have to give you."; } }

        public HonestyQuestOne()
        {
    ...
    public class HonestyQuestTwo : BaseQuest
    {
        public override QuestChain ChainID { get { return QuestChain.VirtueChampionHonesty; } }

        public override Type NextQuest { get { return typeof( HonestyQuestThree ); } }
        ...
        public override object Title { get { return "Honesty (the purification)"; } }

        public override object Description
        {
            get
            {
                return "Purify your Honesty corrupted gem at the shrine of Honesty.<br>" +
        ...
        private class InternalObjective : SlayObjective
        {
            ...
            public override bool IsObjective( Mobile mob )
            {
                return mob is Soulkeeper && ( (Soulkeeper)mob ).Virtue == Virtues.Honesty;
            }
        }
    ...
    public class HonestyQuestThree : BaseQuest
    {
        public override QuestChain ChainID { get { return QuestChain.VirtueChampionHonesty; } }
        ...
        public override object Title { get { return "Honesty (the holy gem)"; } }

        public override object Description
        {
            get
            {
                return "Let me to touch the gem of Honesty purified by sins and cleaned with sacred blood.";
            }
        }
        ...
        private class InternalObjective : ObtainObjective
        {
            ...
            {
                return item is VirtueChampionGem && ( (VirtueChampionGem)item ).Virtue == Virtues.Honesty && ( (VirtueChampionGem)item ).Purified;
            }
        }
