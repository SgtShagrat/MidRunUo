...
{
    public class JusticeQuestOne : BaseQuest
    {
        public override QuestChain ChainID { get { return QuestChain.VirtueChampionJustice; } }

        public override Type NextQuest { get { return typeof( JusticeQuestTwo ); } }
        ...
        public override object Title { get { return "Justice (the unholy gem)"; } }

        public override object Description
        {
            get
            {
                return "<em>Justice is nonjudgmental empathy for one's fellow creatures.</em><br>" +
                       "Give me a pure stone of Justice to complete the overall mission.<br>" +
        ...
        public override object Uncomplete { get { return "Return once ye have purified a gem of Justice."; } }

        public override object Complete { get { return "Well donw. Now you are ready for the main mission I have to give you."; } }

        public JusticeQuestOne()
        {
    ...
    public class JusticeQuestTwo : BaseQuest
    {
        public override QuestChain ChainID { get { return QuestChain.VirtueChampionJustice; } }

        public override Type NextQuest { get { return typeof( JusticeQuestThree ); } }
        ...
        public override object Title { get { return "Justice (the purification)"; } }

        public override object Description
        {
            get
            {
                return "Purify your Justice corrupted gem at the shrine of Justice.<br>" +
        ...
        private class InternalObjective : SlayObjective
        {
            ...
            public override bool IsObjective( Mobile mob )
            {
                return mob is Soulkeeper && ( (Soulkeeper)mob ).Virtue == Virtues.Justice;
            }
        }
    ...
    public class JusticeQuestThree : BaseQuest
    {
        public override QuestChain ChainID { get { return QuestChain.VirtueChampionJustice; } }
        ...
        public override object Title { get { return "Justice (the holy gem)"; } }

        public override object Description
        {
            get
            {
                return "Let me to touch the gem of Justice purified by sins and cleaned with sacred blood.";
            }
        }
        ...
        private class InternalObjective : ObtainObjective
        {
            ...
            {
                return item is VirtueChampionGem && ( (VirtueChampionGem)item ).Virtue == Virtues.Justice && ( (VirtueChampionGem)item ).Purified;
            }
        }
