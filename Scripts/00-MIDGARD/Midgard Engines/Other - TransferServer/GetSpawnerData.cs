        ...
        public override TransferMessage ProcessMessage()
        {
            ...
            foreach( var m in itemarray )
            {
                ...
                if( m is XmlSpawner && ( m.Map.MapID == SelectedMap || SelectedMap == -1 ) )
                {
                    ...
                    // name restricted?
                    if( passed && !string.IsNullOrEmpty( NameFilter ) )
                    {
                        if( NameCase )
                        {
                            // case sensitive
                    ...
                    // entry restricted?
                    if( passed && !string.IsNullOrEmpty( EntryFilter ) )
                    {
                        // search the entries of the spawner
                        bool found = false;
                        if( s.SpawnObjects != null )
                        {
                            foreach( SpawnObject so in s.SpawnObjects )
                            {
                                if( EntryCase )
                                {
                                    // case sensitive
                    ...
                    if( passed && ContainerFilter > 0 )
                    {
                        ...
                        else if( ContainerFilter == 2 && ( s.Parent is Container ) )
                        {
                            passed = false;
                        }
                    }
                    ...
                    if( passed && SequentialFilter > 0 )
                    {
                        ...
                        else if( SequentialFilter == 2 && ( s.SequentialSpawn >= 0 ) )
                        {
                            passed = false;
                        }
                    }
                    ...
                    if( passed && SmartSpawnFilter > 0 )
                    {
                        ...
                        else if( SmartSpawnFilter == 2 && s.SmartSpawning )
                        {
                            passed = false;
                        }
                    }
                    ...
                    if( passed && Modified > 0 )
                    {
                        ...
                        else if( Modified == 2 && s.LastModified < ModifiedDate )
                        {
                            passed = false;
                        }
                    }
                    ...
                    if( passed && Proximity > 0 )
                    {
                        ...
                        else if( Proximity == 2 && s.ProximityRange >= 0 )
                        {
                            passed = false;
                        }
                    }
                    ...
                    if( passed && SpawnTime > 0 )
                    {
                        ...
                        else if( SpawnTime == 2 && avgtime <= AvgSpawnTime )
                        {
                            passed = false;
                        }
                    }
                    ...
                    if( passed && ModifiedBy > 0 )
                    {
                        ...
                        else if( ModifiedBy == 2 && s.LastModifiedBy != ModifiedName )
                        {
                            passed = false;
                        }
                        else if( ModifiedBy == 3 && s.FirstModifiedBy == ModifiedName )
                        {
                            passed = false;
                        }
                        else if( ModifiedBy == 4 && s.LastModifiedBy == ModifiedName )
                        {
                            passed = false;
                        }
                    }
