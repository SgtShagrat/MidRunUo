    ...
    public class AuctionDeliveryGump : Gump
    {
        ...
        private void MakeGump()
        {
            ...
            if( m_Check is AuctionGoldCheck )
            {
                ...
                AddLabel( 70, 220, Config.AuctionLabelHue, AuctionSystem.ST[ 2 ] );
            }
            else
            {
                // Delivering an item
                ...
                AddLabel( 70, 220, Config.AuctionLabelHue, AuctionSystem.ST[ 3 ] );
            }
            ...
            // Item name
            AddLabelCropped( 55, 75, 200, 20, Config.AuctionLabelHue, m_Check.ItemName );
            ...
            if( m_Check.Auction != null )
            {
                ...
                AddLabel( 70, 240, Config.AuctionLabelHue, AuctionSystem.ST[ 6 ] );
            }

            // Button 0 : Close
            AddButton( 45, 263, 5601, 5605, 0, GumpButtonType.Reply, 0 );
            AddLabel( 70, 260, Config.AuctionLabelHue, AuctionSystem.ST[ 7 ] );
