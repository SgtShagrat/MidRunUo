...
namespace Midgard.Engines.AuctionSystem
{
    ...
    public class DeleteAuctionGump : Gump
    {
        ...
        private void MakeGump()
        {
            ...
            AddLabel( 70, 15, Config.AuctionRedHue, AuctionSystem.ST[ 96 ] );
            AddHtml( 30, 45, 285, 130, AuctionSystem.ST[ 97 ], false, false );

            // Close: Button 1
            AddButton( 30, 185, 4017, 4017, 1, GumpButtonType.Reply, 0 );
            AddLabel( 70, 185, Config.AuctionRedHue, AuctionSystem.ST[ 98 ] );
            AddButton( 30, 215, 4014, 4015, 0, GumpButtonType.Reply, 0 );
            AddLabel( 70, 215, Config.AuctionGreenHue, AuctionSystem.ST[ 99 ] );
        }
