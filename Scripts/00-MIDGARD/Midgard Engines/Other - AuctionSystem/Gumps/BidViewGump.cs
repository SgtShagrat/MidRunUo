...
namespace Midgard.Engines.AuctionSystem
{
    ...
    public class BidViewGump : Gump
    {
        ...
        public BidViewGump( Mobile m, List<Bid> bids, AuctionGumpCallback callback )
            : this( m, bids, callback, 0 )
        {
        }

        public BidViewGump( Mobile m, List<Bid> bids, AuctionGumpCallback callback, int page )
            : base( 100, 100 )
        {
        ...
        private void MakeGump()
        {
            ...
            AddLabel( 12, 5, Config.AuctionRedHue, AuctionSystem.ST[ 86 ] );

            AddLabel( 160, 5, Config.AuctionGreenHue, string.Format( AuctionSystem.ST[ 18 ], m_Page + 1, numOfPages ) );
            ...
            AddLabel( 55, 30, Config.AuctionGreenHue, AuctionSystem.ST[ 87 ] );
            AddImageTiled( 156, 31, 129, 19, 9274 );
            AddAlphaRegion( 156, 31, 129, 19 );
            AddLabel( 160, 30, Config.AuctionGreenHue, AuctionSystem.ST[ 88 ] );
            ...
            for( int i = 0; i < 10; i++ )
            {
                ...
                if( m_Page * 10 + i < m_Bids.Count )
                {
                    ...
                    AddLabel( 15, 50 + i * 20, Config.AuctionLabelHue, ( m_Page * 10 + i + 1 ).ToString() );
                    if( bid != null )
                    {
                        AddLabelCropped( 55, 50 + i * 20, 100, 19, Config.AuctionLabelHue,
                                        bid.Mobile != null ? bid.Mobile.Name : AuctionSystem.ST[ 78 ] );
                        AddLabel( 160, 50 + i * 20, Config.AuctionLabelHue, bid.Amount.ToString( "#,0" ) );
                    }
                }
            }

            AddButton( 10, 255, 4011, 4012, 0, GumpButtonType.Reply, 0 );
            AddLabel( 48, 257, Config.AuctionLabelHue, AuctionSystem.ST[ 89 ] );
