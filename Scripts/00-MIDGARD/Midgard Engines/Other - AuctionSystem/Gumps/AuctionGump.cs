...
namespace Midgard.Engines.AuctionSystem
{
    ...
    public class AuctionGump : Gump
    {
        ...
        private void MakeGump()
        {
            ...
            AddLabel( 100, 130, Config.AuctionLabelHue, AuctionSystem.ST[ 9 ] );
            AddButton( 60, 130, 4005, 4006, 1, GumpButtonType.Reply, 0 );

            // View all auctions: B2
            AddLabel( 285, 130, Config.AuctionLabelHue, AuctionSystem.ST[ 10 ] );
            AddButton( 245, 130, 4005, 4006, 2, GumpButtonType.Reply, 0 );

            // View your auctions: B3
            AddLabel( 100, 165, Config.AuctionLabelHue, AuctionSystem.ST[ 11 ] );
            AddButton( 60, 165, 4005, 4006, 3, GumpButtonType.Reply, 0 );

            // View your bids: B4
            AddLabel( 285, 165, Config.AuctionLabelHue, AuctionSystem.ST[ 12 ] );
            AddButton( 245, 165, 4005, 4006, 4, GumpButtonType.Reply, 0 );

            // View pendencies: B5
            AddButton( 60, 200, 4005, 4006, 5, GumpButtonType.Reply, 0 );
            AddLabel( 100, 200, Config.AuctionLabelHue, AuctionSystem.ST[ 13 ] );

            // Exit: B0
            AddLabel( 285, 205, Config.AuctionLabelHue, AuctionSystem.ST[ 14 ] );
