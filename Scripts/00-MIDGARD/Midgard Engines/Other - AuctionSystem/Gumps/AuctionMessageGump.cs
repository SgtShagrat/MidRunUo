...
namespace Midgard.Engines.AuctionSystem
{
    ...
    public class AuctionMessageGump : Gump
    {
        ...
        private void MakeGump()
        {
            ...
            if( auction != null )
            {
                AddLabel( 125, 85, Config.AuctionRedHue, auction.ItemName );

                AddButton( 65, 112, 9762, 9763, 0, GumpButtonType.Reply, 0 );
                AddLabel( 85, 110, Config.AuctionLabelHue, AuctionSystem.ST[ 27 ] );
            }
            else
            {
                AddLabel( 125, 85, Config.AuctionRedHue, AuctionSystem.ST[ 28 ] );
            }

            AddHtml( 75, 170, 413, 120, m_HtmlMessage, true, false );
            AddLabel( 75, 150, Config.AuctionLabelHue, AuctionSystem.ST[ 29 ] );
            ...
            if( m_InformationMode )
            {
                ...
                AddLabel( 125, 355, Config.AuctionLabelHue, m_OkText );
            }
            else
            {
                AddButton( 45, 300, 1147, 1149, 1, GumpButtonType.Reply, 0 );
                AddLabel( 125, 310, Config.AuctionLabelHue, m_OkText );
                AddButton( 45, 345, 1144, 1146, 2, GumpButtonType.Reply, 0 );
                AddLabel( 125, 355, Config.AuctionLabelHue, m_CancelText );
            }

            if( m_ShowExpiration && auction != null )
            {
                AddLabel( 55, 405, Config.AuctionRedHue,
        ...
        public override void OnResponse( NetState sender, RelayInfo info )
        {
            ...
            if( auction == null )
            {
                sender.Mobile.SendMessage( Config.MessageHue, AuctionSystem.ST[ 31 ] );
                return;
            }
