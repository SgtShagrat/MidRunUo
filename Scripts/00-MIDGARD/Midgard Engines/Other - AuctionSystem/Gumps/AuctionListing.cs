...
namespace Midgard.Engines.AuctionSystem
{
    ...
    public class AuctionListing : Gump
    {
        ...
        public AuctionListing( Mobile m, IEnumerable<AuctionItem> items, bool searchEnabled, bool returnToAuction, int page )
            : base( 50, 50 )
        {
        ...
        private void MakeGump()
        {
            ...
            if( m_EnableSearch )
            {
                AddLabel( 305, 120, Config.AuctionLabelHue, AuctionSystem.ST[ 16 ] );
                AddButton( 270, 120, 4005, 4006, 1, GumpButtonType.Reply, 0 );
            }

            // Sort: BUTTON 2
            AddLabel( 395, 120, Config.AuctionLabelHue, AuctionSystem.ST[ 17 ] );
            ...
            if( m_List.Count > 0 )
            {
                ...
                AddLabel( 360, 95, Config.AuctionRedHue, string.Format( AuctionSystem.ST[ 18 ], m_Page + 1, ( m_List.Count - 1 ) / 10 + 1 ) );
                AddLabel( 70, 120, Config.AuctionRedHue, string.Format( AuctionSystem.ST[ 19 ], m_List.Count ) );
            }
            else
                AddLabel( 70, 120, Config.AuctionRedHue, AuctionSystem.ST[ 20 ] );
            ...
            if( m_List.Count > 0 )
            {
                for( int i = 0; i < 10 && ( m_Page * 10 + i ) < m_List.Count; i++ )
                {
                    ...
                    */
                    ...
                    AddLabelCropped( 100, 150 + i * 20, 260, 20, 88, string.Format( "${0}", item.MinNewBid ) );
            ...
            {
                AddLabel( 355, 360, Config.AuctionLabelHue, AuctionSystem.ST[ 22 ] );
            ...
            if( m_Page > 0 )
            {
                AddLabel( 180, 360, Config.AuctionLabelHue, AuctionSystem.ST[ 21 ] );
                AddButton( 280, 360, 4014, 4015, 4, GumpButtonType.Reply, 0 );
            }

            // Close: BUTTON 0
            AddLabel( 115, 360, Config.AuctionLabelHue, AuctionSystem.ST[ 7 ] );
            ...
            switch( info.ButtonID )
            {
                ...
                default:
                    ...
                    if( index < 0 || index >= m_List.Count )
                    {
                        ...
                        sender.Mobile.SendMessage( Config.MessageHue, AuctionSystem.ST[ 23 ] );
                    ...
                    if( item != null )
                    {
                        ...
                        {
                            sender.Mobile.SendMessage( Config.MessageHue, AuctionSystem.ST[ 24 ] );
