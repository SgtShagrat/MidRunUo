...
namespace Midgard.Engines.AuctionSystem
{
    public class AuctionSortGump : Gump
    {
        ...
        public AuctionSortGump( Mobile m, List<AuctionItem> items, bool returnToAuction, bool search )
            : base( 50, 50 )
        {
        ...
        private void MakeGump()
        {
            ...
            AddLabel( 160, 45, Config.AuctionGreenHue, AuctionSystem.ST[ 49 ] );

            AddLabel( 95, 125, Config.AuctionRedHue, AuctionSystem.ST[ 50 ] );
            AddImage( 75, 125, 2511 );

            AddButton( 110, 144, 9702, 9703, 1, GumpButtonType.Reply, 0 );

            AddLabel( 135, 141, Config.AuctionLabelHue, AuctionSystem.ST[ 51 ] );

            AddButton( 110, 163, 9702, 9703, 2, GumpButtonType.Reply, 0 );

            AddLabel( 135, 160, Config.AuctionLabelHue, AuctionSystem.ST[ 52 ] );

            AddImage( 420, 280, 10412 );
            AddLabel( 95, 185, Config.AuctionRedHue, AuctionSystem.ST[ 53 ] );
            AddImage( 75, 185, 2511 );

            AddButton( 110, 204, 9702, 9703, 3, GumpButtonType.Reply, 0 );

            AddLabel( 135, 201, Config.AuctionLabelHue, AuctionSystem.ST[ 54 ] );

            AddButton( 110, 223, 9702, 9703, 4, GumpButtonType.Reply, 0 );

            AddLabel( 135, 220, Config.AuctionLabelHue, AuctionSystem.ST[ 55 ] );

            AddLabel( 95, 245, Config.AuctionRedHue, AuctionSystem.ST[ 56 ] );
            AddImage( 75, 245, 2511 );

            AddButton( 110, 264, 9702, 9703, 5, GumpButtonType.Reply, 0 );

            AddLabel( 135, 261, Config.AuctionLabelHue, AuctionSystem.ST[ 57 ] );

            AddButton( 110, 283, 9702, 9703, 6, GumpButtonType.Reply, 0 );

            AddLabel( 135, 280, Config.AuctionLabelHue, AuctionSystem.ST[ 58 ] );

            AddLabel( 290, 125, Config.AuctionRedHue, AuctionSystem.ST[ 59 ] );
            AddImage( 270, 125, 2511 );

            AddButton( 305, 144, 9702, 9703, 7, GumpButtonType.Reply, 0 );

            AddLabel( 330, 141, Config.AuctionLabelHue, AuctionSystem.ST[ 60 ] );

            AddButton( 305, 163, 9702, 9703, 8, GumpButtonType.Reply, 0 );

            AddLabel( 330, 160, Config.AuctionLabelHue, AuctionSystem.ST[ 61 ] );

            AddLabel( 290, 185, Config.AuctionRedHue, AuctionSystem.ST[ 62 ] );
            AddImage( 270, 185, 2511 );

            AddButton( 305, 204, 9702, 9703, 9, GumpButtonType.Reply, 0 );

            AddLabel( 330, 201, Config.AuctionLabelHue, AuctionSystem.ST[ 63 ] );

            AddButton( 305, 223, 9702, 9703, 10, GumpButtonType.Reply, 0 );

            AddLabel( 330, 220, Config.AuctionLabelHue, AuctionSystem.ST[ 64 ] );

            AddLabel( 290, 245, Config.AuctionRedHue, AuctionSystem.ST[ 65 ] );
            AddImage( 270, 245, 2511 );

            AddButton( 305, 264, 9702, 9703, 11, GumpButtonType.Reply, 0 );

            AddLabel( 330, 261, Config.AuctionLabelHue, AuctionSystem.ST[ 63 ] );

            AddButton( 305, 283, 9702, 9703, 12, GumpButtonType.Reply, 0 );

            AddLabel( 330, 280, Config.AuctionLabelHue, AuctionSystem.ST[ 64 ] );

            AddLabel( 120, 315, Config.AuctionLabelHue, AuctionSystem.ST[ 66 ] );
