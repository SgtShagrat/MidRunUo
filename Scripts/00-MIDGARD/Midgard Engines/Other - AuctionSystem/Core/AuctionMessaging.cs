...
namespace Midgard.Engines.AuctionSystem
{
    ...
    public class AuctionMessaging
    {
        ...
        public static void SendOutbidMessage( AuctionItem auction, int amount, Mobile to )
        {
            ...
            gump.OkText = AuctionSystem.ST[ 238 ]; //  "Close this message"
        ...
        public static void SendReserveMessageToOwner( AuctionItem item )
        {
            ...
            string msg = string.Format( AuctionSystem.ST[ 180 ], item.HighestBid.Amount, item.Reserve.ToString( "#,0" ) );
        ...
        public static void SendReserveMessageToBuyer( AuctionItem item )
        {
            ...
            gump.Message = string.Format( AuctionSystem.ST[ 184 ], Config.DaysForConfirmation, item.HighestBid.Amount, item.Reserve );
