    ...
    public class Auctioner : BaseVendor
    {
        ...
        public override void OnSpeech( SpeechEventArgs e )
        {
            if( e.Speech.ToLower().IndexOf( "auction" ) > -1 )
            {
                ...
                {
                    SayTo( e.Mobile, AuctionSystem.ST[ 236 ] ); // "Am I hearing voices?"
                }
                ...
                {
                    SayTo( e.Mobile, AuctionSystem.ST[ 237 ] ); // "Sorry, we're closed at this time. Please try again later." 
                }
            }
        ...
        internal class TradeHouseEntry : ContextMenuEntry
        {
