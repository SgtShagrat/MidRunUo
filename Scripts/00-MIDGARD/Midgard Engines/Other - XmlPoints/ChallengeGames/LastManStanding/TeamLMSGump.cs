...
namespace Server.Engines.XmlPoints
{
    public class TeamLMSGump : Gump
    {
            ...
            : base( 20, 30 )
        {
            ...
            AddLabel( 100, 10, 0, XmlPointsAttach.GetText( from, 200610 ) ); // "Team LMS Challenge"
            ...
            if( gauntlet.Participants != null )
            {
                ...
                {
                    var entry = (TeamLMSGauntlet.ChallengeEntry)m_WorkingList[ i ];
                ...
                AddLabel( 155, 110, 0, XmlPointsAttach.GetText( from, 200591 ) ); // "Team"
            ...
            if( from == gauntlet.Challenger && !m_Gauntlet.GameLocked )
            {
                ...
                AddLabel( 270, height - 85, 0, XmlPointsAttach.GetText( from, 200592 ) ); // "Set Teams"
        ...
        public override void OnResponse( NetState state, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump( new TeamLMSGump( m_Gauntlet, state.Mobile, m_Viewpage ) );
                    break;
                ...
                default:
                    {
                        ...
                        if( info.ButtonID >= 4000 )
                        {
                            ...
                            {
                                var entry = (TeamLMSGauntlet.ChallengeEntry)m_WorkingList[ selection ];
        ...
        private class MemberTarget : Target
        {
            ...
            public MemberTarget( TeamLMSGauntlet gauntlet, List<BaseChallengeEntry> list )
        ...
        {
            public TeamsGump( BaseChallengeGame gauntlet, Mobile from )
                : base( 350, 30 )
            {
                ...
                AddLabel( 50, 10, 0, XmlPointsAttach.GetText( from, 200611 ) ); // "LMS Team Status"
