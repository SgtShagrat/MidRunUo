...
namespace Server.Engines.XmlPoints
{
    public class TeamKotHGump : Gump
    {
            ...
            : base( 20, 30 )
        {
            ...
            AddLabel( 100, 10, 0, XmlPointsAttach.GetText( from, 200600 ) ); // "Team KotH Challenge"
            ...
            if( gauntlet.Participants != null )
            {
                ...
                {
                    var entry = (TeamKotHGauntlet.ChallengeEntry)m_WorkingList[ i ];
        ...
        public override void OnResponse( NetState state, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump( new TeamKotHGump( m_Gauntlet, state.Mobile, m_Viewpage ) );
                    break;
                ...
                default:
                    {
                        ...
                        if( info.ButtonID >= 4000 )
                        {
                            ...
                            {
                                var entry = (TeamKotHGauntlet.ChallengeEntry)m_WorkingList[ selection ];
        ...
        private class MemberTarget : Target
        {
            ...
            public MemberTarget( TeamKotHGauntlet gauntlet, List<BaseChallengeEntry> list )
        ...
        public class TeamsGump : Gump
        {
                ...
                : base( 350, 30 )
            {
                ...
                AddLabel( 60, 10, 0, XmlPointsAttach.GetText( from, 200601 ) ); // "KotH Team Status"
