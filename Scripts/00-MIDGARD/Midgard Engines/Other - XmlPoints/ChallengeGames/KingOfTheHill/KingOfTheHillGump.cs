...
namespace Server.Engines.XmlPoints
{
    public class KingOfTheHillGump : Gump
    {
            ...
            : base( 20, 30 )
        {
            ...
            AddLabel( 100, 10, 0, XmlPointsAttach.GetText( from, 200580 ) ); // "King of the Hill Challenge"
            ...
            if( gauntlet.Participants != null )
            {
                ...
                {
                    var entry = (KingOfTheHillGauntlet.ChallengeEntry)m_WorkingList[ i ];
        ...
        public override void OnResponse( NetState state, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump( new KingOfTheHillGump( m_Gauntlet, state.Mobile, m_Viewpage ) );
                    break;
                ...
                default:
                    {
                        ...
                        if( info.ButtonID >= 4000 )
                        {
                            ...
                            {
                                var entry = (KingOfTheHillGauntlet.ChallengeEntry)m_WorkingList[ selection ];
        ...
        private class MemberTarget : Target
        {
            ...
            public MemberTarget( KingOfTheHillGauntlet gauntlet, List<BaseChallengeEntry> list )
