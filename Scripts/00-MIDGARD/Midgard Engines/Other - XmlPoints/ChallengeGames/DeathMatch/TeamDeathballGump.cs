...
namespace Server.Engines.XmlPoints
{
    public class TeamDeathballGump : Gump
    {
            ...
            : base( 20, 30 )
        {
            ...
            AddLabel( 100, 10, 0, XmlPointsAttach.GetText( from, 200630 ) ); // "Team Deathball Challenge"
        ...
        public override void OnResponse( NetState state, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump( new TeamDeathballGump( m_Gauntlet, state.Mobile, m_Viewpage ) );
                    break;
        ...
        private class MemberTarget : Target
        {
            ...
            public MemberTarget( TeamDeathballGauntlet gauntlet, List<BaseChallengeEntry> list )
        ...
        public class TeamsGump : Gump
        {
                ...
                : base( 350, 30 )
            {
                ...
                AddLabel( 60, 10, 0, XmlPointsAttach.GetText( from, 200631 ) ); // "Deathball Team Status"
