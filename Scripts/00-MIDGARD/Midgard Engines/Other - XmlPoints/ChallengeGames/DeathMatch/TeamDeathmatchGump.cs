...
namespace Server.Engines.XmlPoints
{
    public class TeamDeathmatchGump : Gump
    {
            ...
            : base( 20, 30 )
        {
            ...
            AddLabel( 100, 10, 0, XmlPointsAttach.GetText( from, 200590 ) ); // "Team Deathmatch Challenge"
            ...
            if( gauntlet.Participants != null )
            {
                ...
                {
                    var entry = (TeamDeathmatchGauntlet.ChallengeEntry)m_WorkingList[ i ];
        ...
        public override void OnResponse( NetState state, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump( new TeamDeathmatchGump( m_Gauntlet, state.Mobile, m_Viewpage ) );
                    break;
                ...
                default:
                    {
                        ...
                        if( info.ButtonID >= 4000 )
                        {
                            ...
                            {
                                var entry = (TeamDeathmatchGauntlet.ChallengeEntry)m_WorkingList[ selection ];
        ...
        private class MemberTarget : Target
        {
            ...
            public MemberTarget( TeamDeathmatchGauntlet gauntlet, List<BaseChallengeEntry> list )
        ...
        public class TeamsGump : Gump
        {
                ...
                : base( 350, 30 )
            {
                ...
                AddLabel( 60, 10, 0, XmlPointsAttach.GetText( from, 200595 ) ); // "Deathmatch Team Status"
