...
namespace Server.Engines.XmlPoints
{
    public class DeathmatchGump : Gump
    {
            ...
            : base( 20, 30 )
        {
            ...
            AddLabel( 100, 10, 0, XmlPointsAttach.GetText( from, 200560 ) ); // "Deathmatch Challenge"
            ...
            if( gauntlet.Participants != null )
            {
                ...
                {
                    var entry = (DeathmatchGauntlet.ChallengeEntry)m_WorkingList[ i ];
            ...
            if( from == gauntlet.Challenger && !m_Gauntlet.GameLocked )
            {
                ...
                AddLabel( 235, height - 60, 0, XmlPointsAttach.GetText( from, 200567 ) ); // "Length mins: "
            }
            else
            {
        ...
        public override void OnResponse( NetState state, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump( new DeathmatchGump( m_Gauntlet, state.Mobile, m_Viewpage ) );
                    break;
                ...
                default:
                    {
                        ...
                        if( info.ButtonID >= 4000 )
                        {
                            ...
                            {
                                var entry = (DeathmatchGauntlet.ChallengeEntry)m_WorkingList[ selection ];
        ...
        private class MemberTarget : Target
        {
            ...
            public MemberTarget( DeathmatchGauntlet gauntlet, List<BaseChallengeEntry> list )
