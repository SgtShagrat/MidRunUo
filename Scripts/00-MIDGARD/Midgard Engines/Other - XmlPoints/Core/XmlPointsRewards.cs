...
namespace Server.Engines.XmlPoints
{
    public class XmlPointsRewards
    {
        ...
        private static List<XmlPointsRewards> PointsRewardList = new List<XmlPointsRewards>();

        public static List<XmlPointsRewards> RewardsList
        {
        ...
        public static void Initialize()
        {
            ...
            PointsRewardList.Add( new XmlPointsRewards( 1000,
                                                        typeof( PowerScroll ),
                                                        "105 Smithing powerscroll",
                                                        1000,
                                                        0x14F0,
                                                        new object[] { SkillName.Blacksmith, 105 } ) );
            PointsRewardList.Add( new XmlPointsRewards( 2000,
                                                        typeof( PowerScroll ),
                                                        "110 Smithing powerscroll",
                                                        2000,
                                                        0x14F0,
                                                        new object[] { SkillName.Blacksmith, 110 } ) );
            PointsRewardList.Add( new XmlPointsRewards( 4000,
                                                        typeof( PowerScroll ),
                                                        "115 Smithing powerscroll",
                                                        4000,
                                                        0x14F0,
                                                        new object[] { SkillName.Blacksmith, 115 } ) );
            PointsRewardList.Add( new XmlPointsRewards( 500,
            ...
            PointsRewardList.Add( new XmlPointsRewards( 100,
            ...
            PointsRewardList.Add( new XmlPointsRewards( 0,
