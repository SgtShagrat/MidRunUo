...
namespace Server.Engines.XmlPoints
{
    public class ChallengeRegionStone : Item
    {
        ...
        public void RefreshRegions()
        {
            ...
            if( m_ChallengeMap == null || ChallengeArea == null )
                return;

            // define a new one based on the named region
            ChallengeRegion = new ChallengeGameRegion( m_ChallengeRegionName,
                                                       m_ChallengeMap,
                                                       m_Priority,
                                                       ChallengeArea );
                ...
                case 0:
                    {
                        ...
                        if( count > 0 )
                        {
                            ...
                            if( version < 2 )
                            {
                                var area = new Rectangle2D[ count ];
        ...
        private static void ChallengeRegionArea_Callback( Mobile from, Map map, Point3D start, Point3D end, object state )
        {
            ...
            var s = state as ChallengeRegionStone;
