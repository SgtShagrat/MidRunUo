...
namespace Server.Mobiles
{
	...
	public class WildKirin : BaseMount
	{
		...
		[Constructable]
		public WildKirin() : this( "a wild ki-rin" )
		{
		}

		[Constructable]
		public WildKirin( string name ) : base( name, 132, 0x3EAD, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x3C5;
		...
		public WildKirin( Serial serial ) : base( serial )
		{
		}
