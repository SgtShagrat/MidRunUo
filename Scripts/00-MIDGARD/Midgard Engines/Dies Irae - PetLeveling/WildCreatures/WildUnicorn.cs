...
namespace Server.Mobiles
{
	...
	public class WildUnicorn : BaseMount
	{
		...
		[Constructable]
		public WildUnicorn() : this( "a wild unicorn" )
		{
		}

		[Constructable]
		public WildUnicorn( string name ) : base( name, 0x7A, 0x3EB4, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x4BC;
		...
		public WildUnicorn( Serial serial ) : base( serial )
		{
		}
