...
namespace Server.Mobiles
{
	...
	public class WildWhiteWyrm : BaseCreature
	{
		[Constructable]
		public WildWhiteWyrm () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = Core.AOS ? 180 : 49;
			Name = "a wild white wyrm";
			BaseSoundID = 362;
		...
		public WildWhiteWyrm( Serial serial ) : base( serial )
		{
		}
