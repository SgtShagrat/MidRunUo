...
namespace Server.Engines.BulkOrders
{
	public class TamingBOBFilterGump : Gump
	{
		...
		{
			TamingBOBFilter f = ( m_From.UseOwnFilter ? ((Midgard2PlayerMobile)m_From).TamingBOBFilter : m_Book.Filter );
		...
		public TamingBOBFilterGump( PlayerMobile from, TamingBulkOrderBook book ) : base( 12, 24 )
		{
			...
			TamingBOBFilter f = ( from.UseOwnFilter ? ((Midgard2PlayerMobile)from).TamingBOBFilter : book.Filter );
