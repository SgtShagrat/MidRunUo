namespace Server.Items
{
    ...
    public class SashOfAnimalLore : BaseClothingOfAnimalLore
    {
        public override string DefaultName
        {
            get
            {
                return "tamer sash of animal lore";
            }
        }

        [Constructable]
        public SashOfAnimalLore( int bonus )
            : base( bonus, 0x1541 )
        {
            Weight = 1.0;
        ...
        public SashOfAnimalLore( Serial serial )
            : base( serial )
        {
        }
        ...
        public override void Deserialize( GenericReader reader )
        {
            ...
            if( Name == "tamer sash of animal lore" )
                Name = null;
        }
    }
    ...
    public class HalfApronOfAnimalLore : BaseClothingOfAnimalLore
    {
        public override string DefaultName
        {
            get
            {
                return "tamer half apron of animal lore";
            }
        }

        [Constructable]
        public HalfApronOfAnimalLore( int bonus )
            : base( bonus, 0x153B )
        {
            Weight = 2.0;
            Layer = Layer.Waist;
        ...
        public HalfApronOfAnimalLore( Serial serial )
            : base( serial )
        {
        }
        ...
        public override void Deserialize( GenericReader reader )
        {
            ...
            if( Name == "tamer half apron of animal lore" )
                Name = null;
        }
    }
    ...
    public class RobeOfAnimalLore : BaseClothingOfAnimalLore
    {
        public override string DefaultName
        {
            get
            {
                return "tamer robe of animal lore";
            }
        }

        [Constructable]
        public RobeOfAnimalLore( int bonus )
            : base( bonus, 0x1F03 )
        {
            Weight = 1.0;
        ...
        public RobeOfAnimalLore( Serial serial )
            : base( serial )
        {
        }
        ...
        public override void Deserialize( GenericReader reader )
        {
            ...
            if( Name == "tamer robe of animal lore" )
                Name = null;
        }
    }
    ...
    public abstract class BaseClothingOfAnimalLore : Item
    {
        ...
        public BaseClothingOfAnimalLore( int bonus, int itemID )
            : base( itemID )
        {
            m_Bonus = bonus;
        ...
        public BaseClothingOfAnimalLore( Serial serial )
            : base( serial )
        {
        }
