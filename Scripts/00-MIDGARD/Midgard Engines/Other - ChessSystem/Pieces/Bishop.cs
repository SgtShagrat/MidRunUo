...
namespace Midgard.Engines.ChessSystem
{
    public class Bishop : BaseChessPiece
    {
        ...
        public Bishop( BChessboard board, ChessColor color, Point2D position )
        ...
        public override void InitializePiece()
        {
            ...
            Piece.Name = string.Format( "Bishop [{0}]", Color );
        ...
        private void CreateFantasyGiant()
        {
            ...
            Piece.BodyValue = 316; // Wanderer of the void
            Piece.Hue = Hue;
        }
