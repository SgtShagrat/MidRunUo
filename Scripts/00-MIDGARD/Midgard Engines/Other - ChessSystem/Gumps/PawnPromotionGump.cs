...
namespace Midgard.Engines.ChessSystem
{
    public class PawnPromotionGump : Gump
    {
        ...
        public PawnPromotionGump( Mobile m, ChessGame game )
            : base( 200, 200 )
        {
        ...
        public override void OnResponse( NetState sender, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                ...
                case 1:
                    type = PawnPromotion.Queen;
                    break;

                case 2:
                    type = PawnPromotion.Rook;
                    break;

                case 3:
                    type = PawnPromotion.Knight;
                    break;

                case 4:
                    type = PawnPromotion.Bishop;
                    break;

                case 5:
                    type = PawnPromotion.None;
                    break;
            }
