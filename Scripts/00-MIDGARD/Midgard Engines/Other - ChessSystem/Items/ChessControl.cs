...
namespace Midgard.Engines.ChessSystem
{
    ...
    public class ChessControl : Item
    {
        ...
        public ChessControl( Serial serial )
            : base( serial )
        {
        }
        ...
        public override void GetProperties( ObjectPropertyList list )
        {
            ...
            if( m_Game != null )
            {
                ...
                list.Add( 1060660, "If you loose your target say\t{0}", Config.ResetKeyword );
            }
        }
        ...
        private static void BuildBoard( ChessControl chess, IPoint3D p, Map map )
        {
