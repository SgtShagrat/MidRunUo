...
namespace Midgard.Engines.ChessSystem
{
    ...
    {
        /// <summary>
        /// Specifies whether spectators should be allowed on the <see cref="BChessboard"/> or not
        /// </summary>
        private bool m_AllowSpectators;

        /// <summary>
        /// The game that's being held on the <see cref="BChessboard"/>
        /// </summary>
        ...
        public ChessRegion( Map map, ChessGame game, bool allowSpectators, Rectangle2D bounds, int height )
            : base( "Chessboard", map, 100, bounds )
        {
            m_Game = game;
            ...
            m_BoardBounds = bounds; // TODO: verificare se va rimosso!!!
        ...
        public override void OnSpeech( SpeechEventArgs args )
        {
            ...
            {
                if( args.Speech.ToLower().IndexOf( Config.ResetKeyword.ToLower() ) > -1 )
