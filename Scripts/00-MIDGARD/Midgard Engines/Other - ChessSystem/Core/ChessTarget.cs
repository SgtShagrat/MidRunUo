...
namespace Midgard.Engines.ChessSystem
{
    ...
    public class ChessTarget : Target
    {
        ...
        /// </summary>
        private bool m_IgnoreGame;

        public ChessTarget( ChessGame game, Mobile m, string message, ChessTargetCallback callback )
        ...
        public ChessTarget( Mobile m, string message, ChessTargetCallback callback )
            : base( -1, true, TargetFlags.None )
        {
            m_IgnoreGame = true;
            m_Message = message;
