...
namespace Midgard.Engines.ChessSystem
{
    ...
    public class ChessMobile : BaseCreature
    {
        ...
        public ChessMobile( BaseChessPiece piece )
        ...
        public ChessMobile( Serial serial )
            : base( serial )
        {
        }
        ...
        protected override void OnLocationChange( Point3D oldLocation )
        {
            ...
            Timer.DelayCall( TimeSpan.FromMilliseconds( 500 ), TimeSpan.FromMilliseconds( 500 ), 1, new TimerStateCallback( OnFacingTimer ), null );
        }
