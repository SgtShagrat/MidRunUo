...
namespace Midgard.Engines.ChessSystem
{
    ...
    /// <summary>
    /// Defines the style of the NPCs on the <see cref="BChessboard"/>
    /// </summary>
    ...
    /// <summary>
    /// The orientaion of the game on the <see cref="BChessboard"/>
    /// </summary>
    ...
    public class BChessboard
    {
        ...
        /// <summary>
        /// The orientation of the <see cref="BChessboard"/>
        /// </summary>
        ...
        public BChessboard( Mobile black, Mobile white, int z, Rectangle2D bounds, ChessGame game, ChessSet chessSet, int whiteHue, int blackHue,
                           int whiteMinorHue, int blackMinorHue, bool overrideMinorHue )
        {
            m_Game = game;
            m_Black = black;
            m_White = white;
        ...
        {
            get { return m_Table[ new Point2D( x, y ) ] as BaseChessPiece; }
        }
        ...
        {
            get { return m_Table[ p ] as BaseChessPiece; }
        }
        ...
        /// <summary>
        /// Rebuilds the <see cref="BChessboard"/> applying any changes made to the NPCs
        /// </summary>
        public void Rebuild()
        {
        ...
        /// <summary>
        /// Verifies is a given Point2D is a valid position on the <see cref="BChessboard"/>
        /// </summary>
        /// <param name="pos">The Point2D considered</param>
        /// <returns>True if the position provided is part of the <see cref="BChessboard"/></returns>
        ...
        public Point2D BoardToWorld( Point2D boardPosition )
        {
            ...
            else
            {
                ...
                return new Point2D( m_Bounds.X + xoffset, m_Bounds.End.Y - yoffset );
            }
        }
        ...
        /// <summary>
        /// Applies a move to the <see cref="BChessboard"/> logic
        /// </summary>
        ...
        public void PlaySound( ChessMobile m, int sound )
        {
            ...
            /* obsolete, by Dies Irae
            Packet p = new PlaySound( sound, m.Location );

            foreach( NetState state in m.GetClientsInRange( 20 ) )
            {
                state.Mobile.PlaySound( sound );
...
*/
        ...
        /// <param name="by">The color of the player attacking</param>
        ...
        /// <summary>
        /// The staff deleted a piece from the <see cref="BChessboard"/>, so clean up the game
        /// </summary>
