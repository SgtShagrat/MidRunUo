...
{
    public class PetCurePotion : BasePetHealthPotion
    {
        #region campi
        ...
        #region costruttori
        [Constructable]
        public PetCurePotion( int amount )
            : base( PotionEffect.PetCure, amount )
        {
        ...
        [Constructable]
        public PetCurePotion()
            : this( 1 )
        {
        }

        public PetCurePotion( Serial serial )
            : base( serial )
        {
        }
        #endregion
