...
{
    public class PetHealPotion : BasePetHealthPotion
    {
        #region campi
        public const double PercMinHeal = 0.10;
        public const double PercMaxHeal = 0.20;
        ...
        #region costruttori
        [Constructable]
        public PetHealPotion( int amount )
            : base( PotionEffect.PetHeal, amount )
        {
        ...
        [Constructable]
        public PetHealPotion()
            : this( 1 )
        {
        }

        public PetHealPotion( Serial serial )
            : base( serial )
        {
        }
        #endregion
