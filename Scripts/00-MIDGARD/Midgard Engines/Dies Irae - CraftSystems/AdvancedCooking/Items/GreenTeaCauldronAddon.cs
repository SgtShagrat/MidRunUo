namespace Server.Items
{
    public class GreenTeaCauldronAddon : BaseAddon
    {
        ...
        {
            get { return new GreenTeaCauldronDeed(); }
        }
        ...
        public GreenTeaCauldronAddon( Serial serial )
            : base( serial )
        {
        }
    ...
    public class GreenTeaCauldronDeed : BaseAddonDeed
    {
        ...
        {
            get { return new GreenTeaCauldronAddon(); }
        }
        ...
        public GreenTeaCauldronDeed( Serial serial )
            : base( serial )
        {
        }
