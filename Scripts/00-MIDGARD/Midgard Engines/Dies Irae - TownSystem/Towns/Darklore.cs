...
{
    public sealed class Darklore : TownSystem
    {
        public Darklore()
        {
            m_Definition = new TownDefinition( "Darklore",
                                                MidgardTowns.Darklore,
                                                "Darklore",
                                                new CityInfo( "Darklore", "Center", 0, 0, 0, Map.Felucca ),
                                                TownBanFlag.Darklore,
                                                new Point3D( 927, 351, 5 )
                                                );
        }
        ...
        public override void DressTownGuard( BaseCreature guard )
        {
            ...
            guard.Race = Races.Core.Undead;
            guard.Title = "the undead guard";
            ...
            guard.AddItem( Immovable( Rehued( new HoodedRobe(), 0x0454 ) ) );
            guard.AddItem( Immovable( Rehued( new Hood(), 0x0454 ) ) );
