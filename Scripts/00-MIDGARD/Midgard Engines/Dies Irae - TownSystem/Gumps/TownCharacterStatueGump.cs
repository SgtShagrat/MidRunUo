...
{
    public class TownCharacterStatueGump : Gump
    {
        ...
        public TownCharacterStatueGump( CharacterStatue statue )
            : base( 60, 36 )
        {
            m_Statue = statue;
        ...
        {
            if( m_Statue == null || m_Statue.Deleted || info.ButtonID == (int)Buttons.Close )
                return;
            ...
            if( sendGump )
                state.Mobile.SendGump( new TownCharacterStatueGump( m_Statue ) );
        }
    }
}