...
namespace Midgard.Engines.MidgardTownSystem
{
    ...
    {
        public Type Spell { get; private set; }
    ...
    public class SpellCombo
    {
        ...
        public ComboEntry[] Entries { get; private set; }
    ...
    public class TownGuardAI : BaseAI
    {
        private BaseTownGuard m_Guard;
        ...
        public TownGuardAI( BaseTownGuard guard )
            : base( guard )
        {
            m_Guard = guard;
        }
        ...
        public override bool Think()
        {
            ...
            {
                m_Guard.DebugSay( "My order is to stand." );

                Mobile toFollow = null;

                if( m_Guard.System != null && m_Guard.Orders.Movement == MovementType.Follow )
                {
                ...
                if( toFollow != null && toFollow.Map == m_Guard.Map && toFollow.InRange( m_Guard, m_Guard.RangePerception * 3 ) && TownSystem.Find( toFollow.Region ) == m_Guard.System )
                {
                    if( Action != ActionType.Combat )
                        Action = ActionType.Combat;
                ...
                else if( m_Guard.System != null && m_Guard.Orders.Movement == MovementType.Patrol && m_Guard.CurrentWayPoint != null )
                {
                    m_Guard.DebugSay( "My order is to patrol." );
