...
namespace Midgard.Engines.JailSystem
{
    public class JailWarningGump : Gump
    {
            ...
            : base( 70, 40 )
        {
            ...
            ( (Account)m.Account ).Comments.Add( new AccountComment( JailSystem.JSName + "-warning",
                                                                     m.Name + " warned for \"" + why + "\" by:" +
                                                                     from.Name + " on:" + DateTime.Now ) );
            Closable = false;
            Dragable = false;
            Resizable = false;
            AddPage( 0 );
            ...
            AddButton( 30 + ( new Random() ).Next( 100 ), 142 + ( ( new Random() ).Next( 100 ) ), 2128, 2130, 1,
