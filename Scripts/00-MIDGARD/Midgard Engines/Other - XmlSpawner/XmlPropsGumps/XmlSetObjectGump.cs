...
namespace Server.Gumps
{
    public class XmlSetObjectGump : Gump
    {
        ...
        public XmlSetObjectGump( PropertyInfo prop, Mobile mobile, object o, Stack stack, Type type, int page,
                                ArrayList list )
        ...
        private class InternalPrompt : Prompt
        {
            ...
            public InternalPrompt( PropertyInfo prop, Mobile mobile, object o, Stack stack, Type type, int page,
                                  ArrayList list )
            {
                m_Property = prop;
                m_Mobile = mobile;
                ...
                try
                {
                    ...
                    else if( !m_Type.IsAssignableFrom( toSet.GetType() ) )
                    {
                        ...
                        m_Mobile.SendMessage(
                            "The object with that serial could not be assigned to a property of type : {0}", m_Type.Name );
                    }
                    else
                    {
                        shouldSet = true;
        ...
        public override void OnResponse( NetState sender, RelayInfo info )
        {
            ...
            switch( info.ButtonID )
            {
                ...
                case 1: // Change by Target
                    {
                        m_Mobile.Target = new XmlSetObjectTarget( m_Property, m_Mobile, m_Object, m_Stack, m_Type, m_Page,
                                                                 m_List );
                        toSet = null;
                        shouldSet = false;
                        shouldSend = false;
                ...
                case 2: // Change by Serial
                    {
                        ...
                        m_Mobile.Prompt = new InternalPrompt( m_Property, m_Mobile, m_Object, m_Stack, m_Type, m_Page,
                                                             m_List );
