...
namespace Server.Gumps
{
    public class XmlSetCustomEnumGump : XmlSetListOptionGump
    {
        ...
        public XmlSetCustomEnumGump( PropertyInfo prop, Mobile mobile, object o, Stack stack, int propspage,
            ...
            if( index >= 0 && index < m_Names.Length )
            {
                try
                {
                    ...
                    if( info != null )
                        ...
                        m_Property.SetValue( m_Object, Enum.Parse( m_Property.PropertyType, m_Names[ index ], false ),
                                            null );
                }
                catch
                {
