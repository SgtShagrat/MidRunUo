    ...
    public class WriteMulti
    {
        ...
        public static void WriteMulti_OnCommand( CommandEventArgs e )
        {
            ...
            if( e.Arguments != null )
            {
                ...
                DefineMultiArea( e.Mobile, dirname, zmin, zmax, includeitems, includestatics, includemultis, includeinvisible,
                                includeaddons );
            }
        }
        ...
        private static void DefineMultiArea_Callback( Mobile from, Map map, Point3D start, Point3D end, object state )
        {
            ...
            if( from != null && multiargs != null && map != null )
            {
                ...
                var staticlist = new List<TileEntry>();
                ...
                if( includeitems )
                {
                    ...
                    eable =
                        map.GetItemsInBounds( new Rectangle2D( sx - searchrange, sy - searchrange,
