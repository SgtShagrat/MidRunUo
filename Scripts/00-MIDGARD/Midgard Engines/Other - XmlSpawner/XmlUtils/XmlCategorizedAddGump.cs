...
namespace Server.Gumps
{
    ...
    public class XmlAddCAGObject : XmlAddCAGNode
    {
        ...
        public XmlAddCAGCategory Parent { get; private set; }
        ...
        public override void OnClick( Mobile from, int page, int index, Gump gump )
        {
            ...
            else
            {
                ...
                {
                    XmlSpawner mSpawner = ( (XmlSpawnerGump)gump ).Spawner;

                    if( mSpawner != null )
                    {
                        XmlSpawnerGump xg = mSpawner.SpawnerGump;
    ...
    public class XmlAddCAGCategory : XmlAddCAGNode
    {
        ...
        public XmlAddCAGNode[] Nodes { get; private set; }
        ...
        public XmlAddCAGCategory( XmlAddCAGCategory parent, XmlReader xml )
        {
            ...
            {
                var nodes = new List<XmlAddCAGNode>();
