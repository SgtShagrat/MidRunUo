...
namespace Server.Commands
{
    public class WhatIsIt
    {
        ...
        {
            CommandSystem.Register( "WhatIsIt", AccessLevel.Player, new CommandEventHandler( WhatIsIt_OnCommand ) );
        }
        */
        ...
        [Usage( "WhatIsIt" )]
        [Description( "Returns the description of a targeted entity" )]
        public static void WhatIsIt_OnCommand( CommandEventArgs e )
        {
