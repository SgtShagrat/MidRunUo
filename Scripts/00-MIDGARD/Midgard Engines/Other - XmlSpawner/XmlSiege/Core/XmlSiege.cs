...
namespace Server.Engines.XmlSpawner2
{
    ...
    {
        public virtual int ShowSiegeColor { get { return 6; } } // color used to flag items with siege attachments

        public virtual int LightDamageColor { get { return 0; } } // color at 67-99% of hitsmax
        public virtual int MediumDamageColor { get { return 0; } } // color at 34-66% of hitsmax
        public virtual int HeavyDamageColor { get { return 0; } } // color at 1-33% of hitsmax
        ...
        public virtual bool Enabled
        {
            get
            {
                ...
                if( AttachedTo is Item && ( (Item)AttachedTo ).Map != Map.Felucca )
                    return false;
                return m_Enabled;
            }
            set
        ...
        public void StoreOriginalItemID( Item targetitem )
        {
            ...
            m_OriginalItemIDList = new List<int> { targetitem.ItemID };
        ...
        public virtual void AssignItemEffect( Item targetitem, int effectid, int hue, int fraction )
        {
            ...
            else
            {
                if( targetitem is BaseMulti )
                {
                    ...
                    var tilelist = new List<TileEntry>();
                ...
                {
                    // place an effect at the location of the target item
                    Effects.SendLocationParticles( EffectItem.Create( targetitem.Location, targetitem.Map, TimeSpan.FromSeconds( DamagedItemEffectDuration ) ), effectid, 9, 10, 5029 );
                    // Effects.SendLocationEffect( targetitem.Location, targetitem.Map, effectid, DamagedItemEffectDuration, hue, 0 );
