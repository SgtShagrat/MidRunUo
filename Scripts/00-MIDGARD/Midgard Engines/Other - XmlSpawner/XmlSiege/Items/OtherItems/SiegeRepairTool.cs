...
namespace Server.Items
{
    public class SiegeRepairTool : Item
    {
        ...
        public override void OnSingleClick( Mobile from )
        {
            ...
            LabelTo( from, 1060584, m_UsesRemaining.ToString() ); // uses remaining: ~1_val~
            LabelTo( from, "Hits per repair\t{0}", HitsPerRepair.ToString() ); // ~1_val~: ~2_val
        }
            ...
            protected override void OnTarget( Mobile from, object targeted )
            {
                ...
                if( a != null )
                {
                    ...
                    if( pack != null )
                    {
                        ...
                        TimeSpan repairtime = TimeSpan.FromSeconds( m_Tool.BaseRepairTime * timepenalty - from.Dex / 40.0 - smithskill / 50.0 -
                                                  carpentryskill / 50.0 );
