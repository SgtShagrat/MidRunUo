...
namespace Server.Items
{
    public abstract class BaseSiegeWeapon : BaseAddon, ISiegeWeapon
    {
        ...
        public virtual bool CheckLOS { get { return false; } } // whether the weapon needs to consider line of sight when selecting a target
        ...
        private bool m_FixedFacing;
        private bool m_Draggable = true;
        private bool m_Packable = true;
        public bool Storing;

        private XmlSiege m_SiegeAttachment;
        ...
        public int Hits { get { return ( SiegeAttachment != null ) ? SiegeAttachment.Hits : 0; } }

        public int HitsMax { get { return ( SiegeAttachment != null ) ? SiegeAttachment.HitsMax : 0; } }
        ...
        [CommandProperty( AccessLevel.GameMaster )]
        public virtual bool FixedFacing { get { return m_FixedFacing; } set { m_FixedFacing = value; } }
        ...
        [CommandProperty( AccessLevel.GameMaster )]
        public TimeSpan NextFiring { get { return m_NextFiringTime - DateTime.Now; } set { m_NextFiringTime = DateTime.Now + value; } }
        ...
        private static bool ContainsInterface( IEnumerable<Type> typearray, Type type )
        {
        ...
        public virtual Point3D ProjectileLaunchPoint { get { return ( Location ); } }
                                              ...
                                              TimeSpan delay )
        {
            ...
            XmlSiege.SendMovingProjectileEffect( this, target, animationid, ProjectileLaunchPoint, targetloc, 7, 0, false,
                                                 true, animationhue );
        ...
        public override void OnDoubleClick( Mobile from )
        {
            ...
            bool checkLOS = BaseBoat.FindBoatAt( from.Location, from.Map ) == null && CheckLOS;
