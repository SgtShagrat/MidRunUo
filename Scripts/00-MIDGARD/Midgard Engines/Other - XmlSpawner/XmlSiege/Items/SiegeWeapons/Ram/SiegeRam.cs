...
namespace Server.Items
{
    public class SiegeRam : BaseSiegeWeapon
    {
        ...
        {
            925, 925, 925, 1, 1, 5823, 5822, 5821, 5820, 5819, 5818, 5817, 5826,
            5831, 5841, 5836
        };
        ...
        {
            926, 926, 926, 1, 1, 5784, 5786, 5789, 5785, 5783, 5782, 5780, 5781,
            5799, 5794, 5808
        };
        ...
        {
            925, 925, 925, 1, 1, 5763, 5758, 5746, 5747, 5748, 5750, 5751, 5752,
            5753, 5768, 5749
        };
        ...
        {
            926, 926, 926, 1, 1, 5704, 5716, 5721, 5710, 5709, 5708, 5707, 5714,
            5706, 5730, 5705
        };
        ...
        private void DisplayLaunch( int frame )
        {
            ...
            if( launchIDArray != null && Components != null && launchIDArray.Length > 0 )
            {
                ...
                {
                    case 0:
                        Components[ 0 ].ItemID = launchIDArray[ 0 ];
                        Components[ 1 ].ItemID = launchIDArray[ 0 ];
                        Components[ 3 ].ItemID = 1;
                        Components[ 4 ].ItemID = 1;
                        break;
                    case 1:
                        Components[ 0 ].ItemID = 1;
                        Components[ 1 ].ItemID = launchIDArray[ 0 ];
                        Components[ 3 ].ItemID = launchIDArray[ 0 ];
                        Components[ 4 ].ItemID = 1;
                        break;
                    case 2:
                        Components[ 0 ].ItemID = 1;
                        Components[ 1 ].ItemID = 1;
                        Components[ 3 ].ItemID = launchIDArray[ 0 ];
                        Components[ 4 ].ItemID = launchIDArray[ 0 ];
                        break;
                }
            }
        }
            ...
            if( Components != null && Components.Count > 2 )
            {
                    ...
                    Components.Count == itemid.Length )
                {
                    for ( int i = 0; i < Components.Count; i++ )
                    {
                        ...
                        Components[ i ].Location = new Point3D( newoffset.X + X, newoffset.Y + Y,
                                                                newoffset.Z + Z );
                    }
                }
            }
