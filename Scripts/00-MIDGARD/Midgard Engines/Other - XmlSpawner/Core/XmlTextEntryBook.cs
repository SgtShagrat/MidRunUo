...
namespace Server.Items
{
    ...
    public class XmlTextEntryBook : BaseEntryBook
    {
        ...
        public XmlTextEntryBookCallback Bookcallback { get; private set; }
    ...
    public class BaseEntryBook : Item
    {
        ...
        public static void ContentChange( NetState state, PacketReader pvSrc )
        {
            ...
            if( tebook != null && tebook.Bookcallback != null )
            {
                tebook.Bookcallback( state.Mobile, tebook.Args, sb.ToString() );
            }
        }
