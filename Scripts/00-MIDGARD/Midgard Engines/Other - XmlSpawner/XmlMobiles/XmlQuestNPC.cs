    ...
    public class XmlQuestNPC : TalkingBaseCreature
    {
            ...
            : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 )
        {
            ...
            if( Female )
            {
                ...
                var hair = new Item( Utility.RandomList( 0x203B, 0x203C, 0x203D, 0x2045, 0x204A, 0x2046, 0x2049 ) );
            ...
            else
            {
                ...
                var hair = new Item( Utility.RandomList( 0x203B, 0x203C, 0x203D, 0x2044, 0x2045, 0x2047, 0x2048 ) );
                hair.Hue = Utility.RandomHairHue();
                hair.Layer = Layer.Hair;
                hair.Movable = false;
                AddItem( hair );
                var beard = new Item( Utility.RandomList( 0x0000, 0x203E, 0x203F, 0x2040, 0x2041, 0x2067, 0x2068, 0x2069 ) );
                beard.Hue = hair.Hue;
