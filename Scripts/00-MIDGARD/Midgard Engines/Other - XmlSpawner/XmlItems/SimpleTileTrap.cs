...
namespace Server.Items
{
    public class SimpleTileTrap : Item
    {
        ...
        public virtual void OnEnter( Mobile m )
        {
            ...
            BaseXmlSpawner.ApplyObjectStringProperties( null, m_TargetProperty1, m_TargetItem1, m, this, out statusStr );
        }

        public virtual void OnExit( Mobile m )
        {
            string statusStr;
            BaseXmlSpawner.ApplyObjectStringProperties( null, m_TargetProperty0, m_TargetItem0, m, this, out statusStr );
        }
    }
}