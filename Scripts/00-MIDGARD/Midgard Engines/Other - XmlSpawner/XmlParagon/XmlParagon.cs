...
namespace Server.Engines.XmlSpawner2
{
    public class XmlParagon : XmlAttachment
    {
        ...
        {
            get { return Core.AOS ? m_Artifacts : m_OldArtifacts; }
        }

        [CommandProperty( AccessLevel.GameMaster )]
        public virtual double ConvertFactor
        {
            get { return m_ConvertFactor; }
            set { m_ConvertFactor = value; }
        }

        [CommandProperty( AccessLevel.GameMaster )]
        public virtual double ArtifactFactor
        {
            get { return m_ArtifactFactor; }
            set { m_ArtifactFactor = value; }
        }
        ...
        {
            get { return m_HitsBuff; }
            set { m_HitsBuff = value; }
        }

        [CommandProperty( AccessLevel.GameMaster )]
        public virtual double StrBuff
        {
            get { return m_StrBuff; }
            set { m_StrBuff = value; }
        }
        ...
        {
            get { return m_SkillsBuff; }
            set { m_SkillsBuff = value; }
        }

        [CommandProperty( AccessLevel.GameMaster )]
        public virtual double SpeedBuff
        {
            get { return m_SpeedBuff; }
            set { m_SpeedBuff = value; }
        }

        [CommandProperty( AccessLevel.GameMaster )]
        public virtual double FameBuff
        {
            get { return m_FameBuff; }
            set { m_FameBuff = value; }
        }

        [CommandProperty( AccessLevel.GameMaster )]
        public virtual double KarmaBuff
        {
            get { return m_KarmaBuff; }
            set { m_KarmaBuff = value; }
        }
        ...
        {
            get { return m_ChestChance; }
            set { m_ChestChance = value; }
        }
        ...
        {
            get { return m_ParagonLabel; }
            set { m_ParagonLabel = value; }
        }
        #endregion
        ...
        public static string GetParagonLabel( BaseCreature bc )
        {
            ...
            else
            {
                if( Core.AOS )
                    ...
                    return string.Format( "({0})", bc.ParagonPrefix );
            }
        }
        ...
        public static void Convert( BaseCreature bc )
        {
            ...
            bc.HitsRegenBonus += 10;
            bc.StaminaRegenBonus += 10;
            bc.ManaRegenBonus += 10;
        }
        ...
        public static void UnConvert( BaseCreature bc )
        {
            ...
            if( bc.HitsRegenBonus < 0 )
                bc.HitsRegenBonus = 0;
            if( bc.StaminaRegenBonus < 0 )
                bc.StaminaRegenBonus = 0;
            if( bc.ManaRegenBonus < 0 )
                bc.ManaRegenBonus = 0;
            #endregion
        }
        ...
        public virtual bool XmlCheckConvert( BaseCreature bc, Point3D location, Map m )
        {
            ...
            #region mod by Dies Irae
            if( bc.HitsMaxSeed < Paragon.MinHitsToConvert || Paragon.IsNotParagonable( bc ) )
                return false;
            #endregion
            ...
            double chance = ConvertFactor / Math.Round( 20.0 - ( fame / 3200.0 ) );
        ...
        public virtual void XmlGiveArtifactTo( Mobile m, BaseCreature bc )
        {
            ...
            Loot.StringToLog( string.Format( "Artefatto {0} (seriale {1}) droppato in data {2} al pg {3} (seriale {4} locazione {5}).", item.GetType().Name, item.Serial, DateTime.Now, m.Name, m.Serial, m.Location ), "Logs/Midgard2ArtifactsLog.txt" );
            #endregion
        ...
        {
            if( suffix.Length == 0 )
                suffix = GetParagonLabel( bc );
            else
                suffix = String.Concat( suffix, " " + GetParagonLabel( bc ) );
