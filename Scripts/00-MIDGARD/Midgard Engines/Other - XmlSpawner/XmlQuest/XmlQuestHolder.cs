...
namespace Server.Items
{
    public abstract class XmlQuestHolder : Container, IXmlQuest
    {
        ...
        protected XmlQuestHolder( int itemID )
            : base( itemID )
        {
            Weight = 0;
            Hue = 500;
    ...
    // add support for new client container packets
        ...
        private void VerboseAddJournalEntry( string entrystring, bool notify, bool echo )
        {
            ...
            // parse the value
            string[] args = entrystring.Split( m_Colondelim, 2 );
...
*/
        ...
        public Item RewardItem
        {
            get
            {
                ...
                {
                    object o = XmlQuest.CreateItem( this, m_RewardString, out m_StatusStr, typeof( Item ) );
                    if( o is Item )
                    {
