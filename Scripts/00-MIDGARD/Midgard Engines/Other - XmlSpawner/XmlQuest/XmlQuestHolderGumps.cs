...
namespace Server.Gumps
{
    public class XmlQuestStatusGump : Gump
    {
            ...
            : base( X, Y )
        {
            ...
            {
                if( !string.IsNullOrEmpty( gumptitle ) )
                {
                ...
                if( questitem != null )
                {
                    if( !string.IsNullOrEmpty( questitem.NoteString ) )
                    {
                ...
                if( questitem != null )
                {
                    if( ( questitem.RewardItem != null && !questitem.RewardItem.Deleted ) )
                    {
                        ...
                        {
                            AddLabel( 230, 356, 55,
                                     String.Format( "Reward: {0} ({1})", questitem.RewardItem.GetType().Name,
                        ...
                        {
                            AddLabel( 230, 356, 55,
                                     String.Format( "Reward: {0} ({1} items)", questitem.RewardItem.GetType().Name,
                    ...
                    if( questitem.Status != null )
                    {
                        ...
                        if( questitem.IsValid )
                        {
                            ...
                            AddHtml( 130, 392, 200, 37, XmlSimpleGump.Color( questitem.ExpirationString, "00FF42" ), false,
                                    false );
                        }
                    ...
                    if( XmlQuest.QuestPointsEnabled )
                    {
                        AddHtml( 250, 40, 200, 30,
                                XmlSimpleGump.Color( String.Format( "Difficulty Level {0}", questitem.Difficulty ),
                                                    "00FF42" ), false, false );
                    }
                ...
                case 800:
                    ...
                    if( m_questitem.RewardAttachment != null )
                    {
                        ...
                        state.Mobile.SendGump( new DisplayAttachmentGump( state.Mobile,
                                                                        m_questitem.RewardAttachment.OnIdentify(
                                                                            state.Mobile ) ) );
                    }
                    break;
                case 900:
