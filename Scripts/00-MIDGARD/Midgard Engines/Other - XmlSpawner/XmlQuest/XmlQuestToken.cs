...
namespace Server.Items
{
    public abstract class XmlQuestToken : Item, IXmlQuest
    {
        ...
        protected XmlQuestToken()
        {
            //LootType = LootType.Blessed;
            TimeCreated = DateTime.Now;
        }

        protected XmlQuestToken( int itemID )
        {
            ItemID = itemID;
            //LootType = LootType.Blessed;
            TimeCreated = DateTime.Now;
        ...
        {
            base.OnDroppedToWorld( from, point );
        ...
        private static char[] m_Colondelim = new char[] { ':' };
        ...
        public string AddJournalEntry
        {
            set
            {
                ...
                // parse the value
                string[] args = value.Split( m_Colondelim, 2 );
        ...
        */
        ...
        public XmlAttachment RewardAttachment
        {
            get
            {
                ...
                {
                    object o = XmlQuest.CreateItem( this, m_AttachmentString, out m_StatusStr, typeof( XmlAttachment ) );
                    if( o is Item )
                    {
        ...
        public Item RewardItem
        {
            get
            {
                ...
                {
                    string statusStr;
                    object o = XmlQuest.CreateItem( this, m_RewardString, out statusStr, typeof( Item ) );
                    if( o is Item )
                    {
        ...
        public virtual bool IsCompleted
        {
            ...
            {
                if( IsValid &&
                    ( Completed1 || string.IsNullOrEmpty( Objective1 ) ) &&
                    ( Completed2 || string.IsNullOrEmpty( Objective2 ) ) &&
                    ( Completed3 || string.IsNullOrEmpty( Objective3 ) ) &&
                    ( Completed4 || string.IsNullOrEmpty( Objective4 ) ) &&
                    ( Completed5 || string.IsNullOrEmpty( Objective5 ) )
                    )
                    return true;
                else
                    return false;
        ...
        {
            get { return ( IsValid && !string.IsNullOrEmpty( m_SkillTrigger ) ); }
        }
