...
namespace Server.Engines.XmlSpawner2
{
    public class XmlDeathAction : XmlAttachment
    {
        ...
        private static void ExecuteDeathActions( IEntity corpse, Mobile killer, string actions )
        {
        ...
        private static void ExecuteDeathAction( IEntity corpse, Mobile killer, string action )
        {
            if( string.IsNullOrEmpty( action ) || corpse == null )
                return;
            ...
            {
                BaseXmlSpawner.SpawnTypeKeyword( corpse, TheSpawn, typeName, substitutedtypeName, true, killer, loc, map,
                                                out status_str );
            }
            else
            {
