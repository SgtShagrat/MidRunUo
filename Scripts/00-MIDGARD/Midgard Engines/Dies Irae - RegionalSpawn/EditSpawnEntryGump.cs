...
{
    public class EditSpawnEntryGump : RegionBaseSpawnGump
    {
        public enum Buttons
        {
            Close,
        ...
        public EditSpawnEntryGump( BaseRegion region, Mobile owner, SpawnEntry entry )
            : base( region, owner )
        {
            m_Entry = entry;

            owner.CloseGump( typeof( EditSpawnEntryGump ) );

            Design();

            base.RegisterUse( typeof( EditSpawnEntryGump ) );
        }
        ...
        private void Design()
        {
            ...
            AddMainBackground();
            AddMainTitle( 150, "Entry details" );
            AddMainWindow();
            ...
            // buttons
            AddActionButton( 1, "start spawns", (int)Buttons.Start, Owner, 0 );
            AddActionButton( 2, "stop spawns", (int)Buttons.Stop, Owner, 0 );
            AddActionButton( 3, "respawn", (int)Buttons.Respawn, Owner, 0 );
            AddActionButton( 4, "delete spawned", (int)Buttons.DeleteObjects, Owner, 0 );
