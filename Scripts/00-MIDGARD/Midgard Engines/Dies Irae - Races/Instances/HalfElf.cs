...
{
    internal class HalfElf : MidgardRace
    {
        private static int[] m_HairHues = new int[] { 1109 };
        private static int[] m_SkinHues = new int[] { 1004 };

        public HalfElf( int raceID, int raceIndex )
            : base( raceID, raceIndex, "HalfElf", "HalfElves", 400, 401, 402, 403 )
        {
        }

        public override RaceLanguageFlag LanguageFlag { get { return RaceLanguageFlag.HalfElf; } }
        ...
        {
            if( skill.SkillName == SkillName.Archery )
                return 0.2;
        ...
        {
            new RaceSkillMod( SkillName.Fletching, true, 5 ),
            new RaceSkillMod( SkillName.Archery, true, 5 ),
            new RaceSkillMod( SkillName.Macing, true, -5 ),
            new RaceSkillMod( SkillName.Mining, true, -5 ),
        };
