...
{
    internal class FairyOfAir : MidgardRace
    {
        private static int[] m_HairHues = new int[] { 1154 };
        private static int[] m_SkinHues = new int[] { 1410 };

        public FairyOfAir( int raceID, int raceIndex )
            : base( raceID, raceIndex, "Fairy Of Air", "Fairies of Air", 400, 401, 402, 403 )
        {
        }

        public override RaceLanguageFlag LanguageFlag { get { return RaceLanguageFlag.FairyOfAir; } }
        ...
        {
            new MorphEntry( /*128*/ 176, 2673, "a pixie", 10, 1 ),//edit by Arlas
        };
        ...
        private int[] m_ElementalBonuses = new int[] { 0, 0, -10, 0, 10 };
