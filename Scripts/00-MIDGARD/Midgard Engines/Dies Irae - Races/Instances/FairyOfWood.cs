...
{
    internal class FairyOfWood : MidgardRace
    {
        private static int[] m_HairHues = new int[] { 1920 };
        private static int[] m_SkinHues = new int[] { 1410 };

        public FairyOfWood( int raceID, int raceIndex )
            : base( raceID, raceIndex, "Fairy Of Wood", "Fairies of Wood", 400, 401, 402, 403 )
        {
        }

        public override RaceLanguageFlag LanguageFlag { get { return RaceLanguageFlag.FairyOfWood; } }
        ...
        {
            new MorphEntry( /*128*/ 176, 1920, "a pixie", 10, 1 ),//edit by Arlas
        };
        ...
        private int[] m_ElementalBonuses = new int[] { 0, 0, 0, 10, -10 };
