...
{
    internal class FairyOfWater : MidgardRace
    {
        private static int[] m_HairHues = new int[] { 1931 };
        private static int[] m_SkinHues = new int[] { 1410 };

        public FairyOfWater( int raceID, int raceIndex )
            : base( raceID, raceIndex, "Fairy Of Water", "Fairies Of Water", 400, 401, 402, 403 )
        {
        }

        public override RaceLanguageFlag LanguageFlag { get { return RaceLanguageFlag.FairyOfWater; } }
        ...
        {
            new MorphEntry( /*128*/ 176, 1931, "a pixie", 10, 1 ),//edit by Arlas
        };
