...
{
    internal class FairyOfFire : MidgardRace
    {
        private static int[] m_HairHues = new int[] { 1933 };
        private static int[] m_SkinHues = new int[] { 1410 };

        public FairyOfFire( int raceID, int raceIndex )
            : base( raceID, raceIndex, "Fairy Of Fire", "Fairies Of Fire", 400, 401, 402, 403 )
        {
        }

        public override RaceLanguageFlag LanguageFlag { get { return RaceLanguageFlag.FairyOfFire; } }
        ...
        {
            new MorphEntry( /*128*/ 176, 1933, "a pixie", 10, 1 ),//edit by Arlas
        };
