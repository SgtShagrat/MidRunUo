...
namespace Server.Mobiles
{
	...
	public class SkeletonDamager : BaseNecroFamiliar, ISkeleton
	{
		[Constructable]
		public SkeletonDamager() : base( AIType.AI_MageDamager, FightMode.Aggressor, 10, 1, 0.1, 0.2 )
		{
			Name = "damager minion";
		...
		public SkeletonDamager( Serial serial ) : base( serial )
		{
		}
