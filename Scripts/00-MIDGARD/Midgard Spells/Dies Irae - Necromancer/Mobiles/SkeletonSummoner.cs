...
namespace Server.Mobiles
{
	...
	public class SkeletonSummoner : BaseNecroFamiliar, ISkeleton
	{
		[Constructable]
		public SkeletonSummoner() : base( AIType.AI_MageSummoner, FightMode.Aggressor, 10, 1, 0.1, 0.2 )
		{
			Name = "summoner minion";
		...
		public SkeletonSummoner( Serial serial ) : base( serial )
		{
		}
