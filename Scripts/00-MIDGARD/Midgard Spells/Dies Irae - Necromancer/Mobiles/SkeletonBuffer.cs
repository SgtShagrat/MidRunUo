...
namespace Server.Mobiles
{
	...
	public class SkeletonBuffer : BaseNecroFamiliar, ISkeleton
	{
		[Constructable]
		public SkeletonBuffer() : base( AIType.AI_MageBuffer, FightMode.Aggressor, 10, 1, 0.1, 0.2 )
		{
			Name = "buffer minion";
		...
		public SkeletonBuffer( Serial serial ) : base( serial )
		{
		}
