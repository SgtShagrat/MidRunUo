...
namespace Server.Mobiles
{
	...
	public class SkeletonHealer : BaseNecroFamiliar, ISkeleton
	{
		[Constructable]
		public SkeletonHealer() : base( AIType.AI_MageHealer, FightMode.Aggressor, 10, 1, 0.1, 0.2 )
		{
			Name = "healer minion";
		...
		public SkeletonHealer( Serial serial ) : base( serial )
		{
		}
