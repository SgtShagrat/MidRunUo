...
/***************************************************************************
 *  Info: 
 * 			Cavallo cavalcabile solo da elfi del nord.
 * 
 ***************************************************************************/
...
{
    [CorpseName( "an northern elven horse corpse" )]
    public class NorthernElvenHorse : BaseMount
    {
        #region proprietà
        public override int Meat { get { return 2; } }
        public override FoodType FavoriteFood { get { return FoodType.FruitsAndVegies | FoodType.GrainsAndHay; } }
        public override PackInstinct PackInstinct { get { return PackInstinct.Bear; } }
        public override Race RequiredRace { get { return Core.NorthernElf; } }
        #endregion

        #region costruttori
        [Constructable]
        public NorthernElvenHorse()
            : base( "an northern elven horse", 0x74, 0x3EA7, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
        {
            Hue = 0x990;
            BaseSoundID = 0x875;
        ...
        public NorthernElvenHorse( Serial serial )
            : base( serial )
        {
        }
        #endregion
