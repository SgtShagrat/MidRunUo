...
{
    public class HirelingRangerArcher : BaseHireling
    {
        [Constructable]
        public HirelingRangerArcher()
            : base( AIType.AI_Archer )
        {
            ...
            SetSkill( SkillName.Archery, 66.0, 97.0 );
            ...
            Item arrow = new Arrow( Utility.RandomMinMax( 50, 70 ) );
            AddItem( arrow );
        ...
        public HirelingRangerArcher( Serial serial )
            : base( serial )
        {
        }
