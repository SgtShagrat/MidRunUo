// #define DebugSBTokunoLibrarian

/***************************************************************************
 *                                    SBTokunoLibrarian.cs
 *                            		-----------------------
 *  begin                	: Marzo, 2007
 *  version					: 1.0
...
{
    public class SBTokunoLibrarian : SBInfo
    {
        private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new InternalSellInfo();

        public SBTokunoLibrarian()
        {
        }
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add( new GenericBuyInfo( typeof( BookOfChivalry ), 50000, 5, 0x2252, 0 ) );
                Add( new GenericBuyInfo( typeof( NecromancerSpellbook ), 50000, 5, 0x2253, 0 ) );
