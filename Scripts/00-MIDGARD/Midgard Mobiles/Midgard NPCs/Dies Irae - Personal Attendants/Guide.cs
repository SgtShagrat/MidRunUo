...
{
    public abstract class AttendantGuide : PersonalAttendant
    {
        ...
        public override void OnDoubleClick( Mobile from )
        {
            ...
            {
                Dictionary<int, Vertex> shops = GuideHelper.FindShops( Region != null ? Region.Name : null, Location );

                if( shops != null )
                {
                    from.CloseGump( typeof( InternalGump ) );
                    from.SendGump( new InternalGump( this, shops ) );
                }
                else
    ...
    public static class GuideHelper
    {
        ...
        public static void LogMessage( string line )
        {
            try
            {
                using( FileStream stream = new FileStream( "Logs/Guide.log", FileMode.Append ) )
        ...
        public class GuideVertexEditGump : Gump
        {
            ...
            private static void Save( string town )
            {
        ...
        [Usage( "VertexEdit" )]
        [Description( "Starts the guide vertex editing procedure" )]
        public static void VertexEdit_OnCommand( CommandEventArgs e )
        {
            ...
            if( m.Region != null )
            {
                GuideVertex closest = ClosestVertex( m.Region.Name, m.Location );
        ...
        public static GuideVertex ClosestVertex( string town, Point3D location )
        {
