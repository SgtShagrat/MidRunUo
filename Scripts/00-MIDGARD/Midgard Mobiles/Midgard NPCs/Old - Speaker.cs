...
namespace Midgard.Mobiles
{
    public class Speaker : BaseCreature
    {
        ...
        private List<SpeechEntry> m_Speech;
        ...
        public new List<SpeechEntry> Speech
        {
            get { return m_Speech; }
            set { m_Speech = value; }
        }
        ...
        [Constructable]
        public Speaker()
            : base( AIType.AI_Thief, FightMode.None, 10, 1, 0.8, 1.6 )
        {
            ...
            if( Female )
            {
                ...
                switch( Utility.Random( 9 ) )
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        AddItem( new KrisnaHair( hairHue ) );
                        break;
                    case 2:
                        AddItem( new PageboyHair( hairHue ) );
                        break;
                    case 3:
                        AddItem( new PonyTail( hairHue ) );
                        break;
                    case 4:
                        AddItem( new ReceedingHair( hairHue ) );
                        break;
                    case 5:
            ...
            else
            {
                ...
                switch( Utility.Random( 5 ) )
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        AddItem( new MediumLongBeard( hairHue ) );
                        break;
                    case 2:
                        AddItem( new Vandyke( hairHue ) );
                        break;
                    case 3:
        ...
        private static VendorShoeType ShoeType
        {
        ...
        public override void OnDoubleClick( Mobile from )
        {
            if( from.AccessLevel >= AccessLevel.GameMaster )
            {
                ...
                {
                    from.SendMessage(
                        "The NPC is currently performing a task. Please wait for it to end before configuring it." );
                    return;
                }
                ...
                {
                    from.SendMessage(
                        "Someone else is currently configuring this NPC. Please try again in a short while." );
                    return;
                }
        ...
        public void SayNext()
        {
            Say( m_SelectedEntry.Speech[ m_NextLine ] );
        ...
        {
            private bool m_MatchAll; // Means all keywords must be matched for the NPC to respond
            private List<string> m_Keywords;
            private List<string> m_Speech;
            ...
            public SpeechEntry()
            {
                ...
                m_Speech = new List<string>();
            }

            public SpeechEntry( IEnumerable<string> keywords, IEnumerable<string> speech )
                : this()
            {
            ...
            public override string ToString()
            {
                ...
                {
                    for( int i = 1; i < m_Keywords.Count; i++ )
                        str += string.Format( " - {0}", m_Keywords[ i ] );
                }
        ...
        private class SpeechTimer : Timer
        {
            ...
            public SpeechTimer( Speaker speaker, int interval )
                : base( new TimeSpan( 0, 0, 0, interval, 0 ), new TimeSpan( 0, 0, 0, interval, 0 ) )
            {
                m_Speaker = speaker;
            }
        ...
        private class SpeechEntryGump : Gump
        {
            ...
            public SpeechEntryGump( Mobile user, Speaker speaker )
                : this( user, speaker, null, 0, 0, false )
            {
            }

            public SpeechEntryGump( Mobile user, Speaker speaker, SpeechEntry entry )
                : this( user, speaker, entry, entry.Keywords.Count, entry.Speech.Count, true )
            {
            }

            public SpeechEntryGump( Mobile user, Speaker speaker, SpeechEntry entry, int keyIndex, int speechIndex,
                                   bool editMode )
                : base( 50, 50 )
            {
                m_User = user;
            ...
            private void MakeGump()
            {
                ...
                AddImageTiled( 0, 0, 600, 450, 82 );
                AddAlphaRegion( 1, 1, 598, 448 );
                ...
                if( m_Entry.Keywords.Count > 0 )
                {
                    ...
                    if( prevKey >= 0 )
                    {
                        ...
                        AddLabel( 95, 10, 631, m_Entry.Keywords[ prevKey ] );
                    }
                    ...
                    if( nextKey < m_Entry.Keywords.Count )
                    {
                        ...
                        AddLabel( 95, 70, 631, m_Entry.Keywords[ nextKey ] );
                    }
                }

                AddImageTiled( 95, 40, 150, 20, 3004 );
                AddImageTiled( 96, 41, 148, 18, 82 );
                ...
                if( m_KeyIndex < m_Entry.Keywords.Count )
                {
                    ...
                    baseKeyword = m_Entry.Keywords[ m_KeyIndex ];
                ...
                if( m_Entry.Speech.Count > 0 )
                {
                    ...
                    if( prevSpeech >= 0 )
                    {
                        ...
                        AddLabelCropped( 95, 90, 150, 20, 631, m_Entry.Speech[ prevSpeech ] );
                    }
                    ...
                    if( nextSpeech < m_Entry.Speech.Count )
                    {
                        ...
                        AddLabelCropped( 95, 150, 460, 20, 631, m_Entry.Speech[ nextSpeech ] );
                    }
                }
                ...
                AddImageTiled( 11, 181, 578, 228, 82 );
            ...
            {
                string keyword = info.TextEntries[ 0 ].Text;
                string speech = info.TextEntries[ 1 ].Text;
                ...
                switch( info.ButtonID )
                {
                    case 1: // Ok finalize
                        ...
                        if( !m_EditMode )
                        {
                            ...
                            {
                                m_User.SendMessage(
                                    "The specified entry is not complete to be used by the NPC. It will not be added." );
                            }
                        }
                        else
                        {
                            ...
                            {
                                m_User.SendMessage(
                                    "The modifications didn't result in a valid speech script, so the entry has been removed." );
        ...
        private class SpeakerGump : Gump
        {
            ...
            public SpeakerGump( Mobile user, Speaker speaker, int page )
                : base( 50, 50 )
            {
                m_Speaker = speaker;
                m_User = user;
                ...
                m_User.CloseGump( typeof( SpeakerGump ) );
            ...
            private void MakeGump()
            {
                ...
                for( int i = 0; i < 4 && m_Page * 4 + i < m_Speaker.Speech.Count; i++ )
                {
                    ...
                    AddImageTiled( 51, 51 + i * 60, 238, 48, 82 );
            ...
            public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
            {
                switch( info.ButtonID )
                {
                    ...
                    default:
                        ...
                        {
                            case 0:
                                m_User.SendGump( new SpeechEntryGump( m_User, m_Speaker, m_Speaker.Speech[ speechIndex ] ) );
                                break;
                            case 1:
