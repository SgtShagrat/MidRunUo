...
namespace Midgard.Mobiles
{
    ...
    public class OrderMageRider : BaseCreature, IVirtueCreature
    {
        [Constructable]
        public OrderMageRider()
            : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.4 )
        {
            ...
            if( Female = Utility.RandomBool() )
            {
                ...
                Title = "the ghost of an Order Sorceress Rider";
            }
            else
            {
                Body = 0x190;
                ...
                Title = "the ghost of an Order Mage Rider";
            }
        ...
        public OrderMageRider( Serial serial )
            : base( serial )
        {
        }
