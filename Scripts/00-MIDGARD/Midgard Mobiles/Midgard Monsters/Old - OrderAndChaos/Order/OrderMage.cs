...
namespace Midgard.Mobiles
{
    ...
    public class OrderMage : BaseCreature, IVirtueCreature
    {
        [Constructable]
        public OrderMage()
            : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.4 )
        {
            ...
            if( Female = Utility.RandomBool() )
            {
                ...
                Title = "the ghost of an Order Sorceress";
            }
            else
            {
                Body = 0x190;
                ...
                Title = "the ghost of an Order Mage";
            }
        ...
        public OrderMage( Serial serial )
            : base( serial )
        {
        }
