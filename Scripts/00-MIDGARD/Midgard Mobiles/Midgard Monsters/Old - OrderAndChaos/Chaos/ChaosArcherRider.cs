...
namespace Midgard.Mobiles
{
    ...
    public class ChaosArcherRider : BaseCreature, IVirtueCreature
    {
        [Constructable]
        public ChaosArcherRider()
            : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.15, 0.4 )
        {
            ...
            Title = "the ghost of a Chaos Archer Rider";
        ...
        public ChaosArcherRider( Serial serial )
            : base( serial )
        {
        }
