...
{
    [CorpseName( "a four armed daemons corpse" )]
    public class FourArmedDaemon : BaseCreature
    {
        [Constructable]
        public FourArmedDaemon()
            : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
        {
            Body = 785;
            Name = "a four armed daemon";
            BaseSoundID = 357;
        ...
        public FourArmedDaemon( Serial serial )
            : base( serial )
        {
        }
