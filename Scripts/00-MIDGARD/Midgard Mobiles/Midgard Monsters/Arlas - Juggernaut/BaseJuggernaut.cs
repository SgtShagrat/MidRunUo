...
{
	public abstract class BaseJuggernaut : BaseCreature
	{
		...
		#region costruttori
		public BaseJuggernaut( AIType aiType, FightMode mode ) : base( aiType, mode, 10, 1, 0.2, 0.4 )
		{
		}

		public BaseJuggernaut( AIType aiType ) : this( aiType, FightMode.Closest )
		{
		}

		public BaseJuggernaut() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		}

		public BaseJuggernaut( Serial serial ) : base( serial )
		{
		}
		#endregion
		...
		public override double AutoDispelChance { get { return 1; } }
		...
		public override void OnGaveMeleeAttack( Mobile defender )
		{
			...
			{
				PublicOverheadMessage( MessageType.Regular, 0x3C3, true, (defender.Language == "ITA" ? "*La terra si modella al suo comando*" : "*earth sunks around the juggernaut*") );
				Earthquake();
			}
