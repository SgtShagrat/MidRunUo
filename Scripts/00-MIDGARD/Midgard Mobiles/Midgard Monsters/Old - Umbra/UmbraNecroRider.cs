...
{ 
   public class UmbraNecroRider : BaseCreature , IUmbraFolk
   { 
      [Constructable] 
      public UmbraNecroRider() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
      { 
...
//		public override bool BardImmune{ get{ return true; } }
		...
		public UmbraNecroRider( Serial serial ) : base( serial ) 
		{ 
		} 
