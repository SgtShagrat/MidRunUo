...
{ 
   public class UmbraWarrior : BaseCreature , IUmbraFolk
   { 
      [Constructable] 
      public UmbraWarrior() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
      { 
...
//		public override bool BardImmune{ get{ return true; } }
		...
		public UmbraWarrior( Serial serial ) : base( serial ) 
		{ 
		} 
