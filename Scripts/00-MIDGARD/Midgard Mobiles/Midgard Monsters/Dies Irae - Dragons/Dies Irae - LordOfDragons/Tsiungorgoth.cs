...
/***************************************************************************
 *  Info:
 * 			Tsiungorgoth e' il signore dei draghi rossi.
 *
 ***************************************************************************/
...
{
    [CorpseName( "the corpse of a Red Dragonlord" )]
    public class Tsiungorgoth : BaseLordOfDragons
    {
        #region costruttori
        [Constructable]
        public Tsiungorgoth()
            : base( AIType.AI_Mage, FightMode.Closest )
        {
            ...
            FireBreathAttack = Utility.RandomMinMax( 200, 200 );
            PetPoisonAttack = Utility.RandomMinMax( 100, 200 );
        ...
        public Tsiungorgoth( Serial serial )
            : base( serial )
        {
        }
        #endregion
