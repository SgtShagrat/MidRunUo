...
/***************************************************************************
 *  Info:
 * 			Koardon e' il signore dei draghi neri.
 *
 ***************************************************************************/
...
{
    [CorpseName( "the corpse of a Black Dragonlord" )]
    public class Koardon : BaseLordOfDragons
    {
        #region costruttori
        [Constructable]
        public Koardon()
        ...
        {
            Name = "Koardon";
            Title = ", the Evil Black DragonLord";
            ...
            FireBreathAttack = Utility.RandomMinMax( 150, 200 );
            PetPoisonAttack = Utility.RandomMinMax( 150, 200 );
            RoarAttack = Utility.RandomMinMax( 150, 200 );
        ...
        #region metodi
        public override double BreathDamageScalar { get { return 0.006; } }
