...
/***************************************************************************
 *  Info:
 * 			template di un drago rosso giovane.
 *
 ***************************************************************************/
...
{
    [CorpseName( "the corpse of a Red Young Dragon" )]
    public class RedYoungDragon : BaseYoungDragon
    {
        #region costruttori
        [Constructable]
        public RedYoungDragon()
            : base( AIType.AI_Mage, FightMode.Closest )
        {
            Name = "a Red Dragon (young)";
            ...
            FireBreathAttack = Utility.RandomMinMax( 130, 130 );
            PetPoisonAttack = Utility.RandomMinMax( 100, 130 );
            RoarAttack = Utility.RandomMinMax( 155, 155 );
        ...
        public RedYoungDragon( Serial serial )
            : base( serial )
        {
        }
        #endregion
