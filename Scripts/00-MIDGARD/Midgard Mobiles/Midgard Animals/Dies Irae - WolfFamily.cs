...
namespace Midgard.Mobiles
{
    ...
    public class MotherWolf : BaseCreature
    {
        ...
        private int m_PupCount = Utility.RandomMinMax( 2, 5 );
            ...
            : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.1, 0.3 )
        {
            ...
            Timer timer = new WolfFamilyTimer( this );
            timer.Start();
        }
        ...
        public void SpawnBabies()
        {
            ...
            if( family >= m_PupCount )
                return;

            DebugSay( "family {0}, should be {1}", family, m_PupCount );
            ...
            int hr = ( RangeHome + 1 ) / 2;

            for( int i = family; i < m_PupCount; ++i )
            {
        ...
        private class WolfFamilyTimer : Timer
        {
