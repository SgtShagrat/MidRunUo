/***************************************************************************
 *                               UpdateMidgardStatueAnimation.cs
 *
...
{
    public class UpdateMidgardStatueAnimation : Packet
    {		
        public UpdateMidgardStatueAnimation( Mobile m, int status, int animation, int frame ) : base( 0xBF, 17 )
        {
