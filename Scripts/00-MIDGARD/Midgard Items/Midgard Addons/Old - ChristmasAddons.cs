...
{
    #region TownCenterChristmasTree
    public class TownCenterChristmasTreeAddon : BaseAddon
    {
        ...
        public TownCenterChristmasTreeAddon( Serial serial )
            : base( serial )
        {
        }
    ...
    public class TownCenterChristmasTreeAddonDeed : BaseAddonDeed
    {
        ...
        public TownCenterChristmasTreeAddonDeed( Serial serial )
            : base( serial )
        {
        }
    ...
    #region TownCenterChristmasTreeNG
    public class TownCenterChristmasTreeNGAddon : BaseAddon
    {
        ...
        public TownCenterChristmasTreeNGAddon( Serial serial )
            : base( serial )
        {
        }
    ...
    public class TownCenterChristmasTreeNGAddonDeed : BaseAddonDeed
    {
        ...
        public TownCenterChristmasTreeNGAddonDeed( Serial serial )
            : base( serial )
        {
        }
