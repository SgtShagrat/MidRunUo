...
{
	public class ElvenPlateGorget : PlateGorget
	{
		[Constructable]
		public ElvenPlateGorget() : this( 0 )
		{
		}

		[Constructable]
		public ElvenPlateGorget( int hue )
		{
			ItemID = 0x288;
			Hue = hue;
		}
		...
		public ElvenPlateGorget( Serial serial ) : base( serial )
		{
		}
