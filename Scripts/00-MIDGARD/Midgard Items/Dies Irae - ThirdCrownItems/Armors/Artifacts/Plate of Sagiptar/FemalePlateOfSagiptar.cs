...
{
    public class FemalePlateOfSagiptar : FemalePlateChest, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Female Plate Of Sagiptar"; } }
        ...
        public FemalePlateOfSagiptar( Serial serial )
            : base( serial )
        {
        }
