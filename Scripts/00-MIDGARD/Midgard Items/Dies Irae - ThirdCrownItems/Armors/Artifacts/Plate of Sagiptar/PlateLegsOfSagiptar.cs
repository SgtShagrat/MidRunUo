...
{
    public class PlateLegsOfSagiptar : PlateLegs, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Legs Of Sagiptar"; } }
        ...
        public PlateLegsOfSagiptar( Serial serial )
            : base( serial )
        {
        }
