...
{
    public class PlateGlovesOfDarkness : PlateGloves, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Gloves Of Darkness"; } }
        ...
        public PlateGlovesOfDarkness( Serial serial )
            : base( serial )
        {
        }
