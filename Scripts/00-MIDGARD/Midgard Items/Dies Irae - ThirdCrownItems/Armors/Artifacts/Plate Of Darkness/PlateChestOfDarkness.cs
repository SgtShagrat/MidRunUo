...
{
    public class PlateChestOfDarkness : PlateChest, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Chest Of Darkness"; } }
        ...
        public PlateChestOfDarkness( Serial serial )
            : base( serial )
        {
        }
