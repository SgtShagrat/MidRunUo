...
{
    public class PlateArmsOfDarkness : PlateArms, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Arms Of Darkness"; } }
        ...
        public PlateArmsOfDarkness( Serial serial )
            : base( serial )
        {
        }
