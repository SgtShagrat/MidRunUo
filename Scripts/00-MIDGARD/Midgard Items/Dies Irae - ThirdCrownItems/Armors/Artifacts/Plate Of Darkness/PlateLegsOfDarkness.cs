...
{
    public class PlateLegsOfDarkness : PlateLegs, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Legs Of Darkness"; } }
        ...
        public PlateLegsOfDarkness( Serial serial )
            : base( serial )
        {
        }
