...
{
    public class FemalePlateOfDarkness : FemalePlateChest
    {
        public override string DefaultName { get { return "Female Plate Of Darkness"; } }
        ...
        public FemalePlateOfDarkness( Serial serial )
            : base( serial )
        {
        }
