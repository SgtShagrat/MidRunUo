...
{
    public class PlateGlovesOfWater : PlateGloves, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Gloves Of The Water Element"; } }
        ...
        public PlateGlovesOfWater( Serial serial )
        : base( serial )
        {
        }
