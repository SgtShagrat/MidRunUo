...
{
    public class PlateChestOfWater : PlateChest, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Breastplate Of The Water Element"; } }
        ...
        public PlateChestOfWater( Serial serial )
            : base( serial )
        {
        }
