...
{
    public class PlateLegsOfWater : PlateLegs, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Legs Of The Water Element"; } }
        ...
        public PlateLegsOfWater( Serial serial )
        : base( serial )
        {
        }
