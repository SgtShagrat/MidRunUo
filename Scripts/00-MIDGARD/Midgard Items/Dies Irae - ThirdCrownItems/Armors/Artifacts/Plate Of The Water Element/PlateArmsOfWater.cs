...
{
    public class PlateArmsOfWater : PlateArms, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Arms Of The Water Element"; } }
        ...
        public PlateArmsOfWater( Serial serial )
        : base( serial )
        {
        }
