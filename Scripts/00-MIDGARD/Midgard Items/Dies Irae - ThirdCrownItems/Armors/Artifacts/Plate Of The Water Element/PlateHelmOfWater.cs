...
{
    public class PlateHelmOfWater : PlateHelm, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Helm Of The Water Element"; } }
        ...
        public PlateHelmOfWater( Serial serial )
        : base( serial )
        {
        }
