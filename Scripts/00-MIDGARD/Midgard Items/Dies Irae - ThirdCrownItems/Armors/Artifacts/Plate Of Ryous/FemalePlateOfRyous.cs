...
{
    public class FemalePlateOfRyous : FemalePlateChest, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Female Plate Of Ryous"; } }
        ...
        public FemalePlateOfRyous( Serial serial )
        : base( serial )
        {
        }
