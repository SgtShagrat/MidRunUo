...
{
    public class PlateHelmOfRyous : PlateHelm, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Helm Of Ryous"; } }
        ...
        public PlateHelmOfRyous( Serial serial )
        : base( serial )
        {
        }
