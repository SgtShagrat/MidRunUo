...
{
    public class PlateChestOfRyous : PlateChest, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Chest Of Ryous"; } }
        ...
        public PlateChestOfRyous( Serial serial )
            : base( serial )
        {
        }
