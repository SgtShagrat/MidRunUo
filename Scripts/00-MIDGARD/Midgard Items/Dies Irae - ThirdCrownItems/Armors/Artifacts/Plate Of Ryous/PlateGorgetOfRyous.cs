...
{
    public class PlateGorgetOfRyous : PlateGorget, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Gorget Of Ryous"; } }
        ...
        public PlateGorgetOfRyous( Serial serial )
        : base( serial )
        {
        }
