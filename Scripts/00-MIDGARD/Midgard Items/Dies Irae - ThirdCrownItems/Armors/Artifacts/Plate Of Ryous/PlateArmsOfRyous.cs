...
{
    public class PlateArmsOfRyous : PlateArms, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Plate Arms Of Ryous"; } }
        ...
        public PlateArmsOfRyous( Serial serial )
        : base( serial )
        {
        }
