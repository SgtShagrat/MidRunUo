...
{
    public class MidgardHalberd : Halberd, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Midgard Halberd"; } }
        ...
        public MidgardHalberd( Serial serial )
        : base( serial )
        {
        }
