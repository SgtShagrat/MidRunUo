...
{
    public class MidgardWarAxe : WarAxe, ITreasureOfMidgard
    {
        public override string DefaultName { get { return "Midgard War Axe"; } }
        ...
        public override int DiceBonus { get { return 13; } }

        [Constructable]
        public MidgardWarAxe()
        {
            Weight = 11.0;
            Hue = 0x48D;
        }
        ...
        public MidgardWarAxe( Serial serial )
        : base( serial )
        {
        }
