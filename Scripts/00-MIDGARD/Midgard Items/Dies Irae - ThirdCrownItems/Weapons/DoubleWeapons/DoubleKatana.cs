...
{
	/// <summary>
	/// 0x3353 Double Katana - ( craftabile, due mani )
	/// </summary>
	public class DoubleKatana : Katana, IDoubleWeapon
	{
		public override string DefaultName { get { return "double katana"; } }
		...
		public DoubleKatana( Serial serial ) : base( serial )
		{
		}
