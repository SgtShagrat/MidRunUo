...
{
	/// <summary>
	/// 0x3352 Double Kryss - ( craftabile, due mani )
	/// </summary>
	public class DoubleKryss : Kryss, IDoubleWeapon
	{
		public override string DefaultName { get { return "double kryss"; } }
		...
		public DoubleKryss( Serial serial ) : base( serial )
		{
		}
