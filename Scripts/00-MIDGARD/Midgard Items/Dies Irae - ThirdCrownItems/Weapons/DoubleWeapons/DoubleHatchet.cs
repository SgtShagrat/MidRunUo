...
{
	/// <summary>
	/// 0x3354 Double Hatchet - ( craftabile, due mani )
	/// </summary>
	[RaceAllowance( typeof( MountainDwarf ) )]
	public class DoubleHatchet : Hatchet, IDoubleWeapon
	{
		public override string DefaultName { get { return "double hatchet"; } }

		[Constructable]
		public DoubleHatchet()
		{
			ItemID = 0x3354;
		...
		public DoubleHatchet( Serial serial ) : base( serial )
		{
		}
	...
	public interface IDoubleWeapon
	{
	}
}