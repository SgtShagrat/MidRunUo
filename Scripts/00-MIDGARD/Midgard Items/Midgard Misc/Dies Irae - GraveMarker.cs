...
{
    [Flipable( 4453, 4454, 4455, 4456, 4457, 4458, 4459, 4460, 4461, 4462, 4463, 4464, 4465, 4466, 4467, 4468, 4469, 4470
        , 4471, 4472, 4473, 4474, 4475, 4476, 4477, 4478, 4479, 4480, 4481, 4482, 4483, 4484 )]
    public class GraveMarker : Item
    {
        private string m_Epitaph = "A Gravestone";
        ...
        public int Style
        {
            get { return ItemID - 4453; }
            set { ItemID = value % 32 + 4453; }
        }
        ...
        [Constructable]
        public GraveMarker( int style )
            : base( 0x1165 + ( style & 0x1F ) )
        {
            Movable = false;
        }

        #region serialization
        public GraveMarker( Serial serial )
            : base( serial )
        {
        }
        ...
        private class EpitaphGump : Gump
        {
            ...
            private static readonly string[] Epitaphs = {
                                                        ...
                                                        , //Ultima VI
                                                        "<BR>The crypt of<BR>Cantrell", "<BR>The crypt of<BR>Spector",
                                                        "<BR>The crypt of<BR>Malone", "<BR>The crypt of<BR>Bourbonnais",
                                                        "<BR>The crypt of<BR>Beyvin", "<BR>The crypt of<BR>Jannati",
                                                        "<BR>The crypt of<BR>Romero", "<BR>The crypt of<BR>Dwyer",
            ...
            public EpitaphGump( Mobile owner, GraveMarker marker )
                : this( owner, marker, -1 )
            {
            }

            private EpitaphGump( Mobile owner, GraveMarker marker, int index )
                : base( 25, 25 )
            {
