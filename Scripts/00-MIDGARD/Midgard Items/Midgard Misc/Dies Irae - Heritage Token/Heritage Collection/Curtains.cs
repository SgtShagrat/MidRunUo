...
{		
	...
	public class CurtainsAddon : BaseAddon
	{
		...
		public CurtainsAddon( bool east ) : base()
		{
			if ( east ) // east
			{
				AddComponent( new CurtainsComponent( 0x3DAC, 0x3DAE ), 0, -1, 0 );
				AddComponent( new CurtainsComponent( 0x3D9E, 0x3DA8 ), 0, 0, 0 );
				AddComponent( new CurtainsComponent( 0x3D9F, 0x3DA7 ), 0, 2, 0 );
				AddComponent( new CurtainsComponent( 0x3DA0, 0x3DA6 ), 0, 1, 0 );
			}
			else 		// south
			{
				AddComponent( new CurtainsComponent( 0x3D9C, 0x3DAD ), 0, 0, 0 );
				AddComponent( new CurtainsComponent( 0x3D9D, 0x3DA3 ), -1, 0, 0 );
				AddComponent( new CurtainsComponent( 0x3DA1, 0x3DA4 ), 2, 0, 0 );
				AddComponent( new CurtainsComponent( 0x3DAB, 0x3DA5 ), 1, 0, 0 );
			}
		}
