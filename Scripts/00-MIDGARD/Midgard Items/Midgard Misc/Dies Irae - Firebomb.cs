		...
		private void OnFirebombTimerTick()
		{
			...
			switch ( m_Ticks )
			{
				...
				case 2:
				{
					...
					if ( HeldBy != null )
						HeldBy.PublicOverheadMessage( MessageType.Regular, 957, true, m_Ticks.ToString() );
					else if ( RootParent == null )
						PublicOverheadMessage( MessageType.Regular, 957, true, m_Ticks.ToString() );
					else if ( RootParent is Mobile )
						((Mobile)RootParent).PublicOverheadMessage( MessageType.Regular, 957, true, m_Ticks.ToString() );
