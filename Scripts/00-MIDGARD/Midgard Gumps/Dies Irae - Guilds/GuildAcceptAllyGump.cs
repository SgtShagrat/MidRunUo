...
{
	public class GuildAcceptAllyGump : GuildListGump
	{
		public GuildAcceptAllyGump( Mobile from, Guild guild ) : base( from, guild, true, guild.AllyInvitations )
		{
		}
					...
					if( index >= 0 && index < m_List.Count )
					{
						...
						if( g != null )
						{
							...
							if( m_Guild.AllyInvitations.Count > 0 )
								m_Mobile.SendGump( new GuildAcceptAllyGump( m_Mobile, m_Guild ) );
							else
