...
{
	public class GuildRescindAllianceDeclarationGump : GuildListGump
	{
		public GuildRescindAllianceDeclarationGump( Mobile from, Guild guild )
		...
		protected override void Design()
		{
			...
			AddHtml( 55, 400, 245, 30, m_Mobile.Language == "ITA" ? "Rescindi le tue richieste di alleanza." : "Rescind your alliance declarations.", false, false );
