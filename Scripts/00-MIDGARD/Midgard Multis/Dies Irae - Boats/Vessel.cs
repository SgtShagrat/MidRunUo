...
namespace Midgard.Multis
{
    public class Vessel : BaseBoat
    {
        ...
        public override int ResistFire
        {
            get { return 30; }
        }

        public override int ResistPhysical
        {
            get { return 70; }
        }

        public override int BoatPrice
        {
            get { return 1000; }
        }
        ...
        {
            get { return new Point2D( 5, 0 ); }
        }

        public override Point2D PortOffset
        {
            get { return new Point2D( -5, 2 ); }
        }
        ...
        {
            return false; // vessels does not decay
        }
    ...
    public class VesselDockedBoat : BaseDockedBoat
    {
        public VesselDockedBoat( BaseBoat boat )
            : base( 5008, Point3D.Zero, boat )
        {
            ItemID = 0x14F3;
        }

        public VesselDockedBoat( Serial serial )
            : base( serial )
        {
        }
    ...
    public class VesselDeed : BaseBoatDeed
    {
        [Constructable]
        public VesselDeed()
            : base( 5008, Point3D.Zero )
        {
        }

        public VesselDeed( Serial serial )
            : base( serial )
        {
        }
        ...
        {
            get { return "a vessel deed"; }
        }

        public override BaseBoat Boat
        {
            get { return new Vessel(); }
        }
