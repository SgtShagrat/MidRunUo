...
{	
    public interface IMidgardQuester
    {
        string Name{ get;}
        Region Region { get; }
        Type[] Quests { get; }
	...
	{			
        ...
        public virtual int KarmaReward{ get{ return 0; } } // mod by Dies Irae
		...
		public IMidgardQuester StartingMobile // mod by Dies Irae
		{
            get { return m_Quester is IMidgardQuester ? (IMidgardQuester)m_Quester : null; }
		}
        ...
        public virtual void OnCompleted()
        {
            ...
            m_Owner.SendMessage( 0x23, m_Owner.Language == "ITA" ? "Hai completato una quest! Non dimenticare di ritirare il premio." : "You've completed a quest!  Don't forget to collect your reward." );
		...
		{				
			...
			{	
				...
				{					
					...
					for ( int j = 0; j < m_Rewards[ i ].Amount; j ++ )
					{
						...
						{
							m_Owner.SendMessage( m_Owner.Language == "ITA" ? "Non c'è spazio sufficiente nel tuo zaino!" : "There is not enough room in your backpack!" ) ;
            ...
            if( KarmaReward > 0 )
                Misc.Titles.AwardKarma( m_Owner, KarmaReward, true );
