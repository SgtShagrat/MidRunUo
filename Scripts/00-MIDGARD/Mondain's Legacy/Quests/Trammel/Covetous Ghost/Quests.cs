...
namespace Server.Engines.Quests
{
	...
	{		
		...
		{							
            ...
            AddReward( new BaseReward( typeof( Gold ), 500, 1075284 ) ); // Return the filled Spirit Bottle to Griswolt the Master Necromancer to receive a reward.
		}
	...
	{		
		...
		{							
			...
			AddReward( new BaseReward( typeof( Gold ), 250, 1075339 ) ); // Hurry! You must get the silk to Leon the Alchemist quickly, or it will crumble and become useless!
		}
	...
	{		
        ...
        public override int KarmaReward { get { return 100; } } // mod by Dies Irae
