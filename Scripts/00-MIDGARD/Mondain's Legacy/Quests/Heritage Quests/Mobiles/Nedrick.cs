...
{	
	public class Nedrick : HeritageQuester
	{
		...
		{
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( IngenuityQuest ), 1074350 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( HeaveHoQuest ), 1074351 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( ResponsibilityQuest ), 1074352 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( AllSeasonAdventurerQuest ), 1074353 ) );
