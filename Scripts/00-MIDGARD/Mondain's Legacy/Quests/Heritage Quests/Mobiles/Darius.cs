...
{	
	...
	{	
		...
		{
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( TheJoysOfLifeQuest ), 1072787 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( DefendingTheHerdQuest ), 1072785 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( CaretakerOfTheLandQuest ), 1072783 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( SeasonsQuest ), 1072782 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( TheBalanceOfNatureQuest ), 1072786 ) );
			HeritageQuests.Add(	new HeritageQuestInfo( typeof( WisdomOfTheSphynxQuest ), 1072784 ) );
