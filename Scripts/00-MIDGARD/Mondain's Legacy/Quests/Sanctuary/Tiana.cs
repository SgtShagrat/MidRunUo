...
{	
	...
	{				
		...
		{			
            ...
            AddReward( new BaseReward( typeof( Gold ), 250, "gold" ) );
		}
		
        public override int KarmaReward { get { return 50; } } // mod by Dies Irae
	...
	{				
        ...
        public override int KarmaReward { get { return 25; } } // mod by Dies Irae
	...
	{				
		...
		{			
			AddObjective( new SlayObjective( typeof( Brigand ), "brigands", 20 ) );
	...
	{				
		...
		{			
			...
			// AddReward( new BaseReward( typeof( TreasureBag ), 1072583 ) );
            AddReward( new BaseReward( typeof( Gold ), 125, "gold" ) );
		}
	...
	{				
        ...
        public override int KarmaReward { get { return 10; } } // mod by Dies Irae
