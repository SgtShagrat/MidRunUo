...
namespace Server.Items
{
    ...
    public class SleeperTallElvenEast : BaseAddon, IChopable
    {
        ...
        public SleeperTallElvenEast( Serial serial )
            : base( serial )
        {
        }
        ...
        {
            get { return new SleeperTallElvenEastDeed(); }
        }
            ...
            else
            {
                if( !m_Sleeping )
                {
                    ...
                    if( m_house != null && ( m_house.IsOwner( from ) || m_house.IsCoOwner( from ) || m_house.IsFriend( from ) ) )
                    {
                        ...
                        var m_Location = new Point3D( Location.X + 3, Location.Y, Location.Z + 14 );
                        m_SleeperBedBody.Direction = Direction.East;
                        m_SleeperBedBody.MoveToWorld( m_Location, Map );
                    }
                    else
                    {
        ...
        public override void GetProperties( ObjectPropertyList list )
        {
            ...
            string tmp = String.Format( "{0}: {1}", Name, ( m_Player != null ? m_Player.Name : "unassigned" ) );
            list.Add( tmp );
    ...
    public class SleeperTallElvenEastPiece : AddonComponent
    {
        ...
        public SleeperTallElvenEastPiece( SleeperTallElvenEast sleeper, int itemid )
            : base( itemid )
        {
            m_Sleeper = sleeper;
        }

        public SleeperTallElvenEastPiece( Serial serial )
            : base( serial )
        {
        }
    ...
    public class SleeperTallElvenEastDeed : BaseAddonDeed
    {
        ...
        {
            get { return new SleeperTallElvenEast(); }
        }
