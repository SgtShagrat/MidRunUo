...
{
    public class ChristmasGingerBreadCookie : Food, IEventItem
    {
        #region IEventItem
        ...
        [Constructable]
        public ChristmasGingerBreadCookie()
        ...
        public ChristmasGingerBreadCookie( Serial serial )
            : base( serial )
        {
        }
        ...
        {
            private readonly ChristmasGingerBreadCookie m_Cookie;
            private readonly int m_Sequencer;
            private readonly Mobile m_Mobile;

            public InternalTimer( ChristmasGingerBreadCookie cookie, Mobile m, int sequencer, TimeSpan delay )
                : base( delay )
            {
            ...
            protected override void OnTick()
            {
                if( m_Mobile != null )
                {
                    m_Cookie.GiveToothAche( m_Mobile, m_Sequencer + 1 );
                }
            }
        }
    }
