...
namespace Midgard.Misc
{
    ...
    public static class ReflectionHelper
    {
        ...
        /// </summary>
        /// <param name="fieldName">Name of the member.</param>
        /// <param name="typeName">Name type of the member.</param>
        ...
        /// <summary>
        /// Sets the value of the public static member.
        /// </summary>
        /// <param name="fieldName">Name of the member.</param>
        /// <param name="typeName">TypeName of the member.</param>
        /// <param name="value">Value to set.</param>
        public static void SetPublicStaticFieldValue<T>( string fieldName, string typeName, T value )
        {
            Type type = Type.GetType( typeName, true );
        ...
        /// <param name="type">Type of the member.</param>
        /// <param name="value">Value to set.</param>
        public static void SetPublicStaticFieldValue<T>( string fieldName, Type type, T value )
        {
            FieldInfo field = type.GetField( fieldName, BindingFlags.Public | BindingFlags.Static );
            if( field == null )
                throw new ArgumentException( string.Format( "Could not find the private instance field '{0}'", fieldName ) );
        ...
        /// <summary>
        /// Invokes a non-public instance method.
        /// </summary>
