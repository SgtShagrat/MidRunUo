...
//					int amount = from.Fame / 10;
...
#if DebugResurrectGump
					Console.WriteLine( "\nDebugResurrectGump:" );
					Console.WriteLine( "\tFame ante: {0}, Amount to loose: {1}", 
					                   from.Fame.ToString(), amount.ToString();
#endif
					#endregion
                ...
                if( /*!Core.AOS && */from.ShortTermMurders >= 5 && !isStatLossImmune ) // mod by Dies Irae : abilitato lo statloss
				{
