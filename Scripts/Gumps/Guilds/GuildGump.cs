...
namespace Server.Gumps
{
	public class GuildGump : Gump
	{
		...
		public GuildGump( Mobile beholder, Guild guild ) : base( 20, 30 )
		{
			...
			Dragable = true; // Dragable = true; // mod by Dies Irae // Mod by Dies Irae
			...
			AddButton( 20, 220 - offset, 4005, 4007, 6, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 220 - offset, 470, 30, 1011087, false, false ); // View the guild's charter.

			AddButton( 20, 250 - offset, 4005, 4007, 7, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 250 - offset, 470, 30, 1011092, false, false ); // Resign from the guild.

			AddButton( 20, 280 - offset, 4005, 4007, 8, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 280 - offset, 470, 30, 1011095, false, false ); // View list of guilds you are at war with.

			AddButton( 20, 280 + 30 - offset, 4005, 4007, 10, GumpButtonType.Reply, 0 );
			AddHtml( 55, 280 + 30 - offset, 470, 30, beholder.Language == "ITA" ? "Guarda la lista delle gilde alleate." : "View list of guilds you are allied with.", false, false );

			if ( beholder.AccessLevel >= AccessLevel.GameMaster || beholder == leader )
			{
				AddButton( 20, 310 + 30 - offset, 4005, 4007, 9, GumpButtonType.Reply, 0 );
				AddHtmlLocalized( 55, 310 + 30 - offset, 470, 30, 1011094, false, false ); // Access guildmaster functions.
			}
			else
			{
				AddImage( 20, 310 + 30 - offset, 4020 );
				AddHtmlLocalized( 55, 310 + 30 - offset, 470, 30, 1018013, false, false ); // Reserved for guildmaster
			}
		...
		public static void EnsureClosed( Mobile m )
		{
            ...
            m.CloseGump( typeof( GuildAllianceGump ) ); // mod by Dies Irae
		}
