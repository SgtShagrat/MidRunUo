...
namespace Server.Gumps
{
	public class GuildmasterGump : Gump
	{
		...
		public GuildmasterGump( Mobile from, Guild guild ) : base( 20, 30 )
		{
			...
			AddButton( 20, 190 + 30, 4005, 4007, 12, GumpButtonType.Reply, 0 );
			AddHtml( 55, 190 + 30, 245, 30, from.Language == "ITA" ? "Vai al menu ALLEANZE." : "Go to the ALLIANCE menu.", false, false );

			if ( m_Guild.Candidates.Count > 0 )
			{
				AddButton( 20, 220 + 30, 4005, 4007, 8, GumpButtonType.Reply, 0 );
				AddHtmlLocalized( 55, 220 + 30, 470, 30, 1013056, false, false ); // Administer the list of candidates
			}
			else
			{
				AddImage( 20, 220 + 30, 4020 );
				AddHtmlLocalized( 55, 220 + 30, 470, 30, 1013031, false, false ); // There are currently no candidates for membership.
			}

			AddButton( 20, 250 + 30, 4005, 4007, 9, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 250 + 30, 470, 30, 1011117, false, false ); // Set the guildmaster's title.

			AddButton( 20, 280 + 30, 4005, 4007, 10, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 280 + 30, 470, 30, 1011118, false, false ); // Grant a title to another member.

			AddButton( 20, 310 + 30, 4005, 4007, 11, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 310 + 30, 470, 30, 1011119, false, false ); // Move this guildstone.
