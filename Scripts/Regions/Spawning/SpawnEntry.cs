...
namespace Server.Regions
{
    public class SpawnEntry : ISpawner
    {
        ...
        public static string NewSpawn
        {
            get
            {
                var now = DateTime.Now.Ticks;
                while( m_Table.ContainsKey( now.ToString() ) )
                {
        ...
        public static SpawnEntry FindSpawnEntry( string id )
        {
            SpawnEntry entry;

            m_Table.TryGetValue( id, out entry );
        ...
        private static Dictionary</* int */ string, SpawnEntry> m_Table = new Dictionary</* int */ string, SpawnEntry>(); // mod by Dies Irae

        public static Dictionary</* int */ string, SpawnEntry> Table { get { return m_Table; } } // mod by Dies Irae
        ...
        public bool RemoveIfUntamed { get { return false; } }
        ...
        #region mod by Dies Irae
        /// <summary>
        /// Amount scaled by regional or entry density
        /// </summary>
        public int RelativeAmount { get; set; }

        /// <summary>
        /// Weight of this entry inside spawn group
        /// </summary>
        public int Weight { get; set; }

        /// <summary>
        /// Custom density for this entry.
        /// Override regional density
        /// </summary>
        public SpawnDensity Density { get; set; }

        /// <summary>
        /// Custom amount for this entry.
        /// Override any density definition.
        /// </summary>
        public int ForceAmount { get; set; }
        #endregion
        
        public SpawnEntry( /* int id */ string id, BaseRegion region, Point3D home, int range, Direction direction, SpawnDefinition definition, int max, TimeSpan minSpawnTime, TimeSpan maxSpawnTime )
        {
            #region mod by Dies Irae
            if( string.IsNullOrEmpty( id ) ) // we didn't provide a serial
            {
                Console.WriteLine( "Warning: SpawnEntry with null id detected." );
                return;
            }
            else
                m_ID = id;
        ...
        public static void Initialize()
        {
            ...
            /* moved to Regional Sawning System by Dies Irae
