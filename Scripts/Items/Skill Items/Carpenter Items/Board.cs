/*
 * 	Script disabled by Dies Irae due to a newer implementation in Scipts/00-Midgard
 *
using System;
...
namespace Server.Items
{
	...
	public class Board : Item, ICommodity
	{
		...
		[Constructable]
		public Board( int amount ) : this( CraftResource.RegularWood, amount )
		{
		}
		...
		[Constructable]
		public Board( CraftResource resource, int amount ) : base( 0x1BD7 )
		{
			Stackable = true;
			Amount = amount;
