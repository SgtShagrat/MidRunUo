...
namespace Server.Items
{
	public class ProspectorsTool : BaseBashing, IUsesRemaining
	{
		...
		public void Prospect( Mobile from, object toProspect )
		{
			...
			HarvestBank bank = def.GetBank( map, loc.X, loc.Y,loc.Z, tileID); // mod by Dies Irae
			...
			else if ( veinIndex >= (def.Veins.Length - 1) )
			{
                ...
                if( !Core.AOS )
                    ...
                    from.SendMessage( "You cannot improve aqua ore through prospecting." );
				#endregion
			}
			else
			{
                ...
                if( !Core.AOS )
				    ...
				    from.SendMessage( "You sift through ore and find {0} can be mined there", GetVeinNameFromIndex( veinIndex + 1 ) );
				#endregion
		...
		#region mod by Dies Irae
		public string GetVeinNameFromIndex( int index )
		{
			switch( index )
			{
				case 0: return "iron";
				case 1: return "dull copper";
				case 2: return "shadow iron";
				case 3: return "copper";
				case 4: return "bronze";
				case 5: return "gold";
				case 6: return "agapite";
				case 7: return "verite";
				case 8: return "valorite";
				case 9: return "platinum";
				case 10: return "titanium";
				case 11: return "obsidian";
				case 12: return "dark rubidian";
				case 13: return "ebon sapphire";
				case 14: return "radiant diamond";
				case 15: return "eldar";
				case 16: return "crystaline";
				case 17: return "vulcan";
				case 18: return "aqua";
				default: return "iron";
			}
		}
