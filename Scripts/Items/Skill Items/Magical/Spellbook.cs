...
namespace Server.Items
{
	...
	public class Spellbook : Item, ICraftable, ISlayer, IEngravable
	{
        ...
        public string EngravedText
        {
            ...
            set { m_EngravedText = value; InvalidateProperties(); InvalidateSecondAgeNames(); }
        }
		...
		private static void EventSink_OpenSpellbookRequest( OpenSpellbookRequestEventArgs e )
		{
            ...
            // http://forum.uosecondage.com/viewtopic.php?f=7&t=6086
            // Ghosts can no longer open spellbook
		    if ( from.Player && !from.Alive )
        ...
        */
        ...
        {
            BuildStandardSecondAgeNames( string.IsNullOrEmpty( Name ) ? StringList.Localization[ LabelNumber ] : Name, "ITA" );
        }
        ...
        public void OnOldSingleClick( Mobile from )
        {
            ...
            if( m_SecondAgeFullName == null )
                BuildStandardSecondAgeNames( name, from.Language );
            ...
            LabelTo( from, 1042886, m_Count.ToString() ); // ~1_NUMBERS_OF_SPELLS~ Spells
