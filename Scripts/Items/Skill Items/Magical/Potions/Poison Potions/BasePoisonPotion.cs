...
namespace Server.Items
{
	public abstract class BasePoisonPotion : BasePotion
	{
		...
		public BasePoisonPotion( int itemID, PotionEffect effect, int amount ) : base( itemID, effect, amount )
		{
		}

		#region Modifica by Dies Irae per le pozioni Stackable
		public BasePoisonPotion( PotionEffect effect, int amount ) : base( 0xF0A, effect, amount )
		{
		}
		#endregion
