...
namespace Server.Items
{
	...
	public abstract class BaseCurePotion : BasePotion
	{
		...
		public BaseCurePotion( PotionEffect effect, int amount ) : base( 0xF07, effect, amount )
		{
		}
		...
		public void DoCure( Mobile from )
		{
			...
			for ( int i = 0; i < info.Length; ++i )
			{
				...
				if ( li.Poison.Level == from.Poison.Level && Scale( from, li.Chance ) > Utility.RandomDouble() )
				{
					cure = true;
					break;
				}
