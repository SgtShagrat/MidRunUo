...
namespace Server.Items
{
	public abstract class FarmableCrop : Item
	{
		...
		public virtual void OnPicked( Mobile from, Point3D loc, Map map )
		{
			...
			{
				if ( Utility.Random( 100 ) < from.Skills[ SkillName.Camping ].Value )
				{
					from.SendMessage( from.Language == "ITA" ? "La conoscenza della natura ti è molto utile!" : "Your knowledge of nature is very helpful!" );
					spawn.Amount++;
				}
			}
