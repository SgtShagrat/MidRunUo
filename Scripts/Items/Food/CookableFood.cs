...
namespace Server.Items
{
	public abstract class CookableFood : Item
	{
        ...
        {
            if( !( this is IUncookedEatable ) )
                return;

            if( !Movable || !from.InRange( GetWorldLocation(), 1 ) || !from.InLOS( this ) )
                return;

            if( from.Race == Midgard.Engines.Races.Core.Werewolf )
                Werewolf.EatRawFood( this, from );
        }
        #endregion
	...
	// ********** RawRibs **********
	public class RawRibs : CookableFood, IUncookedEatable
	{
		[Constructable]
	...
	// ********** RawLambLeg **********
	public class RawLambLeg : CookableFood, IUncookedEatable
	{
		[Constructable]
	...
	// ********** RawChickenLeg **********
	public class RawChickenLeg : CookableFood, IUncookedEatable
	{
		[Constructable]
	...
	// ********** RawBird **********
	public class RawBird : CookableFood, IUncookedEatable
	{
		[Constructable]
	...
	public class RawFishSteak : CookableFood, IUncookedEatable
	{
