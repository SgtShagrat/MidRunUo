...
namespace Server.Items
{
	public class BallOfSummoning : Item, TranslocationItem
	{
		...
		public void CastSummonPet( Mobile from )
		{
            ...
            else if( pet.IsHitched )
            {
                from.Send( new AsciiMessage( this.Serial, this.ItemID, MessageType.Regular, 0x22, 3, "", "You cannot summon your pet to this location because it's hitched somewhere." ) );
            }
            #endregion
