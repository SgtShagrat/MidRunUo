...
namespace Server.Items
{
	...
	public class BaseBook : Item, ISecurable
	{
        ...
        {
            return new XElement( "book", new XAttribute( "author", Midgard.Engines.MyMidgard.Utility.SafeString( Author ) ),
                                 new XAttribute( "title", Midgard.Engines.MyMidgard.Utility.SafeString( Title ) ),
                                 new XElement( "content", Midgard.Engines.MyMidgard.Utility.SafeString( FullContent ) ) );
        }
        ...
        public string FullContent
        {
            get
            {
                try
                {
                    ...
                    foreach( BookPageInfo info in Pages )
                    {
