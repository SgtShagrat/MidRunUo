...
namespace Server.Items
{
	public abstract class Hair : Item
	{
        ...
        public static int PageboyHair = 0x2045;
        public static int BunsHair = 0x2046;
        public static int LongHair = 0x203C;
        public static int ShortHair = 0x203B;
        public static int PonyTail = 0x203D;
        public static int Afro = 0x2047;
        public static int ReceedingHair = 0x2048;
        public static int TwoPigTails = 0x2049;
        public static int KrisnaHair = 0x204A;
        #endregion
