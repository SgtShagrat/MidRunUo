...
namespace Server.Items
{
	...
	public class DeathRobe : Robe
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			try
			{
                ...
                if( from.Backpack == null || !from.Backpack.TryDropItem( from, bandage, false ) )
    ...
    */
	...
	public class MaleElvenRobe : BaseOuterTorso
	{
		...
		public override int LabelNumber{ get{ return 1064471; } } // Male Elven Robe
		#endregion
	...
	public class FemaleElvenRobe : BaseOuterTorso
	{
		public override Race RequiredRace { get { return Race.Elf; } }
		#region modifica by Dies Irae per la label
		public override int LabelNumber{ get{ return 1064472; } } // Female Elven Robe
		#endregion
