...
namespace Server.Items
{
	...
	{
        public override string DefaultName { get { return "chaos shield"; } } // mod by Dies Irae
        ...
        {
            return from != null && from is Midgard2PlayerMobile && ( (Midgard2PlayerMobile)from ).IsChaos;
        }
        #endregion
