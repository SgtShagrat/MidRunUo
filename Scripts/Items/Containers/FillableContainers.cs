...
namespace Server.Items
{
	public abstract class FillableContainer : LockableContainer
	{
		...
		public override bool IsDecoContainer{ get{ return false; } } // modifica by Dies Irae
		...
		public void CheckRespawn()
		{
			...
			if ( canSpawn )
			{
				if ( m_RespawnTimer == null )
				{
				    ...
				    m_RespawnTimer.Priority = TimerPriority.FiveSeconds;
				}
			}
...
//				int difficulty = (m_Content.Level - 1) * 30;
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			// Timer.DelayCall( TimeSpan.Zero, new TimerStateCallback( Relock_Callback ), this ); // modifica by Dies Irae
		}

		#region mod By Dies Irae
		public static void Relock_Callback( object state )
		{
			FillableContainer c = (FillableContainer)state;

			if( c.IsLockable && c.Content != null )
			{
				c.Locked = true;
				int difficulty = (c.Content.Level) * 30;
				c.LockLevel = difficulty - Utility.Dice( 1, 5, 5 );
				c.MaxLockLevel = difficulty + Utility.Dice( 1, 20, 20 );
				c.RequiredSkill = difficulty + Utility.Dice( 1, 5, 0 );
			}
		}
		#endregion
	}
