...
namespace Server.Items
{
	...
	public class ParagonChest : LockableContainer
	{
		...
		public override void OnSingleClick( Mobile from )
		{
            ...
            LabelTo( from, string.Format( "a treasure recovered from {0}", m_Name ) );
		}
...
//			DropItem( new TreasureMap( level + 1, ( Utility.RandomBool() ? Map.Felucca : Map.Trammel ) ) );
            ...
            if( Core.AOS )
            {
                ...
                {
                    case 1:
                        randomTalismanChance = 0.0;
                        break;
                    case 2:
                        randomTalismanChance = 0.0;
                        break;
                    case 3:
                        randomTalismanChance = 0.2;
                        break;
                    case 4:
                        randomTalismanChance = 0.5;
                        break;
                    case 5:
                        randomTalismanChance = 1.0;
                        break;
                    default:
                        randomTalismanChance = 0.0;
                        break;
