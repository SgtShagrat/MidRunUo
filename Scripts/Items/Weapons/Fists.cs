...
namespace Server.Items
{
	public class Fists : BaseMeleeWeapon
	{
		...
		public override int OldSpeed{ get{ return /*30*/ 50; } } // mod by Dies Irae

		public override int DefHitSound{ get{ return Core.AOS ? -1 : Utility.RandomList( 314, 315, 316, 317 ); } } // mod by Dies Irae
		...
		public override double GetDefendSkillValue( Mobile attacker, Mobile defender )
		{
			...
			if ( incrValue > ( Core.AOS ? 120.0 : 100.0 ) ) // mod by Dies Irae
                incrValue = ( Core.AOS ? 120.0 : 100.0 ); // mod by Dies Irae
