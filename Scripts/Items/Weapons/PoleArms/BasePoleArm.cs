...
namespace Server.Items
{
	public abstract class BasePoleArm : BaseMeleeWeapon, IUsesRemaining
	{
		...
		{
			m_UsesRemaining = 150 * 2; // mod by Dies Irae
		}
		...
		public override void OnHit( Mobile attacker, Mobile defender, double damageBonus )
		{
			...
			if ( PoleArmsSpecialMoveEnabled && !Core.AOS && (attacker.Player || attacker.Body.IsHuman) && Layer == Layer.TwoHanded && (attacker.Skills[SkillName.Anatomy].Value / 400.0) >= Utility.RandomDouble() )
			{
