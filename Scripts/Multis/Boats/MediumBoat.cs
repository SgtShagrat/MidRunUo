...
{
    /// <summary>
    /// Medium Ship        	15	400 Stones	14,200 GP	This is the typical midsize ship. It is a good blend of manoeuvrability, and room. A great ship if you want to bring a small to medium adventuring party to Hythloth and bring back a few loads of treasure. This ship is also good for shipping large amounts of ore or ingots from the more remote mountains to the cities.
    /// </summary>
	public class MediumBoat : BaseBoat
	{
        #region mod by Dies Irae
        public override int HitsMax { get { return 15000; } }
        ...
        public override string Description
        {
            get
            {
                return "This is the typical midsize ship." +
                    "It is a good blend of manoeuvrability, and room. " +
                    "A great ship if you want to bring a small to medium adventuring party to Hythloth and bring back a few loads of treasure." +
                    "This ship is also good for shipping large amounts of ore or ingots from the more remote mountains to the cities.";
            }
        }
