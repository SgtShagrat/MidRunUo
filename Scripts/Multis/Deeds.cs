...
namespace Server.Multis.Deeds
{
	...
	public abstract class HouseDeed : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel < AccessLevel.GameMaster && BaseHouse.HasAccountHouse( from ) && BaseHouse.HasAccountHouses( from ) ) // mod by Dies Irae
			{
				// from.SendLocalizedMessage( 501271 ); // You already own a house, you may not place another!
                from.SendMessage( "You already own the maximum houses allowed on Sosaria, you may not place another!" );
			}
			else
			{
    ...
    public class BlueTentDeed : HouseDeed
    {
        ...
        public override BaseHouse GetHouse( Mobile owner )
        {
            return new OldTent( owner, 0x70 );
        }

        public override Rectangle2D[] Area{ get{ return OldTent.AreaArray; } }
