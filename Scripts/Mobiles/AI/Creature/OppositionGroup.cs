...
namespace Server
{
	public class OppositionGroup
	{
		...
		private static OppositionGroup m_OrderAndChaos = new OppositionGroup( new Type[][]
			{
				new Type[]
				{
					typeof( OrderRider ),
					...
					typeof( OrderWarrior ),
					typeof( OrderMage ),
					typeof( OrderMageRider ),
					typeof( OrderArcherRider )
				},
				new Type[]
				{
					typeof( ChaosRider ),
					...
					typeof( ChaosMage ),
					typeof( OrderMageRider ),
					typeof( ChaosArcherRider )
				}
			} );

		public static OppositionGroup OrderAndChaos
		{
			get{ return m_OrderAndChaos; }
		}
		#endregion
	}
}