...
namespace Server.Mobiles
{
	...
	{
        public override SpeechFragment PersonalFragmentObj { get { return PersonalFragment.Blacksmith; } } // mod by Dies Irae
		...
		public override void InitOutfit()
		{
            ...
            if( item == null && FindItemOnLayer( Layer.MiddleTorso ) == null ) // mod by Dies Irae
		...
		{
			return ( Midgard2Persistance.SmithBulksEnabled && from is PlayerMobile && from.Skills[SkillName.Blacksmith].Base > 0 );
		}
