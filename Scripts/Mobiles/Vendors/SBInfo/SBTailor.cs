	...
	public class SBTailor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
                ...
                Add( new GenericBuyInfo( typeof( Midgard.Items.SuperiorKilt ), 15, 20, 0x3823, Utility.RandomDyedHue() ) );
                Add( new GenericBuyInfo( typeof( TailoringBook ), 50, 10, 0xEFA, 0 ) );
                #endregion
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			public InternalSellInfo()
			{
                ...
                Add( typeof( SpoolOfThread ), 1 ); // 9 );

                Add( typeof( Flax ), 1 ); // 51 );
                Add( typeof( Cotton ), 1 ); // 51 );
                Add( typeof( Wool ), 1 ); // 51 );
			}
		}
	}
}
