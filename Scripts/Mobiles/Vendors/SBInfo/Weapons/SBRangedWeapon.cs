	...
	public class SBRangedWeapon: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( Bolt ), 2, Utility.Random( 30, 60 ) * 4, 0x1BFB, 0 ) );
				Add( new GenericBuyInfo( typeof( Bow ), 40, 20, 0x13B2, 0 ) );
				Add( new GenericBuyInfo( typeof( Arrow ), 2, Utility.Random( 30, 60 ) * 4, 0xF3F, 0 ) );
				Add( new GenericBuyInfo( typeof( Feather ), 2, Utility.Random( 30, 60 ) * 4, 0x1BD1, 0 ) );
				Add( new GenericBuyInfo( typeof( Shaft ), 3, Utility.Random( 30, 60 ) * 4, 0x1BD4, 0 ) );
			}
		}
