	...
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( Arrow ), 2, 20 * 10, 0xF3F, 0 ) );
				Add( new GenericBuyInfo( typeof( Bolt ), 5, 20 * 10, 0x1BFB, 0 ) );
...
//					Add( new GenericBuyInfo( "1041055", typeof( GuildDeed ), 12450, 20, 0x14F0, 0 ) );
                ...
                Add( new GenericBuyInfo( typeof( Bandage ), 20, 150, 0xE21, 0 ) );
                Add( new GenericBuyInfo( "quiver", typeof( Quiver ), 100, 20, 0x3827, 0 ) );
                Add( new GenericBuyInfo( "sheath", typeof( Sheath ), 100, 20, 0x3826, 0 ) );
                Add( new GenericBuyInfo( "shoulder bag", typeof( ShoulderBag ), 100, 20, 0x3825, 0 ) );
                Add( new GenericBuyInfo( "pocket bag", typeof( PocketBag ), 100, 20, 0x3824, 0 ) );
                Add( new GenericBuyInfo( "belt with bag", typeof( BeltWithBag ), 100, 20, 0x3363, 0 ) );
                Add( new GenericBuyInfo( "belt", typeof( Belt ), 100, 20, 0x3364, 0 ) );
                Add( new GenericBuyInfo( "weistband", typeof( Weistband ), 100, 20, 0x3365, 0 ) );
                Add( new GenericBuyInfo( "alchemist bag", typeof( AlchemistBag ), 100, 20, 0x113F, 0 ) );
                Add( new GenericBuyInfo( "kilt bag", typeof( KiltBag ), 100, 20, 0x1152, 0 ) );
                Add( new GenericBuyInfo( "donation box", typeof( GoldDonationBox.GoldDonationBoxAddonDeed ), 500, 5, 0x14F0, 0 ) );
                Add( new GenericBuyInfo( "recycling tool", typeof( Midgard.Engines.FeedStockRecoverySystem.RecyclingTool ), 50, 10, 0x1EB8, Utility.RandomNeutralHue() ) );
                // Add( new GenericBuyInfo( "prof. recycling tool", typeof( Midgard.Engines.FeedStockRecoverySystem.ProfessionalRecyclingTool ), 200, 5, 0x1EB8, Utility.RandomMetalHue() ) );
