	...
	public class SBStoneCrafter : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( "Making Valuables With Stonecrafting", typeof( MasonryBook ), Core.AOS ? 10625 : 1000, 10, 0xFBE, 0 ) );
				Add( new GenericBuyInfo( "Mining For Quality Stone", typeof( StoneMiningBook ), Core.AOS ? 10625 : 1000, 10, 0xFBE, 0 ) );
				Add( new GenericBuyInfo( "1044515", typeof( MalletAndChisel ), 3, 50, 0x12B3, 0 ) );

			    Add( new GenericBuyInfo( typeof( MasonryCraftBook ), 50, 10, 0xEFA, 0 ) ); // mod by Dies Irae
			}
		}
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			{
				Add( typeof( MasonryBook ), Core.AOS ? 5000 : 500 );
				Add( typeof( StoneMiningBook ), Core.AOS ? 5000 : 500 );
