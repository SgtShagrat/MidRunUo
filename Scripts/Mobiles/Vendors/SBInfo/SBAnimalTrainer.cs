...
namespace Server.Mobiles
{
	public class SBAnimalTrainer : SBInfo
	{
		...
		public class InternalSellInfo : AnimalSellInfo
		{
		    private  const double Scalar = 0.1;

            public InternalSellInfo()
            {
                Add( typeof( Cat ), (int)( 132 * Scalar ) );
                Add( typeof( Dog ), (int)( 170 * Scalar ) );
                Add( typeof( Horse ), (int)( 550 * Scalar ) );
                Add( typeof( PackHorse ), (int)( 631 * Scalar ) );
                Add( typeof( PackLlama ), (int)( 565 * Scalar ) );
                Add( typeof( Rabbit ), (int)( 106 * Scalar ) );

                Add( typeof( Eagle ), (int)( 110 * Scalar ) );
                Add( typeof( BrownBear ), (int)( 200 * Scalar ) );
                Add( typeof( GrizzlyBear ), (int)( 220 * Scalar ) );
                Add( typeof( Panther ), (int)( 200 * Scalar ) );
                Add( typeof( TimberWolf ), (int)( 210 * Scalar ) );
                Add( typeof( Rat ), (int)( 107 * Scalar ) );
            }
		}
	}
}
