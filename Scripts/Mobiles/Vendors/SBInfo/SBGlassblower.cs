	...
	public class SBGlassblower : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( MandrakeRoot ), 3, 50, 0xF86, 0 ) );
				Add( new GenericBuyInfo( typeof( Nightshade ), 3, 50, 0xF88, 0 ) );
				Add( new GenericBuyInfo( typeof( SpidersSilk ), 3, 50, 0xF8D, 0 ) );
				Add( new GenericBuyInfo( typeof( SulfurousAsh ), 3, 50, 0xF8C, 0 ) );
                */
				...
				Add( new GenericBuyInfo( "Crafting Glass With Glassblowing", typeof( GlassblowingBook ), Core.AOS ? 10637 : 1000, 30, 0xFF4, 0 ) );
				Add( new GenericBuyInfo( "Finding Glass-Quality Sand", typeof( SandMiningBook ), Core.AOS ? 10637 : 1000, 30, 0xFF4, 0 ) );
				Add( new GenericBuyInfo( "1044608", typeof( Blowpipe ), 21, 100, 0xE8A, 0x3B9 ) );

                Add( new GenericBuyInfo( typeof( GlassblowingCraftGump ), 50, 10, 0xEFA, 0 ) );
			}
		}
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
                ...
                */
				...
				Add( typeof( GlassblowingBook ), Core.AOS ? 5000 : 500 );
				Add( typeof( SandMiningBook ), Core.AOS ? 5000 : 500 );
