...
{
	public class Banker : BaseVendor, ITownFolk
	{
        public override SpeechFragment PersonalFragmentObj { get { return PersonalFragment.Banker; } } // mod by Dies Irae
		...
		{
            DebugSay( "Banker is dealing speech..." );

            if( ( !e.Handled /*|| WasNamed( e.Speech )*/ ) && e.Mobile.InRange( this.Location, 12 ) )
            {
                DebugSay( "Was handled {0} - Was named {1}", e.Handled, WasNamed( e.Speech ) );

                #region mod by Dies Irae
                if( Insensitive.Contains( e.Speech, "bank" ) || Insensitive.Contains( e.Speech, "banca" ) )
                {
                    e.Handled = true;
			/*
			...
			*/
                    if( !YoungDeal( this, e.Mobile ) || !CitizenDeal( this, e.Mobile, false, true ) )
                        return;
					...
					switch ( keyword )
					{
						case 0x0000: // *withdraw*
						{
							...
							*/
							...
							if( !CitizenDeal( this, e.Mobile, false, true ) )
								break;
							#endregion
						...
						case 0x0003: // *check*
						{
							...
							*/
							...
							if ( split.Length >= 2 )
							{
								...
								if ( amount < 1000 ) // 5000 // mod by Dies Irae
								{
