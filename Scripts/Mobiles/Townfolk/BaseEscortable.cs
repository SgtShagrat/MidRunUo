...
{
	public abstract class BaseEscortable : BaseCreature, ITownFolk
	{
		...
		private static string[] m_TownNames = new string[]
		{
            ...
            "Serpent's Hold" // mod by Dies Irae
		};
		...
		public virtual void InitOutfit()
		{
			...
			PackGold( 200 / 10, 250 / 10 ); // mod by Dies Irae
		}
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			if( dest != null && !e.Handled && e.Mobile.InRange( this.Location, 3 ) )
			{
                ...
                if( e.Mobile != null && !e.Mobile.Alive && ( e.HasKeyword( 0x1D ) || e.HasKeyword( 0x1E ) ) )
                {
                    Say( true, "That sounded spooky!" );
                    e.Handled = true;
                    return;
                }
                #endregion
		...
		public virtual bool CheckAtDestination()
		{
			...
			if( dest.Contains( Location ) )
			{
                ...
                Misc.Titles.AwardKarma( escorter, 100, true ); // mod by Dies Irae
