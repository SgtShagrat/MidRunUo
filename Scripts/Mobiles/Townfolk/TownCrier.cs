...
namespace Server.Mobiles
{
	...
	public class GlobalTownCrierEntryList : ITownCrierEntryList, ITownFolk
	{
	...
	{
        // public override SpeechFragment PersonalFragmentObj { get { return PersonalFragment.Messenger; } } // mod by Dies Irae
		...
		public virtual TownCrierEntry GetRandomEntry()
		{
			if ( m_Entries == null || m_Entries.Count == 0 )
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if ( /* Core.AOS && */ NameHue == 0x35 ) // mod by Dies Irae
				NameHue = -1;
		}
	}
}