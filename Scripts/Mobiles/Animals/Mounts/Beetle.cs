...
namespace Server.Mobiles
{
	...
	public class Beetle : BaseMount
	{
        ...
        public override int StoneMaxWeight { get { return 1600; } } // mod by Dies Irae
        ...
        {
            if( from.Alive && from.InRange( Location, 3 ) )
                return true;
        ...
        {
			if( ( Alive && Controlled && ControlMaster == e.Mobile ) && e.Mobile.InRange( Location, 3 ) )
			{
                if( Insensitive.Contains( "open pack", e.Speech ) )
                {
