...
namespace Server.Mobiles
{
	...
	public class BrownBear : BaseCreature
	{
		...
		{
			corpse.DropItem( MakeInstanceOwner( new ArtigliDiOrso( 4 ), from ) );
			from.SendMessage( (from.Language == "ITA" ? "Stacchi con crudeltà alcuni artigli." : "You take away some claws, brutally." ) ); // You shear it, and the wool is now on the corpse.
