...
namespace Server.Mobiles
{
	...
	{
		public override bool CanAutoStable { get { return true; } } // mod by Dies Irae

		public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			corpse.DropItem( MakeInstanceOwner( new BeccoDiFalco( ), from ) );
			from.SendMessage( (from.Language == "ITA" ? "Stacchi con crudeltà il suo becco." : "You take away his beak." ) ); // You shear it, and the wool is now on the corpse.
