	...
	public class Harrower : BaseCreature
	{
		...
		public override bool OnBeforeDeath()
		{
			if ( m_TrueForm )
			{
				...
				if ( !NoKillAwards )
				{
                    if( Midgard2Persistance.StatScrollsEnabled && Midgard2Persistance.PowerScrollsEnabled )
					    GivePowerScrolls();
		...
		private class GoodiesTimer : Timer
		{
			...
			protected override void OnTick()
			{
                ...
                #region mod by Dies Irae
                g.Amount = (int)( g.Amount * Midgard2Persistance.GoldDemultiplier );
                #endregion
