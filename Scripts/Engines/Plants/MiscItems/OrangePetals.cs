...
namespace Server.Items
{
	public class OrangePetals : Item
	{
	    ...
	    public const double DurationInSeconds = 30.0; // mod by Dies Irae

		private class OrangePetalsTimer : Timer
		{
			private Mobile m_Mobile;

			public OrangePetalsTimer( Mobile from ) : base ( TimeSpan.FromSeconds( DurationInSeconds ) /* TimeSpan.FromMinutes( 5.0 ) */ )
			{
				m_Mobile = from;
			}
