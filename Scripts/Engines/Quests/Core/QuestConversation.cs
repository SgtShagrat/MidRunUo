...
namespace Server.Engines.Quests
{
	public abstract class QuestConversation
	{
	    ...
	    public virtual object MessageIta { get { return null; } } // mod by Dies Irae
	...
	public class QuestConversationsGump : BaseQuestGump
	{
		...
		public QuestConversationsGump( ArrayList conversations ) : base( 30, 50 )
		{
			...
			for ( int i = 0; i < conversations.Count; ++i )
			{
                ...
                if( conv.System.QuestLanguage == LanguageType.Ita && conv.MessageIta != null )
                    AddHtmlObject( 70, 110, 365, 220, conv.MessageIta, LightGreen, false, true );
                else
