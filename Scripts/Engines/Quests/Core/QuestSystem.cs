...
namespace Server.Engines.Quests
{
	...
	public abstract class QuestSystem
	{
        ...
        public virtual object NameIta { get { return null; } }
        public virtual object OfferMessageIta { get { return null; } }

	    public LanguageType QuestLanguage
	    {
	        get { return From != null && From.TrueLanguage == LanguageType.Ita ? LanguageType.Ita : LanguageType.Eng; }
	    }
        #endregion
		...
		public virtual void StartTimer()
		{
		    ...
		    m_Timer.Priority = TimerPriority.TwoFiftyMS; // mod by Dies Irae
		}
	...
	public class QuestCancelGump : BaseQuestGump
	{
		...
		public QuestCancelGump( QuestSystem system ) : base( 120, 50 )
		{
			...
			else
			{
                ...
                if( system.QuestLanguage == LanguageType.Ita && system.Name != null )
                    AddHtmlObject( 48, 80, 280, 20, system.NameIta, DarkGreen, false, false );
                else
	...
	public class QuestOfferGump : BaseQuestGump
	{
		...
		public QuestOfferGump( QuestSystem system ) : base( 75, 25 )
		{
            ...
            if( system.QuestLanguage == LanguageType.Ita && system.Name != null )
                AddHtmlObject( 160, 108, 250, 20, system.NameIta, DarkGreen, false, false );
            else
                AddHtmlObject( 160, 108, 250, 20, system.Name, DarkGreen, false, false );

            if( system.QuestLanguage == LanguageType.Ita && system.OfferMessageIta != null )
                AddHtmlObject( 98, 140, 312, 200, system.OfferMessageIta, LightGreen, false, true );
            else
