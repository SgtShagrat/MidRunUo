...
namespace Server.Engines.Quests.Matriarch
{
	public class KillInfiltratorsObjective : QuestObjective
	{
		...
		public override object MessageIta {
			get {
				return "Uccidi 7 \"" + (((SolenMatriarchQuest)System).RedSolen ? "Black" : "Red" ) + " solen infiltrators\"." ;
			}
		}
		#endregion
	...
	public class ReturnAfterKillsObjective : QuestObjective
	{
		...
		public override object MessageIta {
			get {
				return "Hai completato la missione uccidendo gli \"infiltrators\". Ritorna dalla Formica Madre che ti ha dato la missione." ;
			}
		}
		#endregion
	...
	public class GatherWaterObjective : QuestObjective
	{
		...
		public override object MessageIta {
			get {
				return "Riempi con 8 galloni di acqua le vasche nel formicaio." ;
			}
		}
		#endregion
	...
	public class ReturnAfterWaterObjective : QuestObjective
	{
		...
		public override object MessageIta {
			get {
				return "Hai completato la missione rifornendo d'acqua il formicaio. Ritorna dalla Formica Madre che ti ha dato la missione." ;
			}
		}
		#endregion
	...
	public class ProcessFungiObjective : QuestObjective
	{
		...
		public override object MessageIta {
			get {
				return "Dai alla Formica Madre gli \"zoogi fungus\" per trasformarli in \"powder of translocation\"." ;
			}
		}
		#endregion
	...
	public class GetRewardObjective : QuestObjective
	{
		...
		public override object MessageIta {
			get {
				return "Ritorna dalla Formica Madre per la ricompensa." ;
			}
		}
		#endregion
