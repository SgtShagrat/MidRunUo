	...
	public class SolenMatriarchQuest : QuestSystem
	{
		...
		public override object OfferMessageIta
		{
			get
			{
				if ( IsFriend( From, RedSolen ) )
				{
					return "La Formica Madre sorride felice quando la saluti.</I><BR><BR>"+
						"Salve di nuovo. E' sempre un piacere vedere un amico della colonia.<BR><BR>"+
							"Vorresti che lavorassi su qualche \"zoogi fungus\" per trasformatlo in polvere (powder of translocation)? "+
							"Lo farò volentieri in cambio di un paio di lavoretti che vorrei tu facessi per me.<BR><BR>"+
							"Primo, vorrei che eliminassi alcuni \"Infiltrators\" dell'altra colonia. Li hanno mandati a spiarci e temo per l'incolumità della mia gente. Devono essere eliminati!<BR><BR>"+
							"Dopo questo, vorrei che tu prendessi dell'acqua dalla tua terra per rifornire le nostre riserve che stanno prosciugandosi.<BR><BR>."+
							"Accetteresti la mia offerta?";
				}
				else
				{
					return "La Formica Madre sorride felice mentre assapora il seme che gli hai offerto.</I><BR><BR>"+
						"Ti ringrazio per questo seme prelibato e dolce.<BR><BR>"+
							"Se lo desideri posso farti diventare un amico della colona, in questo modo la mia gente non ti attaccherà più perchè non sarai più considerato come un intruso. " +
							"Inoltre, come amico della colonia, potrei lavorare per te su qualche \"zoogi fungus\" per trasformatlo in polvere (powder of translocation). "+
							"Per diventare un amico della colonia, ti chiedo di completare un un paio di lavoretti.<BR><BR>"+
							"Primo, vorrei che eliminassi alcuni \"Infiltrators\" dell'altra colonia. Li hanno mandati a spiarci e temo per l'incolumità della mia gente. Devono essere eliminati!<BR><BR>"+
							"Dopo questo, vorrei che tu prendessi dell'acqua dalla tua terra per rifornire le nostre riserve che stanno prosciugandosi.<BR><BR>."+
							"Accetteresti la mia offerta?";
				}
