...
namespace Server.Engines.Quests.Naturalist
{
	...
	public class AcceptConversation : QuestConversation
	{
	    ...
	    {
	        get { return "Ah! Questa è una splendida notizia! Ogni volta che un mio assistente entra nel Formicaio per raccogliere informazioni per me, mi sento come se fossi un po' più vicino ad una grande scoperta. Tuttavia avevo le stesse sensazioni quando ero certo che i Terathan avessero la capacità di cambiare aspetto per somigliare a frutta e verdura - una teoria che sono certo ulteriori studi possano confermare.<BR><BR>Comunque, non potrò ringraziarla abbastanza! La prego di ritornare da me quando avrà studiato tutti i nidi di uova nascosti all'interno del Formicaio."; }
	    }
	...
	public class NaturalistDuringStudyConversation : QuestConversation
	{
        ...
        public override object MessageIta
        {
            get
            {
                return "<I>Il Naturalista alza lo sguardo dai suoi appunti con un'espressione frustrata.</I><BR><BR>Non ha ancora terminato la missione che le ho affidato? Bah... è così difficile trovare un buon assistente di questi tempi.<BR><BR>Si ricordi, prima di tutto deve trovare un'entrata per il Formicaio. Una volta dentro, dovrà studiare per me i nidi di uova. Quando avrà studiato i quattro nidi, dovrebbe avere informazioni sufficienti per guadagnarsi una ricompensa.<BR><BR>Ora vada! Ho un mucchio di appunti da altri e più utili aiutanti che devo ancora studiare!";
            }
        }
	...
	public class EndConversation : QuestConversation
	{
        ...
        public override object MessageIta
        {
            get
            {
                return "<I>Il Naturalista alza lo sguardo dai suoi appunti con un'espressione soddisfatta.</I><BR><BR>Ah! Grazie, mio valido aiutante! Questi appunti che hai raccolto mi saranno d'aiuto senza dubbio per comprendere queste affascinanti creature Solen.<BR><BR>Ora, dal momento che ha fatto un buon lavoro, credo di doverle dare una piccola ricompensa.<BR><BR>Una mia amica botanica ha scoperto una strana mutazione nelle piante da lei coltivate. Attraverso scienza e magia, è riuscita a produrre una coltura mutante di semi colorati come nessun giardiniere ha mai visto.<BR><BR>Come ricompensa per le sue fatiche, le regalo questo strano e raro seme. Il che mi fa venire in mente che devo terminare i miei appunti sulle abitudini dietetiche delle Solen. Sono voraci mangiatrici di semi, quelle Matriarche Solen!<BR><BR>Ad ogni modo, ora devo tornare ai miei appunti. La ringrazio ancora e le auguro una buona giornata, mio giovane apprendista! Se mi volesse aiutare ancora, mi faccia sapere.";
            }
        }
