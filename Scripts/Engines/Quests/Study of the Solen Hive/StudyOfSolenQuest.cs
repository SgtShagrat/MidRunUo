...
namespace Server.Engines.Quests.Naturalist
{
	public class StudyOfSolenQuest : QuestSystem
	{
        ...
        public override object NameIta
        {
            get
            {
                return "Lo studio del Nido delle Solen";
            }
        }
	    ...
	    public override object OfferMessageIta
	    {
	        get
	        {
	            return "<I>Il Naturalista alza lo sguardo dai suoi appunti, salutandoti con un sorriso pieno di speranza.</I><BR><BR>" +
	                   "Uhm..sì..mi scusi. Mi chiedevo se potesse offrirmi un piccolo aiuto. " +
	                   "Vede, sono un naturalista di una certa fama - un gentiluomo ed un erudito, diciamo - interessato soprattutto allo studio di insetti ed aracnidi. " +
	                   "Ho scritto alcuni interessanti libri riguardo la meravigliosa razza dei Terathan e la loro bizzarra civiltà, " +
	                   "ed ora ho sentito voci di una nuova importante scoperta!<BR><BR>Sembra che una razza di creature, chiamate Solen e simili a formiche, " +
	                   "sia apparsa nel nostro mondo, dopo essere scappate dalla loro precedente dimora nascosta." +
	                   "Ci crederebbe? Questi sì che sono giorni meravigliosi!" +
	                   "Per uno studioso come me, questa è un'opportunità eccitante<BR><BR>" +
	                   "Detto questo, mentre da una parte sono un genio di una certa fama, furbo come una volpe e veloce come una lepre, " +
	                   "purtroppo non sono un grande avventuriero. Sebbene finora abbia ricevuto aiuto, ci sono ancora molte domande senza risposta.<BR><BR>" +
	                   "Mi interessano particolarmente i nidi di uova delle Solen, attentamente protetti dai lavoratori Solen. " +
	                   "Se fosse così gentile da aiutarmi, le chiederei di andare nel Formicaio e studiare tutti i nidi di uova che vi sono all'interno. " +
	                   "Dovrà impiegare un po' di tempo per esaminare ciascun nido prima di poter raccogliere informazioni sufficienti." +
	                   "Quando avrà finito, mi faccia un resoconto e io la ricompenserò per le sue fatiche come meglio posso.<BR><BR>Accetta la mia offerta?";
	        }
	    }
