...
namespace Server.Engines.Quests.Naturalist
{
	public class StudyNestsObjective : QuestObjective
	{
	    ...
	    {
            get { return "Trova un'entrata per il Formicaio, e cerca al suo interno i nidi di uova. Ciascun nido deve essere studiato per un po' di tempo senza perdita di concentrazione per poter raccogliere informazioni sufficienti.<BR><BR>Quando avrai completato lo studio dei nidi, torna dal Naturalista che ti ha affidato la missione."; }
	    }
	...
	public class ReturnToNaturalistObjective : QuestObjective
	{
        ...
        public override object MessageIta
        {
            get
            {
                return "Hai studiato i nidi a sufficienza per poter raccogliere un buon numero di informazioni utili. Torna dal Naturalista che ti ha affidato la missione.";
            }
        }
