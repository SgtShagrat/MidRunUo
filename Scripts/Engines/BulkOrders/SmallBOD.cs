	...
	public abstract class SmallBOD : Item
	{
		...
		public static BulkMaterialType GetMaterial( CraftResource resource )
		{
			switch ( resource )
			{
				...
				case CraftResource.OldDullCopper:	return BulkMaterialType.DullCopper;
				case CraftResource.OldShadowIron:	return BulkMaterialType.ShadowIron;
				case CraftResource.OldCopper:		return BulkMaterialType.Copper;
				case CraftResource.OldBronze:		return BulkMaterialType.Bronze;
				case CraftResource.OldGold:			return BulkMaterialType.Gold;
				case CraftResource.OldAgapite:		return BulkMaterialType.Agapite;
				case CraftResource.OldVerite:		return BulkMaterialType.Verite;
				case CraftResource.OldValorite:		return BulkMaterialType.Valorite;

                case CraftResource.OldReptileLeather:	return BulkMaterialType.Spined;
                case CraftResource.OldOphidianLeather:	return BulkMaterialType.Horned;
                case CraftResource.OldHumanoidLeather:	return BulkMaterialType.Barbed;
                #endregion
            }
		...
		public void EndCombine( Mobile from, object o )
		{
			if ( o is Item && ((Item)o).IsChildOf( from.Backpack ) )
			{
				...
				else
				{
                    ...
                    #region mod by Dies Irae
                    if( !Core.AOS && material != m_Material )
                    {
                        from.SendMessage( "The item is not made from the requested material." );
                    }
                    #endregion
                    else
					{
