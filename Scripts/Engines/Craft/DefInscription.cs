...
namespace Server.Engines.Craft
{
	public class DefInscription : CraftSystem
	{
        ...
        public override CraftDefinitionTree DefinitionTree
        {
            get
            {
                if( m_CraftDefinitionTree == null )
                    m_CraftDefinitionTree = new CraftDefinitionTree( "Inscription.xml", CraftSystem );
        ...
        {
            get { return CraftECA.ZeroToFourPercentPlusBonus; }
        }
		#endregion
		...
		private DefInscription() : base( 2, 4, 1.25 ) // mod by Dies Irae // base( 1, 1, 3.0 )
		{
		}
		...
		public override int CanCraft( Mobile from, BaseTool tool, Type typeItem )
		{
			...
			if( from.AccessLevel == AccessLevel.Player && m_DebugItemList.Contains( typeItem ) )
		...
		private void AddSpell( Type type, params Reg[] regs )
		{
            ...
            if( !Core.AOS )
            {
                int index = AddCraft( type, 1044369 + m_Circle, 1044381 + m_Index++, minSkill, maxSkill, typeof( BlankScroll ), 1044377, 1, 1044378 );
		...
		public static void InitDebugItemsList()
		{
            ...
            //m_DebugItemList.Add( typeof( ScrappersCompendium ) );
            //m_DebugItemList.Add( typeof( SpellbookEngraver ) );
		}
		#endregion
        ...
        public void InitOldCraftList()
        {
            ...
            AddCraft( typeof( MapBook ), 1044294, "map book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 15, 1044378 );
            AddCraft( typeof( NetBook ), 1044294, "net book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 10, 1044378 );
            // AddCraft( typeof( SketchBook ), 1044294, "sketch book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 5, 1044378 );
            AddCraft( typeof( BlueBook ), 1044294, "blue book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 10, 1044378 );
            AddCraft( typeof( BrownBook ), 1044294, "brown book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 10, 1044378 );
            AddCraft( typeof( RedBook ), 1044294, "red book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 10, 1044378 );
            AddCraft( typeof( TanBook ), 1044294, "tan book", 65.0, 115.0, typeof( BlankScroll ), 1044377, 10, 1044378 );
