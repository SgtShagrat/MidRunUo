...
namespace Server.Engines.Craft
{
	public class DefGlassblowing : CraftSystem
	{
        ...
        public override string Name { get{ return "Glassblowing"; } }
        ...
        public override CraftDefinitionTree DefinitionTree
        {
            get
            {
                if( m_CraftDefinitionTree == null )
                    m_CraftDefinitionTree = new CraftDefinitionTree( "Glassblowing.xml", CraftSystem );
		...
		private DefGlassblowing() : base( 2, 4, 1.25 ) // mod by Dies Irae // base( 1, 2, 1.7 )
		{
		}
        ...
        public void InitOldCraftList()
        {
            ...
            AddCraft( typeof( BlessedDrop ), 1044050, "decorated crystal bottle", 90.0, 150.0, typeof( Sand ), 1044625, 2, 1044627 );
            #endregion			
        }
	    ...
	    public override void InitCraftList()
		{
			...
			#region Mod by Dies Irae
			index = AddCraft( typeof( BlessedDrop ), 1044050, "decorated crystal bottle", 100.0, 150.0, typeof( Sand ), 1044625, 2, 1044627 );
			#endregion			
		}
	}
}