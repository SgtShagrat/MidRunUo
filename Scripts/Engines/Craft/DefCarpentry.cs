...
namespace Server.Engines.Craft
{
	...
	public class DefCarpentry : CraftSystem
	{
        ...
        public override CraftDefinitionTree DefinitionTree
        {
            get
            {
                if( m_CraftDefinitionTree == null )
                    m_CraftDefinitionTree = new CraftDefinitionTree( "Carpentry.xml", CraftSystem );
        ...
        public static void CheckCarpenteryTableLoom( Mobile from, int range, out bool carpenterytable )
        {
            carpenterytable = false;
            ...
            foreach( Item item in eable )
            {
                ...
                if( t == typeof( CarpenteryTableEastAddon ) || t == typeof( CarpenteryTableSouthAddon ) )
                {
                    carpenterytable = true;
                }
		...
		private DefCarpentry() : base( 2, 4, 1.25 ) // base( 1, 1, 3.0 )
		{
		}
        ...
        public void InitOldCraftList()
        {
            ...
            #region Deco items
            index = AddCraft( typeof( WeaponBarrel1 ), 1065020, 1065021, 90.0, 110.0, typeof( BarrelStaves ), 1044288, 10, 1044253 );
            AddRes( index, typeof( BarrelHoops ), 1044289, 1, 1044253 );
            AddRes( index, typeof( BarrelLid ), 1044251, 1, 1044253 );
            AddRes( index, typeof( IronIngot ), 1044036, 10, 1044037 );

            index = AddCraft( typeof( WeaponBarrel2 ), 1065020, 1065022, 90.0, 110.0, typeof( BarrelStaves ), 1044288, 10, 1044253 );
            AddRes( index, typeof( BarrelHoops ), 1044289, 1, 1044253 );
            AddRes( index, typeof( BarrelLid ), 1044251, 1, 1044253 );
            AddRes( index, typeof( IronIngot ), 1044036, 10, 1044037 );

            index = AddCraft( typeof( WeaponBarrel3 ), 1065020, 1065023, 65.0, 90.0, typeof( BarrelStaves ), 1044288, 5, 1044253 );
            AddRes( index, typeof( BarrelHoops ), 1044289, 1, 1044253 );
            AddRes( index, typeof( BarrelLid ), 1044251, 1, 1044253 );
            AddRes( index, typeof( IronIngot ), 1044036, 5, 1044037 );

            index = AddCraft( typeof( WeaponBarrel4 ), 1065020, 1065024, 65.0, 90.0, typeof( BarrelStaves ), 1044288, 5, 1044253 );
            AddRes( index, typeof( BarrelHoops ), 1044289, 1, 1044253 );
            AddRes( index, typeof( BarrelLid ), 1044251, 1, 1044253 );
            AddRes( index, typeof( IronIngot ), 1044036, 5, 1044037 );
            #endregion
            ...
            AddRes( index, typeof( BaseIngot ), 1044036, 2, 1044037 );

            AddCraft( typeof( RecallRune ), 1044294, 1027956, 94.7, 113.1, typeof( Log ), 1044041, 3, 1044351 );
            #endregion
            ...
            AddCraft( typeof( OrnateElvenTableSouthDeed ), 1044291, 1072869, 85.0, 110.0, typeof( Log ), 1044041, 60, 1044351 );
            AddCraft( typeof( OrnateElvenTableEastDeed ), 1044291, 1073384, 85.0, 110.0, typeof( Log ), 1044041, 60, 1044351 );
            AddCraft( typeof( FancyElvenTableSouthDeed ), 1044291, 1073385, 80.0, 105.0, typeof( Log ), 1044041, 50, 1044351 );
            AddCraft( typeof( FancyElvenTableEastDeed ), 1044291, 1073386, 80.0, 105.0, typeof( Log ), 1044041, 50, 1044351 );
            AddCraft( typeof( ElvenPodium ), 1044291, 1073399, 80.0, 105.0, typeof( Log ), 1044041, 20, 1044351 );
            ...
            AddCraft( typeof( LargeCounter ), 1044291, 1064510, 81.2, 90.2, typeof( Log ), 1044041, 28, 1044351 );
            #endregion

            #region Containers
            AddCraft( typeof( WoodenBox ), 1044292, 1023709, 21.0, 46.0, typeof( Log ), 1044041, 10, 1044351 );

		AddCraft( typeof( TrapableExplosionWoodenBox ), 1044292, "trapable wooden box", 20.0, 45.0, typeof( Log ), 1044041, 10, 1044351 );
            ...
            AddCraft( typeof( CraftableBookcase ), 1044292, 1022718, 31.5, 56.5, typeof( Log ), 1044041, 25, 1044351 );
            ...
            AddCraft( typeof( OrnateElvenChestSouthDeed ), 1044292, 1072862, 94.7, 119.7, typeof( Log ), 1044041, 40, 1044351 );
            AddCraft( typeof( OrnateElvenChestEastDeed ), 1044292, 1073383, 94.7, 119.7, typeof( Log ), 1044041, 40, 1044351 );
            AddCraft( typeof( ElvenWashBasinSouthDeed ), 1044292, 1072865, 70.0, 95.0, typeof( Log ), 1044041, 40, 1044351 );
            AddCraft( typeof( ElvenWashBasinEastDeed ), 1044292, 1073387, 70.0, 95.0, typeof( Log ), 1044041, 40, 1044351 );
            AddCraft( typeof( ElvenDresserSouthDeed ), 1044292, 1072864, 75.0, 100.0, typeof( Log ), 1044041, 45, 1044351 );
            AddCraft( typeof( ElvenDresserEastDeed ), 1044292, 1073388, 75.0, 100.0, typeof( Log ), 1044041, 45, 1044351 );
            AddCraft( typeof( FancyElvenArmoire ), 1044292, 1072866, 80.0, 105.0, typeof( Log ), 1044041, 60, 1044351 );
            AddCraft( typeof( SimpleElvenArmoire ), 1044292, 1073401, 80.0, 105.0, typeof( Log ), 1044041, 60, 1044351 );
            AddCraft( typeof( RarewoodChest ), 1044292, 1073402, 80.0, 105.0, typeof( Log ), 1044041, 30, 1044351 );
            AddCraft( typeof( DecorativeBox ), 1044292, 1073403, 80.0, 105.0, typeof( Log ), 1044041, 25, 1044351 );
            AddCraft( typeof( PicnicBasket ), 1044292, 1064962, 31.0, 56.0, typeof( Log ), 1044041, 10, 1044351 );
            AddCraft( typeof( Basket ), 1044292, 1064963, 45.0, 70.0, typeof( Log ), 1044041, 15, 1044351 );

            index = AddCraft( typeof( CraftableTrashBarrel ), 1044292, 1064925, 65.0, 90.0, typeof( BarrelStaves ), 1044288, 5, 1044253 );
            AddRes( index, typeof( BarrelHoops ), 1044289, 1, 1044253 );
            AddRes( index, typeof( BarrelLid ), 1044251, 1, 1044253 );
            ...
            AddCraft( typeof( LightStaff ), 1044295, "light staff", 78.9, 103.9, typeof( Log ), 1044041, 7, 1044351 );
            AddCraft( typeof( DarkenStaff ), 1044295, "darken staff", 78.9, 103.9, typeof( Log ), 1044041, 7, 1044351 );

            AddCraft( typeof( MageStaff ), 1044295, "mage staff", 78.9, 103.9, typeof( Log ), 1044041, 9, 1044351 );

            AddCraft( typeof( BlackStaff ), 1044295, "black staff", 78.9, 103.9, typeof( Log ), 1044041, 7, 1044351 );
            #endregion
            ...
            AddCraft( typeof( ParrotPerchAddonDeed ), 1044290, 1072617, 50.0, 85.0, typeof( Log ), 1044041, 100, 1044351 );
            ...
            AddRes( index, typeof( Diamond ), 1065152, 1 );
            ...
            AddCraft( typeof( AlchemistTableSouthDeed ), 1044290, 1074902, 85.0, 110.0, typeof( Log ), 1044041, 70, 1044351 );
            
            AddCraft( typeof( AlchemistTableEastDeed ), 1044290, 1074903, 85.0, 110.0, typeof( Log ), 1044041, 70, 1044351 );
            ...
            index = AddCraft( typeof( PentagramDeed ), 1044290, 1044328, 90.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Magery, 75.0, 80.0 );
            AddRes( index, typeof( IronIngot ), 1044036, 40, 1044037 );

            index = AddCraft( typeof( AbbatoirDeed ), 1044290, 1044329, 90.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
            ...
            index = AddCraft( typeof( CarpenteryTableEastDeed ), 1044290, 1064515, 90.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 40, 1044037 );

            index = AddCraft( typeof( CarpenteryTableSouthDeed ), 1044290, 1064514, 90.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 40, 1044037 );

            index = AddCraft( typeof( GraniteBox ), 1044290, 1065138, 90.0, 110.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Tinkering, 80.0, 90.0 );
            AddRes( index, typeof( IronIngot ), 1044036, 50, 1044037 );

            index = AddCraft( typeof( SeedBox ), 1044290, 1065137, 90.0, 110.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Tinkering, 80.0, 90.0 );
            AddRes( index, typeof( IronIngot ), 1044036, 50, 1044037 );

            index = AddCraft( typeof( CraftableScareCrow ), 1044290, 1065132, 80.0, 105.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Tailoring, 30.0, 40.0 );
            AddRes( index, typeof( Cloth ), 1044286, 25, 1044287 );
            AddRes( index, typeof( SheafOfHay ), 1065133, 1, 1065134 );
            #endregion
            ...
            AddRes( index, typeof( Sapphire ), 1065154, 3 );
            ...
            index = AddCraft( typeof( CarpetLoomSouthDeed ), 1044298, 1064440, 90.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
            AddRes( index, typeof( Cloth ), 1044286, 100, 1044287 );
            AddRes( index, typeof( BaseIngot ), 1044036, 20, 1044037 );

            index = AddCraft( typeof( CarpetLoomEastDeed ), 1044298, 1064441, 90.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
            AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
            AddRes( index, typeof( Cloth ), 1044286, 100, 1044287 );
            AddRes( index, typeof( BaseIngot ), 1044036, 20, 1044037 );
            ...
            AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 125, 1044037 );
            ...
            AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 50, 1044037 );
            ...
            AddRes( index, typeof( Diamond ), 1065152, 10 );
            AddRes( index, typeof( RadiantDiamondIngot ), 1065171, 50 );
            ...
            AddRes( index, typeof( BaseIngot ), 1044036, 75, 1044037 );
            ...
            AddRes( index, typeof( BaseIngot ), 1044036, 100, 1044037 );
            ...
            AddSkill( index, SkillName.Blacksmith, 75.0, 80.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 150, 1044037 );

            index = AddCraft( typeof( AnvilSouthDeed ), 1044296, 1044334, 73.6, 98.6, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 75.0, 80.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 150, 1044037 );

            index = AddCraft( typeof( AdvancedForge ), 1044296, "smelting forge", 90.0, 110.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 80.0, 85.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 150, 1044037 );

            index = AddCraft( typeof( FancyAnvil ), 1044296, 1064954, 90.0, 110.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 80.0, 85.0 );
            AddRes( index, typeof( BaseIngot ), 1044036, 150, 1044037 );
            AddRes( index, typeof( StarSapphire ), 1065155, 10 );

            index = AddCraft( typeof( MarbleAnvil ), 1044296, 1064955, 90.0, 110.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 75.0, 80.0 );
            AddRes( index, typeof( Granite ), 1044514, 10, 1044513 );
            AddRes( index, typeof( BaseIngot ), 1044036, 100, 1044037 );

            index = AddCraft( typeof( FancyMarbleForge ), 1044296, 1064956, 95.0, 120.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 80.0, 85.0 );
            AddRes( index, typeof( Granite ), 1044514, 10, 1044513 );

            index = AddCraft( typeof( MarbleForge ), 1044296, 1064957, 90.0, 110.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 75.0, 80.0 );
            AddRes( index, typeof( Granite ), 1044514, 5, 1044513 );

            index = AddCraft( typeof( MarbleWithWater ), 1044296, 1064958, 85.0, 110.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 75.0, 80.0 );
            AddRes( index, typeof( Granite ), 1044514, 10, 1044513 );
            AddRes( index, typeof( BaseIngot ), 1044036, 25, 1044037 );

            index = AddCraft( typeof( FancyLargeForgeAddonDeed ), 1044296, 1064959, 90.0, 130.0, typeof( Log ), 1044041, 5, 1044351 );
            AddSkill( index, SkillName.Blacksmith, 75.0, 80.0 );
            AddRes( index, typeof( Granite ), 1044514, 20, 1044513 );
            #endregion
