...
namespace Server.Engines.Craft
{
	...
	public class DefBlacksmithy : CraftSystem
	{
		...
		public override string Name { get{ return "Blacksmithy"; } }
		...
		public override CraftDefinitionTree DefinitionTree
		{
			get
			{
				if( m_CraftDefinitionTree == null )
					m_CraftDefinitionTree = new CraftDefinitionTree( "Blacksmithy.xml", CraftSystem );
	    ...
	    public override bool ForceConsumeOnFailure
	    {
	        get { return true; }
	    }

	    public override ConsumeType ConsumeTypeOnFailure
	    {
	        get { return ConsumeType.HalfOrLess; }
	    }
		#endregion
		...
		public override CraftECA ECA { get { return Core.AOS ? CraftECA.ChanceMinusSixtyToFourtyFive : CraftECA.ZeroToTenPercentPlusBonus; } } // mod by Arlas
		...
		private DefBlacksmithy() : base( 2, 4, 1.7 )// base( 1, 2, 1.7 )
		{
			/*
		...
		#region modifica by Dies Irae
		// NB: Gli oggetti vengono colorati di solito in OnCraft.
		// Se non hanno ICraftable allora li si colora via CraftItem e RetainsColorFrom
		private static Type[] m_BlacksmithColorables = new Type[]
		{
		};
		...
		public override bool RetainsColorFrom( CraftItem item, Type type )
		{
			...
			for ( int i = 0; !contains && i < m_BlacksmithColorables.Length; ++i )
				contains = ( m_BlacksmithColorables[i] == type );
		...
		public override void SetCustomQuality( Mobile from, CraftItem craftItem, Item item, bool exceptional, Type typeRes, double bonus )
		{
			...
			if( resInfo != null )
			{
				...
				if( attrInfo != null )
					modBonus = 1 - Math.Sqrt( attrInfo.OldStaticMultiply );
			}
		...
		public void InitOldCraftList()
		{
			...
			AddCraft( typeof( SeaChainChest ), 1011077, "sea chain chest", 39.1, 89.1, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( SeaChainCoif ), 1011077, "sea chain coif", 14.5, 64.5, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( SeaChainLegs ), 1011077, "sea chain legs", 36.7, 86.7, typeof( IronIngot ), 1044036, 18, 1044037 );
			#endregion
			...
			AddCraft( typeof( BarbarianChest ), 1011078, "barbarian chest", 75.0, 125.0, typeof( IronIngot ), 1044036, 25, 1044037 );
			AddCraft( typeof( BarbarianGorget ), 1011078, "barbarian gorget", 56.4, 106.4, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( BarbarianLegs ), 1011078, "barbarian legs", 68.8, 118.8, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( BarbarianPlateGloves ), 1011078, "barbarian gloves", 58.9, 108.9, typeof( IronIngot ), 1044036, 12, 1044037 );

			AddCraft( typeof( CruciformPlateArms ), 1011078, "cruciform arms", 66.3, 116.3, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( CruciformPlateGloves ), 1011078, "cruciform gloves", 58.9, 108.9, typeof( IronIngot ), 1044036, 12, 1044037 );
			AddCraft( typeof( CruciformPlateGorget ), 1011078, "cruciform gorget", 56.4, 106.4, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( CruciformPlateLegs ), 1011078, "cruciform legs", 68.8, 118.8, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( CruciformPlateChest ), 1011078, "cruciform chest", 75.0, 125.0, typeof( IronIngot ), 1044036, 25, 1044037 );

			AddCraft( typeof( ElvenPlateArms ), 1011078, "elven arms", 66.3, 116.3, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( ElvenPlateGloves ), 1011078, "elven gloves", 58.9, 108.9, typeof( IronIngot ), 1044036, 12, 1044037 );
			AddCraft( typeof( ElvenPlateGorget ), 1011078, "elven gorget", 56.4, 106.4, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( ElvenPlateLegs ), 1011078, "elven legs", 68.8, 118.8, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( ElvenPlateChest ), 1011078, "elven chest", 75.0, 125.0, typeof( IronIngot ), 1044036, 25, 1044037 );

			AddCraft( typeof( EvilPlateArms ), 1011078, "evil arms", 66.3, 116.3, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( EvilPlateGloves ), 1011078, "evil gloves", 58.9, 108.9, typeof( IronIngot ), 1044036, 12, 1044037 );
			AddCraft( typeof( EvilPlateGorget ), 1011078, "evil gorget", 56.4, 106.4, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( EvilPlateLegs ), 1011078, "evil legs", 68.8, 118.8, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( EvilPlateChest ), 1011078, "evil chest", 75.0, 125.0, typeof( IronIngot ), 1044036, 25, 1044037 );

			AddCraft( typeof( OrderPlatemail ), 1011078, "order plate chest", 75.0, 125.0, typeof( IronIngot ), 1044036, 26, 1044037 );
			AddCraft( typeof( ChaosPlatemail ), 1011078, "chaos plate chest", 75.0, 125.0, typeof( IronIngot ), 1044036, 26, 1044037 );

			AddCraft( typeof( NaglorPlateArms ), 1011078, "naglor plate arms", 75.0, 125.0, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( HorseBardingDeed ), 1011078, "horse barding deed", 75.0, 125.0, typeof( IronIngot ), 1044036, 250, 1044037 );
			#endregion
			...
			AddCraft( typeof( BarbarianPlateHelm ), 1011079, "barbarian helm", 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
			AddCraft( typeof( CruciformPlateHelm ), 1011079, "cruciform helm", 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
			AddCraft( typeof( ElvenPlateHelm ), 1011079, "elven helm", 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
			AddCraft( typeof( EvilPlateHelm ), 1011079, "evil helm", 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
        
			index = AddCraft( typeof( PlumedHelm ), 1011079, "plumed helm", 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
			AddRes( index, typeof( Feather ), "feather", 3 );
			#endregion
			...
			AddCraft( typeof( CruciformShield ), 1011080, "cruciform shield", 24.3, 74.3, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( ChaosShield ), 1011080, 1027107, 24.3, 74.3, typeof( IronIngot ), 1044036, 25, 1044037 );
			AddCraft( typeof( OrderShield ), 1011080, 1027108, 24.3, 74.3, typeof( IronIngot ), 1044036, 25, 1044037 );

			AddCraft( typeof( OldShadowShield ), 1011080, "shadow shield", 24.3, 74.3, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( AllianceShield ), 1011080, "alliance shield", 24.3, 74.3, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( HordeShield ), 1011080, "horde shield", 85.0, 135.0, typeof( IronIngot ), 1044036, 14, 1044037 );
			#endregion
			...
			AddCraft( typeof( ThinLongsword ), 1011081, "thin long sword", 33.0, 83.0, typeof( IronIngot ), 1044036, 8, 1044037 );
			AddCraft( typeof( ElvenLongSword ), 1011081, "elven long sword", 44.1, 94.1, typeof( IronIngot ), 1044036, 12, 1044037 );
			AddCraft( typeof( BoneBlade ), 1011081, "bone blade", 44.1, 94.1, typeof( IronIngot ), 1044036, 8, 1044037 );
			AddCraft( typeof( DoubleBoneBlade ), 1011081, "double bone blade", 44.1, 94.1, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( DoubleHatchet ), 1011081, "double hatchet", 44.1, 94.1, typeof( IronIngot ), 1044036, 13, 1044037 );
			AddCraft( typeof( DoubleKatana ), 1011081, "double katana", 44.1, 94.1, typeof( IronIngot ), 1044036, 16, 1044037 );
			AddCraft( typeof( DoubleKryss ), 1011081, "double kryss", 44.1, 94.1, typeof( IronIngot ), 1044036, 16, 1044037 );
			// AddCraft( typeof( DarkScythe ), 1011081, "dark scythe", 44.1, 94.1, typeof( IronIngot ), 1044036, 16, 1044037 );
			AddCraft( typeof( HordeCutlass ), 1011081, "horde cutlass", 44.1, 94.1, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( DrowPike ), 1011081, "drow pike", 44.1, 94.1, typeof( IronIngot ), 1044036, 8, 1044037 );
			#endregion
			...
			AddCraft( typeof( DwarvenAxe ), 1011082, "dwarven axe", 39.1, 89.1, typeof( IronIngot ), 1044036, 20, 1044037 );
			#endregion
			...
			index = AddCraft( typeof( DragonGloves ), 1053114, 1029795, 58.9, 108.9, typeof( RedScales ), 1060883, 16, 1060884 );
			SetUseSubRes2( index, true );
			AddRes( index, typeof( IronIngot ), "Iron ingots", 10, "You do not have sufficient iron ingots to make that." );

			index = AddCraft( typeof( DragonHelm ), 1053114, 1029797, 62.6, 112.6, typeof( RedScales ), 1060883, 20, 1060884 );
			SetUseSubRes2( index, true );
			AddRes( index, typeof( IronIngot ), "Iron ingots", 10, "You do not have sufficient iron ingots to make that." );

			index = AddCraft( typeof( DragonLegs ), 1053114, 1029799, 68.8, 118.8, typeof( RedScales ), 1060883, 28, 1060884 );
			SetUseSubRes2( index, true );
			AddRes( index, typeof( IronIngot ), "Iron ingots", 20, "You do not have sufficient iron ingots to make that." );

			index = AddCraft( typeof( DragonArms ), 1053114, 1029815, 66.3, 116.3, typeof( RedScales ), 1060883, 24, 1060884 );
			SetUseSubRes2( index, true );
			AddRes( index, typeof( IronIngot ), "Iron ingots", 15, "You do not have sufficient iron ingots to make that." );

			index = AddCraft( typeof( DragonChest ), 1053114, 1029793, 75.0, 125.0, typeof( RedScales ), 1060883, 36, 1060884 );
			SetUseSubRes2( index, true );
			AddRes( index, typeof( IronIngot ), "Iron ingots", 20, "You do not have sufficient iron ingots to make that." );
			#endregion
			...
			AddSubRes( typeof( PyriteIngot ), 1066405, 70.0, 1044036, 1044268, 1.26 );
			AddSubRes( typeof( AzuriteIngot ), 1066406, 70.0, 1044036, 1044268, 1.28 );
			AddSubRes( typeof( VanadiumIngot ), 1066407, 75.0, 1044036, 1044268, 1.30 );
			AddSubRes( typeof( SilverIngot ), 1066408, 80.0, 1044036, 1044268, 1.32 );
			AddSubRes( typeof( PlatinumIngot ), 1066409, 80.0, 1044036, 1044268, 1.34 );
			AddSubRes( typeof( AmethystIngot ), 1066410, 85.0, 1044036, 1044268, 1.36 );
			AddSubRes( typeof( TitaniumIngot ), 1066411, 85.0, 1044036, 1044268, 1.38 );

			AddSubRes( typeof( GoldIngot ), 1066412, 90.0, 1044036, 1044268, 1.40 );
			AddSubRes( typeof( XenianIngot ), 1066413, 90.0, 1044036, 1044268, 1.42 );
			AddSubRes( typeof( RubidianIngot ), 1066414, 92.5, 1044036, 1044268, 1.44 );
			AddSubRes( typeof( ObsidianIngot ), 1066415, 95.0, 1044036, 1044268, 1.46 );

			AddSubRes( typeof( EbonSapphireIngot ), 1066416, 97.5, 1044036, 1044268, 1.48 );
			AddSubRes( typeof( DarkRubyIngot ), 1066417, 99.0, 1044036, 1044268, 1.50 );
			AddSubRes( typeof( RadiantDiamondIngot ), 1066418, 99.9, 1044036, 1044268, 1.52 );
			#endregion

			#region SubRes2: RedScales
