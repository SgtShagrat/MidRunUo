...
namespace Server.Engines.Craft
{
	...
	public class CraftContext
	{
		...
		public bool DoNotColor{ get{ return Core.AOS ? m_DoNotColor : false; } set{ m_DoNotColor = value; } } // mod by Dies Irae
	    ...
	    private Type m_LastResourceSelected;

	    public Type LastResourceSelected
	    {
	        get { return m_LastResourceSelected; }
	        set { m_LastResourceSelected = value; }
	    }
	    #endregion
	}
}