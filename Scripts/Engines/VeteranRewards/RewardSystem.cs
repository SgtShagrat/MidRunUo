...
namespace Server.Engines.VeteranRewards
{
	public class RewardSystem
	{
		...
		public static bool Enabled = Midgard2Persistance.VeteranRewards; // change to true to enable vet rewards
		public static bool SkillCapRewards = Midgard2Persistance.SkillCapRewards; // assuming vet rewards are enabled, should total skill cap bonuses be awarded? (720 skills total at 4th level)
		public static TimeSpan RewardInterval = Midgard2Persistance.RewardInterval; // TimeSpan.FromDays( 120.0 ); // mod by Dies Irae
			...
			m_Lists = new RewardList[]
				{
					new RewardList( RewardInterval, 1, new RewardEntry[]
					{
						...
						new RewardEntry(    houseAddOns, 1072216, typeof( ChurchAtNightDeed ) ), // modifica by Dies Irae
						new RewardEntry(    houseAddOns, 1062692, typeof( MalasMountainPassDeed ) ), // modifica by Dies Irae
					...
					new RewardList( RewardInterval, 2, new RewardEntry[]
					{
						...
						new RewardEntry(    houseAddOns, 1006048, typeof( VeteranBannerDeed ) ), // modifica by Dies Irae
						new RewardEntry(    houseAddOns, 1006049, typeof( VeteranFlamingSkullDeed ) ), // modifica by Dies Irae
					...
					new RewardList( RewardInterval, 4, new RewardEntry[]
					{
						...
						new RewardEntry(    houseAddOns, 1049737, typeof( VeteranHangingShieldDeed ) ), // modifica by Dies Irae
						new RewardEntry(    houseAddOns, 1049738, typeof( VeteranHangingSkeletonDeed ) ) // modifica by Dies Irae
					} ),
					new RewardList( RewardInterval, 5, new RewardEntry[]
					{
						...
						new RewardEntry( houseAddOns,    1049739, typeof( VeteranDecoAnkhDeed ) ), // modifica by Dies Irae						
					...
					{
						new RewardEntry( miscellaneous, 1065556, typeof( ClothingEngraver ) ), // modifica by Dies Irae
					...
					new RewardList( RewardInterval, 7, new RewardEntry[]
					{
						...
						new RewardEntry( houseAddOns,	1080550, typeof( TreeStumpDeed ), Expansion.ML ),
				       	...
				       	new RewardEntry( miscellaneous, 1065555, typeof( ArmorEngraver ) ), // modifica by Dies Irae
				       	new RewardEntry( etherealSteeds, "Ethereal Polar Bear Statuette", typeof( EtherealPolarBear ) ) // modifica by Dies Irae   
					} ),
					new RewardList( RewardInterval, 8, new RewardEntry[]
					{
						...
						new RewardEntry( miscellaneous, 1065554, typeof( WeaponEngraver ) ),						

				       	new RewardEntry( etherealSteeds, "Ethereal Skeletal Mount Statuette", typeof( EtherealSkeletalMount ) )  // modifica by Dies Irae   
					} ),
					new RewardList( RewardInterval, 9, new RewardEntry[]
					{
						new RewardEntry( houseAddOns, 1076155, typeof( RedSoulstone ) ),  // modifica by Dies Irae   
					...
					{												
						...
						new RewardEntry( etherealSteeds,	1080386, typeof( Server.Items.EtherealCuSidhe ), Expansion.ML ),
