			...
			switch ( info.ButtonID )
			{
				...
				case 1: // go to sender
				{
					...
					try
					{
						...
						tw.WriteLine( "Lo staffano {0} (account {1}) è andato dal pg {2} (account {3}), in data {4} alle ore {5}.",
						              m.Name, m.Account.Username, 
						              m_Entry.Sender.Name, m_Entry.Sender.Account.Username,
				...
				case 2: // go to handler
				{
					...
					if ( h != null )
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) è andato dall'handler {2} (account {3}) di un page del pg {4} (account {5}), in data {6} alle ore {7}.",
							              m.Name, m.Account.Username, 
							              h.Name, h.Account.Username,
							              m_Entry.Sender.Name, m_Entry.Sender.Account.Username, 
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString() );
							tw.Close();
						}
				...
				case 3: // go to page location
				{
					...
					else
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) è andato nella posizione originale di un page del pg {2} (account {3}), in data {4} alle ore {5}.",
							              m.Name, m.Account.Username, m_Entry.Sender.Name, 
							              m_Entry.Sender.Account.Username, 
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString() );
							tw.Close();
						}
						catch( Exception ex )
				...
				case 4: // handle page
				{
					if ( m_Entry.Handler == null )
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) ha preso in handle un page del pg {2} (account {3}), in data {4} alle ore {5}.",
							              state.Mobile.Name, state.Mobile.Account.Username, 
							              m_Entry.Sender.Name, m_Entry.Sender.Account.Username, 
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString() );
							tw.Close();
						}
				...
				case 5: // delete page
				{
					if ( m_Entry.Handler == null )
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) ha cancellato un page del pg {2} (account {3}), in data {4} alle ore {5}.",
							              state.Mobile.Name, state.Mobile.Account.Username, 
							              m_Entry.Sender.Name, m_Entry.Sender.Account.Username, 
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString() );
							tw.Close();
				...
				case 6: // abandon page
				{
					if ( m_Entry.Handler == state.Mobile )
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) ha abbandonato un page del pg {2} (account {3}), in data {4} alle ore {5}.",
							              state.Mobile.Name, state.Mobile.Account.Username, 
							              m_Entry.Sender.Name, m_Entry.Sender.Account.Username, 
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString() );
							tw.Close();
				...
				case 7: // page handled
				{
					if ( m_Entry.Handler == state.Mobile )
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) ha segnato come handled un page del pg {2} (account {3}), in data {4} alle ore {5}.",
							              state.Mobile.Name, state.Mobile.Account.Username, 
							              m_Entry.Sender.Name, m_Entry.Sender.Account.Username, 
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString() );
							tw.Close();
				...
				case 8: // Send message
				{
					...
					if ( text != null )
					{
						...
						{
							System.IO.TextWriter tw = System.IO.File.AppendText("Logs/Midgard2PagesLog.txt");
							tw.WriteLine( "Lo staffano {0} (account {1}) ha mandato un messaggio ad un page del pg {2} (account {3}), in data {4} alle ore {5}." +
							              "Il contenuto è {6}.",
							              state.Mobile.Name, state.Mobile.Account.Username, 
							              m_Entry.Sender.Name, m_Entry.Sender.Account.Username,
							              DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString(), text.Text);
							tw.Close();
						}
						catch( Exception ex )
						{
