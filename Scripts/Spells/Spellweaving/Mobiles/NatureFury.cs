...
namespace Server.Mobiles
{
	...
	{
		public override bool DeleteCorpseOnDeath { get { return /* Core.AOS */ true; } } // mod by Dies Irae
        ...
        public Poison PoisonLevel { get; set; }
			...
			: base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            ...
            PoisonLevel = Poison.Lesser; // mod by Dies Irae
		}
