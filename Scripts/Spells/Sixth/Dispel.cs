		...
		public class InternalTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object o )
			{
				...
				{					
					...
					else if ( bc == null || !bc.IsDispellable || !from.CanBeHarmful( m, false ) )
					{
					...
					else if ( m_Owner.CheckHSequence( m ) )
					{
						...
						{
							dispelChance = 0.3 + (from.Skills.Magery.Value - bc.DispelDifficulty)/200.0;
						}
						...
						if (master!=null && master!=from && from.CanBeHarmful( master, false ))
