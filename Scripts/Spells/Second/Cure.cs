		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckBSequence( m ) )
			{
				...
				if ( p != null )
				{
					...
					/*
					* confirmed by UO demo code!
					*
					int Q5KQ = (int) (Caster.Skills[SkillName.Magery].Value * 0x4B); // 75
					int Q5JC = p.Level * 0x06D6; // 1750
					if(((0x2710 + (Q5KQ - Q5JC)) / 0x64) > Utility.Random( 0x64 )) // ( 10000 + Q5KQ - Q5JC ) / 100
					*
					*/
