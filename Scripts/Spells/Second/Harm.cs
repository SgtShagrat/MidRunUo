	...
	public class HarmSpell : MagerySpell
	{
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
				...
				{
					//magery:=cint(magery/20);
					//var dmg := randomdiceroll((magery+"d3"));
					//int mag = (int)(Caster.Skills[SkillName.Magery].Value/20);
					damage = DiceRoll.Roll( new DiceRoll( (int) ( Caster.Skills[ SkillName.Magery ].Value / 20.0 ), 3, 0 ) );//GetBaseDamage(); // Utility.Random( 1, 15 );
				...
				*/
				...
				if( Core.AOS )
					...
					MidgardSpellHelper.Damage( this, m, damage, SpellType.General );
				#endregion
			}
