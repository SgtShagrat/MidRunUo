	...
	public class PoisonFieldSpell : MagerySpell
	{
		...
		public class InternalItem : Item
		{
			...
			public override bool OnMoveOver( Mobile m )
			{
				...
				if( MidgardSpellHelper.CheckResisted( m_Caster, m, SpellRegistry.GetSpellByType( typeof( PoisonFieldSpell ) ) as MagerySpell, false, false, false ) )
				{
					if( m.Player )
				...
				else
				{
					...
					{
						if ( m_Caster.CanAreaHarmful( m ) )//il veleno scala hp e ogni colpo rende il caster grigio
						{
