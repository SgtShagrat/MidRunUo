...
namespace Server.Spells.First
{
	public class CreateFoodSpell : MagerySpell
	{
        ...
        private static FoodInfo m_WizardFoodInfo = new FoodInfo( typeof( Midgard.Items.WizardFood ), "some wizard food" ); // mod by Dies Irae
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
            {
                ...
                FoodInfo foodInfo = m_WizardFoodInfo; //  m_Food[ Utility.Random( m_Food.Length ) ];
				Item food = foodInfo.Create( Caster ); // foodInfo.Create();
                #endregion
	...
	public class FoodInfo
	{
        ...
        #region mod by Dies Irae
        public Item Create( Mobile caster )
        {
            return new Midgard.Items.WizardFood( caster );
        }
        #endregion
