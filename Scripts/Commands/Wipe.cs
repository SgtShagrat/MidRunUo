...
namespace Server.Commands
{
	public class Wipe
	{
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register( "Wipe", AccessLevel.Administrator, new CommandEventHandler( WipeAll_OnCommand ) );
			CommandSystem.Register( "WipeItems", AccessLevel.Administrator, new CommandEventHandler( WipeItems_OnCommand ) );
			CommandSystem.Register( "WipeNPCs", AccessLevel.Administrator, new CommandEventHandler( WipeNPCs_OnCommand ) );
			CommandSystem.Register( "WipeMultis", AccessLevel.Administrator, new CommandEventHandler( WipeMultis_OnCommand ) );
			#endregion
		}
