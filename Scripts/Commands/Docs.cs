...
namespace Server.Commands
{
	public class Docs
	{
		...
		{
			CommandSystem.Register( "DocGen", AccessLevel.Developer, new CommandEventHandler( DocGen_OnCommand ) ); // mod by Dies Irae
		}
		...
		private static void DocGen_OnCommand( CommandEventArgs e )
		{
			...
			{
				World.Broadcast( 0x35, true, "Documentation failed: Documentation directories are locked and in use. Please close all open files and directories and try again." );
	    ...
	    public static List<Dictionary<int, SpeechEntry>> LoadSpeechFile()
		{
