...
namespace Server.Commands
{
	public class Dupe
	{
		public static void Initialize()
		{
			...
			CommandSystem.Register( "Dupe", AccessLevel.Administrator, new CommandEventHandler( Dupe_OnCommand ) );
			CommandSystem.Register( "DupeInBag", AccessLevel.Administrator, new CommandEventHandler( DupeInBag_OnCommand ) );
			#endregion
		}
